 ...
 */
public class CSCHLOutcomeLevelOfNeedImpl extends uk.nhs.connect.iucds.ucr.impl.CSImpl implements uk.nhs.connect.iucds.ucr.CSCHLOutcomeLevelOfNeed
{
    private static final long serialVersionUID = 1L;
    
    public CSCHLOutcomeLevelOfNeedImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
