 ...
 */
public class StrucDocCaptionImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.ucr.StrucDocCaption
{
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocLinkHtml getLinkHtmlArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.ucr.StrucDocLinkHtml)get_store().find_element_user(LINKHTML$0, i);
            if (target == null)
            {
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocLinkHtml insertNewLinkHtml(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocLinkHtml target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocLinkHtml)get_store().insert_element_user(LINKHTML$0, i);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocLinkHtml addNewLinkHtml()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocLinkHtml target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocLinkHtml)get_store().add_element_user(LINKHTML$0);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocFootnote getFootnoteArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.ucr.StrucDocFootnote)get_store().find_element_user(FOOTNOTE$6, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocFootnote insertNewFootnote(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocFootnote target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocFootnote)get_store().insert_element_user(FOOTNOTE$6, i);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocFootnote addNewFootnote()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocFootnote target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocFootnote)get_store().add_element_user(FOOTNOTE$6);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocFootnoteRef getFootnoteRefArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.ucr.StrucDocFootnoteRef)get_store().find_element_user(FOOTNOTEREF$8, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocFootnoteRef insertNewFootnoteRef(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocFootnoteRef target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocFootnoteRef)get_store().insert_element_user(FOOTNOTEREF$8, i);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocFootnoteRef addNewFootnoteRef()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocFootnoteRef target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocFootnoteRef)get_store().add_element_user(FOOTNOTEREF$8);
            return target;
        }
    }
