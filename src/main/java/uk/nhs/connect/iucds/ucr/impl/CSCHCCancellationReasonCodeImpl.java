 ...
 */
public class CSCHCCancellationReasonCodeImpl extends uk.nhs.connect.iucds.ucr.impl.CSImpl implements uk.nhs.connect.iucds.ucr.CSCHCCancellationReasonCode
{
    private static final long serialVersionUID = 1L;
    
    public CSCHCCancellationReasonCodeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
