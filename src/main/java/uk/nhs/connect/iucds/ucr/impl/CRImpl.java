 ...
 */
public class CRImpl extends uk.nhs.connect.iucds.ucr.impl.CDImpl implements uk.nhs.connect.iucds.ucr.CR
{
     ...
     */
    public uk.nhs.connect.iucds.ucr.CV getName()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.CV target = null;
            target = (uk.nhs.connect.iucds.ucr.CV)get_store().find_element_user(NAME$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setName(uk.nhs.connect.iucds.ucr.CV name)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.CV addNewName()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.CV target = null;
            target = (uk.nhs.connect.iucds.ucr.CV)get_store().add_element_user(NAME$0);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.CD getValue()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.CD target = null;
            target = (uk.nhs.connect.iucds.ucr.CD)get_store().find_element_user(VALUE$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setValue(uk.nhs.connect.iucds.ucr.CD value)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.CD addNewValue()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.CD target = null;
            target = (uk.nhs.connect.iucds.ucr.CD)get_store().add_element_user(VALUE$2);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.Bl2 xgetInverted()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.Bl2 target = null;
            target = (uk.nhs.connect.iucds.ucr.Bl2)get_store().find_attribute_user(INVERTED$4);
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.Bl2)get_default_attribute_value(INVERTED$4);
            }
            return target;
        }
    }
     ...
     */
    public void xsetInverted(uk.nhs.connect.iucds.ucr.Bl2 inverted)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.Bl2)get_store().add_attribute_user(INVERTED$4);
            }
            target.set(inverted);
        }
    }
