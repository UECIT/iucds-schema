 ...
 */
public class StrucDocListImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.ucr.StrucDocList
{
     ...
     */
    public uk.nhs.connect.iucds.ucr.StrucDocItem[] getItemArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            uk.nhs.connect.iucds.ucr.StrucDocItem[] result = new uk.nhs.connect.iucds.ucr.StrucDocItem[targetList.size()];
     ...
     */
    public uk.nhs.connect.iucds.ucr.StrucDocItem getItemArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocItem target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocItem)get_store().find_element_user(ITEM$2, i);
            if (target == null)
            {
     ...
     */
    public void setItemArray(uk.nhs.connect.iucds.ucr.StrucDocItem[] itemArray)
    {
        check_orphaned();
     ...
     */
    public void setItemArray(int i, uk.nhs.connect.iucds.ucr.StrucDocItem item)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.StrucDocItem insertNewItem(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocItem target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocItem)get_store().insert_element_user(ITEM$2, i);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.StrucDocItem addNewItem()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocItem target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocItem)get_store().add_element_user(ITEM$2);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.StrucDocList.ListType.Enum getListType()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (uk.nhs.connect.iucds.ucr.StrucDocList.ListType.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.StrucDocList.ListType xgetListType()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocList.ListType target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocList.ListType)get_store().find_attribute_user(LISTTYPE$10);
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.StrucDocList.ListType)get_default_attribute_value(LISTTYPE$10);
            }
            return target;
        }
    }
     ...
     */
    public void setListType(uk.nhs.connect.iucds.ucr.StrucDocList.ListType.Enum listType)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetListType(uk.nhs.connect.iucds.ucr.StrucDocList.ListType listType)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.StrucDocList.ListType)get_store().add_attribute_user(LISTTYPE$10);
            }
            target.set(listType);
        }
    }
     ...
     */
    public static class ListTypeImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements uk.nhs.connect.iucds.ucr.StrucDocList.ListType
    {
        private static final long serialVersionUID = 1L;
