 ...
 */
public class StrucDocTrImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.ucr.StrucDocTr
{
     ...
     */
    public uk.nhs.connect.iucds.ucr.StrucDocTh[] getThArray()
    {
        synchronized (monitor())
        {
            ...
            uk.nhs.connect.iucds.ucr.StrucDocTh[] result = new uk.nhs.connect.iucds.ucr.StrucDocTh[targetList.size()];
     ...
     * Gets ith "th" element
     */
    public uk.nhs.connect.iucds.ucr.StrucDocTh getThArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocTh target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocTh)get_store().find_element_user(TH$0, i);
            if (target == null)
            {
     ...
     */
    public void setThArray(uk.nhs.connect.iucds.ucr.StrucDocTh[] thArray)
    {
        check_orphaned();
     ...
     * Sets ith "th" element
     */
    public void setThArray(int i, uk.nhs.connect.iucds.ucr.StrucDocTh th)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.StrucDocTh insertNewTh(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocTh target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocTh)get_store().insert_element_user(TH$0, i);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.StrucDocTh addNewTh()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocTh target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocTh)get_store().add_element_user(TH$0);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.StrucDocTd[] getTdArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            uk.nhs.connect.iucds.ucr.StrucDocTd[] result = new uk.nhs.connect.iucds.ucr.StrucDocTd[targetList.size()];
            targetList.toArray(result);
            return result;
        }
    }
     ...
     * Gets ith "td" element
     */
    public uk.nhs.connect.iucds.ucr.StrucDocTd getTdArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocTd target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocTd)get_store().find_element_user(TD$2, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
     ...
     */
    public void setTdArray(uk.nhs.connect.iucds.ucr.StrucDocTd[] tdArray)
    {
        check_orphaned();
     ...
     * Sets ith "td" element
     */
    public void setTdArray(int i, uk.nhs.connect.iucds.ucr.StrucDocTd td)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.StrucDocTd insertNewTd(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocTd target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocTd)get_store().insert_element_user(TD$2, i);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.StrucDocTd addNewTd()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocTd target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocTd)get_store().add_element_user(TD$2);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.StrucDocTr.Align.Enum getAlign()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (uk.nhs.connect.iucds.ucr.StrucDocTr.Align.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.StrucDocTr.Align xgetAlign()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocTr.Align target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocTr.Align)get_store().find_attribute_user(ALIGN$10);
            return target;
        }
    }
     ...
     */
    public void setAlign(uk.nhs.connect.iucds.ucr.StrucDocTr.Align.Enum align)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetAlign(uk.nhs.connect.iucds.ucr.StrucDocTr.Align align)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.StrucDocTr.Align)get_store().add_attribute_user(ALIGN$10);
            }
            target.set(align);
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.StrucDocTr.Valign.Enum getValign()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (uk.nhs.connect.iucds.ucr.StrucDocTr.Valign.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.StrucDocTr.Valign xgetValign()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocTr.Valign target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocTr.Valign)get_store().find_attribute_user(VALIGN$16);
            return target;
        }
    }
     ...
     */
    public void setValign(uk.nhs.connect.iucds.ucr.StrucDocTr.Valign.Enum valign)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetValign(uk.nhs.connect.iucds.ucr.StrucDocTr.Valign valign)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.StrucDocTr.Valign)get_store().add_attribute_user(VALIGN$16);
            }
            target.set(valign);
        }
    }
     ...
     */
    public static class AlignImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements uk.nhs.connect.iucds.ucr.StrucDocTr.Align
    {
        private static final long serialVersionUID = 1L;
     ...
     */
    public static class ValignImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements uk.nhs.connect.iucds.ucr.StrucDocTr.Valign
    {
        private static final long serialVersionUID = 1L;
