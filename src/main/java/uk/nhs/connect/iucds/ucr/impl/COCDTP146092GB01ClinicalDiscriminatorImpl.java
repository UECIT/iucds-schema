 ...
 */
public class COCDTP146092GB01ClinicalDiscriminatorImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.ucr.COCDTP146092GB01ClinicalDiscriminator
{
    private static final long serialVersionUID = 1L;
    
    public COCDTP146092GB01ClinicalDiscriminatorImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146092GB01ClinicalDiscriminator.TemplateId getTemplateId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146092GB01ClinicalDiscriminator.TemplateId target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146092GB01ClinicalDiscriminator.TemplateId)get_store().find_element_user(TEMPLATEID$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setTemplateId(uk.nhs.connect.iucds.ucr.COCDTP146092GB01ClinicalDiscriminator.TemplateId templateId)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146092GB01ClinicalDiscriminator.TemplateId addNewTemplateId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146092GB01ClinicalDiscriminator.TemplateId target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146092GB01ClinicalDiscriminator.TemplateId)get_store().add_element_user(TEMPLATEID$2);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.CV getValue()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.CV target = null;
            target = (uk.nhs.connect.iucds.ucr.CV)get_store().find_element_user(VALUE$4, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setValue(uk.nhs.connect.iucds.ucr.CV value)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.CV addNewValue()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.CV target = null;
            target = (uk.nhs.connect.iucds.ucr.CV)get_store().add_element_user(VALUE$4);
            return target;
        }
    }
     ...
     * This is a complex type.
     */
    public static class TemplateIdImpl extends uk.nhs.connect.iucds.ucr.impl.IIImpl implements uk.nhs.connect.iucds.ucr.COCDTP146092GB01ClinicalDiscriminator.TemplateId
    {
        private static final long serialVersionUID = 1L;
         ...
         */
        public static class RootImpl extends org.apache.xmlbeans.impl.values.XmlUnionImpl implements uk.nhs.connect.iucds.ucr.COCDTP146092GB01ClinicalDiscriminator.TemplateId.Root, uk.nhs.connect.iucds.ucr.Oid, uk.nhs.connect.iucds.ucr.Uuid, uk.nhs.connect.iucds.ucr.Ruid
        {
            private static final long serialVersionUID = 1L;
         ...
         */
        public static class ExtensionImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements uk.nhs.connect.iucds.ucr.COCDTP146092GB01ClinicalDiscriminator.TemplateId.Extension
        {
            private static final long serialVersionUID = 1L;
