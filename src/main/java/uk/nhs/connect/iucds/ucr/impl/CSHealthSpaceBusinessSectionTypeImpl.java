 ...
 */
public class CSHealthSpaceBusinessSectionTypeImpl extends uk.nhs.connect.iucds.ucr.impl.CSImpl implements uk.nhs.connect.iucds.ucr.CSHealthSpaceBusinessSectionType
{
    private static final long serialVersionUID = 1L;
    
    public CSHealthSpaceBusinessSectionTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
