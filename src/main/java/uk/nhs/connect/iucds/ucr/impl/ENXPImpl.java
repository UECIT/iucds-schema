 ...
 */
public class ENXPImpl extends uk.nhs.connect.iucds.ucr.impl.STImpl implements uk.nhs.connect.iucds.ucr.ENXP
{
     ...
     */
    public uk.nhs.connect.iucds.ucr.SetCsEntityNamePartQualifier xgetQualifier()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.SetCsEntityNamePartQualifier target = null;
            target = (uk.nhs.connect.iucds.ucr.SetCsEntityNamePartQualifier)get_store().find_attribute_user(QUALIFIER$2);
            return target;
        }
    }
     ...
     */
    public void xsetQualifier(uk.nhs.connect.iucds.ucr.SetCsEntityNamePartQualifier qualifier)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.SetCsEntityNamePartQualifier)get_store().add_attribute_user(QUALIFIER$2);
            }
