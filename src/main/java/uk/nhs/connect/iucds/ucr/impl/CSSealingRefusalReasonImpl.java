 ...
 */
public class CSSealingRefusalReasonImpl extends uk.nhs.connect.iucds.ucr.impl.CSImpl implements uk.nhs.connect.iucds.ucr.CSSealingRefusalReason
{
    private static final long serialVersionUID = 1L;
    
    public CSSealingRefusalReasonImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
