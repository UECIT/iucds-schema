 ...
 */
public class GLISTPQImpl extends uk.nhs.connect.iucds.ucr.impl.ANYImpl implements uk.nhs.connect.iucds.ucr.GLISTPQ
{
     ...
     */
    public uk.nhs.connect.iucds.ucr.PQ getHead()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.PQ target = null;
            target = (uk.nhs.connect.iucds.ucr.PQ)get_store().find_element_user(HEAD$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setHead(uk.nhs.connect.iucds.ucr.PQ head)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.PQ addNewHead()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.PQ target = null;
            target = (uk.nhs.connect.iucds.ucr.PQ)get_store().add_element_user(HEAD$0);
            return target;
        }
    }
