 ...
 */
public class POCDMT200001GB02Component5Impl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.ucr.POCDMT200001GB02Component5
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT200001GB02Component5Impl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName STRUCTUREDBODY$0 = 
     ...
     */
    public uk.nhs.connect.iucds.ucr.POCDMT200001GB02StructuredBody getStructuredBody()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.POCDMT200001GB02StructuredBody target = null;
            target = (uk.nhs.connect.iucds.ucr.POCDMT200001GB02StructuredBody)get_store().find_element_user(STRUCTUREDBODY$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setStructuredBody(uk.nhs.connect.iucds.ucr.POCDMT200001GB02StructuredBody structuredBody)
    {
        generatedSetterHelperImpl(structuredBody, STRUCTUREDBODY$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "structuredBody" element
     */
    public uk.nhs.connect.iucds.ucr.POCDMT200001GB02StructuredBody addNewStructuredBody()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.POCDMT200001GB02StructuredBody target = null;
            target = (uk.nhs.connect.iucds.ucr.POCDMT200001GB02StructuredBody)get_store().add_element_user(STRUCTUREDBODY$0);
            return target;
        }
    }
