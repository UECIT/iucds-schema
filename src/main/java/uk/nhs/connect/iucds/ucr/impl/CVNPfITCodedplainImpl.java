 ...
 */
public class CVNPfITCodedplainImpl extends uk.nhs.connect.iucds.ucr.impl.CVImpl implements uk.nhs.connect.iucds.ucr.CVNPfITCodedplain
{
    private static final long serialVersionUID = 1L;
    
    public CVNPfITCodedplainImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
