 ...
 * Java type: uk.nhs.connect.iucds.ucr.StrucDocTh
 *
 ...
 */
public class StrucDocThImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.ucr.StrucDocTh
{
     ...
     */
    public uk.nhs.connect.iucds.ucr.StrucDocTh.Scope.Enum getScope()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (uk.nhs.connect.iucds.ucr.StrucDocTh.Scope.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.StrucDocTh.Scope xgetScope()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocTh.Scope target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocTh.Scope)get_store().find_attribute_user(SCOPE$28);
            return target;
        }
    }
     ...
     */
    public void setScope(uk.nhs.connect.iucds.ucr.StrucDocTh.Scope.Enum scope)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetScope(uk.nhs.connect.iucds.ucr.StrucDocTh.Scope scope)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.StrucDocTh.Scope)get_store().add_attribute_user(SCOPE$28);
            }
            target.set(scope);
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.StrucDocTh.Align.Enum getAlign()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (uk.nhs.connect.iucds.ucr.StrucDocTh.Align.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.StrucDocTh.Align xgetAlign()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocTh.Align target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocTh.Align)get_store().find_attribute_user(ALIGN$34);
            return target;
        }
    }
     ...
     */
    public void setAlign(uk.nhs.connect.iucds.ucr.StrucDocTh.Align.Enum align)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetAlign(uk.nhs.connect.iucds.ucr.StrucDocTh.Align align)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.StrucDocTh.Align)get_store().add_attribute_user(ALIGN$34);
            }
            target.set(align);
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.StrucDocTh.Valign.Enum getValign()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (uk.nhs.connect.iucds.ucr.StrucDocTh.Valign.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.StrucDocTh.Valign xgetValign()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocTh.Valign target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocTh.Valign)get_store().find_attribute_user(VALIGN$40);
            return target;
        }
    }
     ...
     */
    public void setValign(uk.nhs.connect.iucds.ucr.StrucDocTh.Valign.Enum valign)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetValign(uk.nhs.connect.iucds.ucr.StrucDocTh.Valign valign)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.StrucDocTh.Valign)get_store().add_attribute_user(VALIGN$40);
            }
            target.set(valign);
        }
    }
     ...
     * An XML scope(@).
     *
     * This is an atomic type that is a restriction of uk.nhs.connect.iucds.ucr.StrucDocTh$Scope.
     */
    public static class ScopeImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements uk.nhs.connect.iucds.ucr.StrucDocTh.Scope
    {
        private static final long serialVersionUID = 1L;
     ...
     * An XML align(@).
     *
     * This is an atomic type that is a restriction of uk.nhs.connect.iucds.ucr.StrucDocTh$Align.
     */
    public static class AlignImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements uk.nhs.connect.iucds.ucr.StrucDocTh.Align
    {
        private static final long serialVersionUID = 1L;
     ...
     * An XML valign(@).
     *
     * This is an atomic type that is a restriction of uk.nhs.connect.iucds.ucr.StrucDocTh$Valign.
     */
    public static class ValignImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements uk.nhs.connect.iucds.ucr.StrucDocTh.Valign
    {
        private static final long serialVersionUID = 1L;
