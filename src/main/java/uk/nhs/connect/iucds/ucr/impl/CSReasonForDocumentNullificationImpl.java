 ...
 */
public class CSReasonForDocumentNullificationImpl extends uk.nhs.connect.iucds.ucr.impl.CSImpl implements uk.nhs.connect.iucds.ucr.CSReasonForDocumentNullification
{
    private static final long serialVersionUID = 1L;
    
    public CSReasonForDocumentNullificationImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
