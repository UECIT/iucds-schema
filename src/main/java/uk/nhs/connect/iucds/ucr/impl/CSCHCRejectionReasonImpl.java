 ...
 */
public class CSCHCRejectionReasonImpl extends uk.nhs.connect.iucds.ucr.impl.CSImpl implements uk.nhs.connect.iucds.ucr.CSCHCRejectionReason
{
    private static final long serialVersionUID = 1L;
    
    public CSCHCRejectionReasonImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
