 ...
 */
public class CDNPfITCDAUrlImpl extends uk.nhs.connect.iucds.ucr.impl.ANYImpl implements uk.nhs.connect.iucds.ucr.CDNPfITCDAUrl
{
     ...
     */
    public uk.nhs.connect.iucds.ucr.CdaNPfITED getOriginalText()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.CdaNPfITED target = null;
            target = (uk.nhs.connect.iucds.ucr.CdaNPfITED)get_store().find_element_user(ORIGINALTEXT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setOriginalText(uk.nhs.connect.iucds.ucr.CdaNPfITED originalText)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.CdaNPfITED addNewOriginalText()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.CdaNPfITED target = null;
            target = (uk.nhs.connect.iucds.ucr.CdaNPfITED)get_store().add_element_user(ORIGINALTEXT$0);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.CDNPfITCDAUrl.Group[] getGroupArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            uk.nhs.connect.iucds.ucr.CDNPfITCDAUrl.Group[] result = new uk.nhs.connect.iucds.ucr.CDNPfITCDAUrl.Group[targetList.size()];
            targetList.toArray(result);
            return result;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.CDNPfITCDAUrl.Group getGroupArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.CDNPfITCDAUrl.Group target = null;
            target = (uk.nhs.connect.iucds.ucr.CDNPfITCDAUrl.Group)get_store().find_element_user(GROUP$4, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
     ...
     */
    public void setGroupArray(uk.nhs.connect.iucds.ucr.CDNPfITCDAUrl.Group[] groupArray)
    {
        check_orphaned();
     ...
     */
    public void setGroupArray(int i, uk.nhs.connect.iucds.ucr.CDNPfITCDAUrl.Group group)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.CDNPfITCDAUrl.Group insertNewGroup(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.CDNPfITCDAUrl.Group target = null;
            target = (uk.nhs.connect.iucds.ucr.CDNPfITCDAUrl.Group)get_store().insert_element_user(GROUP$4, i);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.CDNPfITCDAUrl.Group addNewGroup()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.CDNPfITCDAUrl.Group target = null;
            target = (uk.nhs.connect.iucds.ucr.CDNPfITCDAUrl.Group)get_store().add_element_user(GROUP$4);
            return target;
        }
    }
     ...
     * This is a complex type.
     */
    public static class GroupImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.ucr.CDNPfITCDAUrl.Group
    {
        private static final long serialVersionUID = 1L;
