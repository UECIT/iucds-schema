 ...
 */
public class COCDTP145222GB02HealthCareFacilityImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.ucr.COCDTP145222GB02HealthCareFacility
{
    private static final long serialVersionUID = 1L;
    
    public COCDTP145222GB02HealthCareFacilityImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.IINPfITOidRequired[] getIdArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            uk.nhs.connect.iucds.ucr.IINPfITOidRequired[] result = new uk.nhs.connect.iucds.ucr.IINPfITOidRequired[targetList.size()];
     ...
     * Gets ith "id" element
     */
    public uk.nhs.connect.iucds.ucr.IINPfITOidRequired getIdArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.IINPfITOidRequired target = null;
            target = (uk.nhs.connect.iucds.ucr.IINPfITOidRequired)get_store().find_element_user(ID$2, i);
            if (target == null)
            {
     ...
     */
    public void setIdArray(uk.nhs.connect.iucds.ucr.IINPfITOidRequired[] idArray)
    {
        check_orphaned();
     ...
     * Sets ith "id" element
     */
    public void setIdArray(int i, uk.nhs.connect.iucds.ucr.IINPfITOidRequired id)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.IINPfITOidRequired insertNewId(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.IINPfITOidRequired target = null;
            target = (uk.nhs.connect.iucds.ucr.IINPfITOidRequired)get_store().insert_element_user(ID$2, i);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.IINPfITOidRequired addNewId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.IINPfITOidRequired target = null;
            target = (uk.nhs.connect.iucds.ucr.IINPfITOidRequired)get_store().add_element_user(ID$2);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP145222GB02HealthCareFacility.TemplateId getTemplateId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP145222GB02HealthCareFacility.TemplateId target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP145222GB02HealthCareFacility.TemplateId)get_store().find_element_user(TEMPLATEID$4, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setTemplateId(uk.nhs.connect.iucds.ucr.COCDTP145222GB02HealthCareFacility.TemplateId templateId)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP145222GB02HealthCareFacility.TemplateId addNewTemplateId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP145222GB02HealthCareFacility.TemplateId target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP145222GB02HealthCareFacility.TemplateId)get_store().add_element_user(TEMPLATEID$4);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP145222GB02Place getLocation()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP145222GB02Place target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP145222GB02Place)get_store().find_element_user(LOCATION$6, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setLocation(uk.nhs.connect.iucds.ucr.COCDTP145222GB02Place location)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP145222GB02Place addNewLocation()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP145222GB02Place target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP145222GB02Place)get_store().add_element_user(LOCATION$6);
            return target;
        }
    }
     ...
     * This is a complex type.
     */
    public static class TemplateIdImpl extends uk.nhs.connect.iucds.ucr.impl.IIImpl implements uk.nhs.connect.iucds.ucr.COCDTP145222GB02HealthCareFacility.TemplateId
    {
        private static final long serialVersionUID = 1L;
         ...
         */
        public static class RootImpl extends org.apache.xmlbeans.impl.values.XmlUnionImpl implements uk.nhs.connect.iucds.ucr.COCDTP145222GB02HealthCareFacility.TemplateId.Root, uk.nhs.connect.iucds.ucr.Oid, uk.nhs.connect.iucds.ucr.Uuid, uk.nhs.connect.iucds.ucr.Ruid
        {
            private static final long serialVersionUID = 1L;
         ...
         */
        public static class ExtensionImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements uk.nhs.connect.iucds.ucr.COCDTP145222GB02HealthCareFacility.TemplateId.Extension
        {
            private static final long serialVersionUID = 1L;
