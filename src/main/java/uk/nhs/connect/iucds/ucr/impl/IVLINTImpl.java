 ...
 */
public class IVLINTImpl extends uk.nhs.connect.iucds.ucr.impl.ANYImpl implements uk.nhs.connect.iucds.ucr.IVLINT
{
     ...
     */
    public uk.nhs.connect.iucds.ucr.IVLINT.Low getLow()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.IVLINT.Low target = null;
            target = (uk.nhs.connect.iucds.ucr.IVLINT.Low)get_store().find_element_user(LOW$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setLow(uk.nhs.connect.iucds.ucr.IVLINT.Low low)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.IVLINT.Low addNewLow()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.IVLINT.Low target = null;
            target = (uk.nhs.connect.iucds.ucr.IVLINT.Low)get_store().add_element_user(LOW$0);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.IVLINT.High getHigh()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.IVLINT.High target = null;
            target = (uk.nhs.connect.iucds.ucr.IVLINT.High)get_store().find_element_user(HIGH$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setHigh(uk.nhs.connect.iucds.ucr.IVLINT.High high)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.IVLINT.High addNewHigh()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.IVLINT.High target = null;
            target = (uk.nhs.connect.iucds.ucr.IVLINT.High)get_store().add_element_user(HIGH$2);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.Int2 xgetValue()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.ucr.Int2)get_store().find_attribute_user(VALUE$4);
            return target;
        }
    }
    ...
    public void xsetValue(uk.nhs.connect.iucds.ucr.Int2 value)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.Int2)get_store().add_attribute_user(VALUE$4);
            }
            target.set(value);
        }
    }
     ...
     * This is a complex type.
     */
    public static class LowImpl extends uk.nhs.connect.iucds.ucr.impl.INTImpl implements uk.nhs.connect.iucds.ucr.IVLINT.Low
    {
        private static final long serialVersionUID = 1L;
        ...
        public uk.nhs.connect.iucds.ucr.Bl2 xgetInclusive()
        {
            synchronized (monitor())
            {
                ...
                target = (uk.nhs.connect.iucds.ucr.Bl2)get_store().find_attribute_user(INCLUSIVE$0);
                if (target == null)
                {
                    target = (uk.nhs.connect.iucds.ucr.Bl2)get_default_attribute_value(INCLUSIVE$0);
                }
                return target;
            }
        }
        ...
        public void xsetInclusive(uk.nhs.connect.iucds.ucr.Bl2 inclusive)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (uk.nhs.connect.iucds.ucr.Bl2)get_store().add_attribute_user(INCLUSIVE$0);
                }
     ...
     * This is a complex type.
     */
    public static class HighImpl extends uk.nhs.connect.iucds.ucr.impl.INTImpl implements uk.nhs.connect.iucds.ucr.IVLINT.High
    {
        private static final long serialVersionUID = 1L;
