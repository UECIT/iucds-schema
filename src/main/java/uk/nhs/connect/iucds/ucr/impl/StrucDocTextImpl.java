 ...
 */
public class StrucDocTextImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.ucr.StrucDocText
{
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocTable getTableArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.ucr.StrucDocTable)get_store().find_element_user(TABLE$20, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocTable insertNewTable(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocTable target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocTable)get_store().insert_element_user(TABLE$20, i);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocTable addNewTable()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocTable target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocTable)get_store().add_element_user(TABLE$20);
            return target;
        }
    }
