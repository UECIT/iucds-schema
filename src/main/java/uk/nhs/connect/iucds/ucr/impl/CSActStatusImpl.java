 ...
 */
public class CSActStatusImpl extends uk.nhs.connect.iucds.ucr.impl.CSImpl implements uk.nhs.connect.iucds.ucr.CSActStatus
{
    private static final long serialVersionUID = 1L;
    
    public CSActStatusImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
