 ...
 */
public class COCDTP145007UK05PersonImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.ucr.COCDTP145007UK05Person
{
    private static final long serialVersionUID = 1L;
    
    public COCDTP145007UK05PersonImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP145007UK05Person.TemplateId getTemplateId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP145007UK05Person.TemplateId target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP145007UK05Person.TemplateId)get_store().find_element_user(TEMPLATEID$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setTemplateId(uk.nhs.connect.iucds.ucr.COCDTP145007UK05Person.TemplateId templateId)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP145007UK05Person.TemplateId addNewTemplateId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP145007UK05Person.TemplateId target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP145007UK05Person.TemplateId)get_store().add_element_user(TEMPLATEID$2);
            return target;
        }
    }
     ...
     * This is a complex type.
     */
    public static class TemplateIdImpl extends uk.nhs.connect.iucds.ucr.impl.IIImpl implements uk.nhs.connect.iucds.ucr.COCDTP145007UK05Person.TemplateId
    {
        private static final long serialVersionUID = 1L;
         ...
         */
        public static class RootImpl extends org.apache.xmlbeans.impl.values.XmlUnionImpl implements uk.nhs.connect.iucds.ucr.COCDTP145007UK05Person.TemplateId.Root, uk.nhs.connect.iucds.ucr.Oid, uk.nhs.connect.iucds.ucr.Uuid, uk.nhs.connect.iucds.ucr.Ruid
        {
            private static final long serialVersionUID = 1L;
         ...
         */
        public static class ExtensionImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements uk.nhs.connect.iucds.ucr.COCDTP145007UK05Person.TemplateId.Extension
        {
            private static final long serialVersionUID = 1L;
