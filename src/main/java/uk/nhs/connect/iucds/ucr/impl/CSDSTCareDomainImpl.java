 ...
 */
public class CSDSTCareDomainImpl extends uk.nhs.connect.iucds.ucr.impl.CSImpl implements uk.nhs.connect.iucds.ucr.CSDSTCareDomain
{
    private static final long serialVersionUID = 1L;
    
    public CSDSTCareDomainImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
