 ...
 */
public class CSXBasicConfidentialityKindImpl extends uk.nhs.connect.iucds.ucr.impl.CSImpl implements uk.nhs.connect.iucds.ucr.CSXBasicConfidentialityKind
{
    private static final long serialVersionUID = 1L;
    
    public CSXBasicConfidentialityKindImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
