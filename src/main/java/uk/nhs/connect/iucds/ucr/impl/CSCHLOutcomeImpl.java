 ...
 */
public class CSCHLOutcomeImpl extends uk.nhs.connect.iucds.ucr.impl.CSImpl implements uk.nhs.connect.iucds.ucr.CSCHLOutcome
{
    private static final long serialVersionUID = 1L;
    
    public CSCHLOutcomeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
