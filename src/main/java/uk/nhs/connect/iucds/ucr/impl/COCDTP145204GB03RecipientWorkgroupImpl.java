 ...
 */
public class COCDTP145204GB03RecipientWorkgroupImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.ucr.COCDTP145204GB03RecipientWorkgroup
{
    private static final long serialVersionUID = 1L;
    
    public COCDTP145204GB03RecipientWorkgroupImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP145204GB03RecipientWorkgroup.TemplateId getTemplateId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP145204GB03RecipientWorkgroup.TemplateId target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP145204GB03RecipientWorkgroup.TemplateId)get_store().find_element_user(TEMPLATEID$8, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setTemplateId(uk.nhs.connect.iucds.ucr.COCDTP145204GB03RecipientWorkgroup.TemplateId templateId)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP145204GB03RecipientWorkgroup.TemplateId addNewTemplateId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP145204GB03RecipientWorkgroup.TemplateId target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP145204GB03RecipientWorkgroup.TemplateId)get_store().add_element_user(TEMPLATEID$8);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP145204GB03Person getAssignedPerson()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP145204GB03Person target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP145204GB03Person)get_store().find_element_user(ASSIGNEDPERSON$10, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetAssignedPerson()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ASSIGNEDPERSON$10) != 0;
        }
    }
     ...
     */
    public void setAssignedPerson(uk.nhs.connect.iucds.ucr.COCDTP145204GB03Person assignedPerson)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP145204GB03Person addNewAssignedPerson()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP145204GB03Person target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP145204GB03Person)get_store().add_element_user(ASSIGNEDPERSON$10);
            return target;
        }
    }
    ...
    public void unsetAssignedPerson()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(ASSIGNEDPERSON$10, 0);
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP145204GB03Organization getRepresentedOrganization()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP145204GB03Organization target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP145204GB03Organization)get_store().find_element_user(REPRESENTEDORGANIZATION$12, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setRepresentedOrganization(uk.nhs.connect.iucds.ucr.COCDTP145204GB03Organization representedOrganization)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP145204GB03Organization addNewRepresentedOrganization()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP145204GB03Organization target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP145204GB03Organization)get_store().add_element_user(REPRESENTEDORGANIZATION$12);
            return target;
        }
    }
     ...
     * This is a complex type.
     */
    public static class TemplateIdImpl extends uk.nhs.connect.iucds.ucr.impl.IIImpl implements uk.nhs.connect.iucds.ucr.COCDTP145204GB03RecipientWorkgroup.TemplateId
    {
        private static final long serialVersionUID = 1L;
         ...
         */
        public static class RootImpl extends org.apache.xmlbeans.impl.values.XmlUnionImpl implements uk.nhs.connect.iucds.ucr.COCDTP145204GB03RecipientWorkgroup.TemplateId.Root, uk.nhs.connect.iucds.ucr.Oid, uk.nhs.connect.iucds.ucr.Uuid, uk.nhs.connect.iucds.ucr.Ruid
        {
            private static final long serialVersionUID = 1L;
         ...
         */
        public static class ExtensionImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements uk.nhs.connect.iucds.ucr.COCDTP145204GB03RecipientWorkgroup.TemplateId.Extension
        {
            private static final long serialVersionUID = 1L;
