 ...
 */
public class CSCDAActCodeImpl extends uk.nhs.connect.iucds.ucr.impl.CSImpl implements uk.nhs.connect.iucds.ucr.CSCDAActCode
{
    private static final long serialVersionUID = 1L;
    
    public CSCDAActCodeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
