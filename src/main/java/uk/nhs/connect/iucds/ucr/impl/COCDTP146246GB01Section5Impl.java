 ...
 */
public class COCDTP146246GB01Section5Impl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section5
{
    private static final long serialVersionUID = 1L;
    
    public COCDTP146246GB01Section5Impl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName COMPONENT5$10 = 
        new javax.xml.namespace.QName("urn:hl7-org:v3", "component5");
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section5.TemplateId getTemplateId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section5.TemplateId target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section5.TemplateId)get_store().find_element_user(TEMPLATEID$4, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setTemplateId(uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section5.TemplateId templateId)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section5.TemplateId addNewTemplateId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section5.TemplateId target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section5.TemplateId)get_store().add_element_user(TEMPLATEID$4);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component2[] getComponent5Array()
    {
        synchronized (monitor())
        {
            check_orphaned();
            java.util.List targetList = new java.util.ArrayList();
            get_store().find_all_element_users(COMPONENT5$10, targetList);
            uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component2[] result = new uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component2[targetList.size()];
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component2 getComponent5Array(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component2 target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component2)get_store().find_element_user(COMPONENT5$10, i);
            if (target == null)
            {
     ...
     */
    public boolean isNilComponent5Array(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public int sizeOfComponent5Array()
    {
        synchronized (monitor())
        {
            check_orphaned();
            return get_store().count_elements(COMPONENT5$10);
        }
    }
    
    /**
     * Sets array of all "component5" element  WARNING: This method is not atomicaly synchronized.
     */
    public void setComponent5Array(uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component2[] component5Array)
    {
        check_orphaned();
        arraySetterHelper(component5Array, COMPONENT5$10);
    }
    
    /**
     * Sets ith "component5" element
     */
    public void setComponent5Array(int i, uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component2 component5)
    {
        generatedSetterHelperImpl(component5, COMPONENT5$10, i, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_ARRAYITEM);
    }
    
    /**
     * Nils the ith "component5" element
     */
    public void setNilComponent5Array(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component2 insertNewComponent5(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component2 target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component2)get_store().insert_element_user(COMPONENT5$10, i);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component2 addNewComponent5()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component2 target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component2)get_store().add_element_user(COMPONENT5$10);
            return target;
        }
    }
     ...
     */
    public void removeComponent5(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(COMPONENT5$10, i);
        }
    }
     ...
     * This is a complex type.
     */
    public static class TemplateIdImpl extends uk.nhs.connect.iucds.ucr.impl.IIImpl implements uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section5.TemplateId
    {
        private static final long serialVersionUID = 1L;
         ...
         */
        public static class RootImpl extends org.apache.xmlbeans.impl.values.XmlUnionImpl implements uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section5.TemplateId.Root, uk.nhs.connect.iucds.ucr.Oid, uk.nhs.connect.iucds.ucr.Uuid, uk.nhs.connect.iucds.ucr.Ruid
        {
            private static final long serialVersionUID = 1L;
         ...
         */
        public static class ExtensionImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section5.TemplateId.Extension
        {
            private static final long serialVersionUID = 1L;
