 ...
 */
public class CVTriageOutcomeTypeImpl extends uk.nhs.connect.iucds.ucr.impl.CVImpl implements uk.nhs.connect.iucds.ucr.CVTriageOutcomeType
{
    private static final long serialVersionUID = 1L;
    
    public CVTriageOutcomeTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
