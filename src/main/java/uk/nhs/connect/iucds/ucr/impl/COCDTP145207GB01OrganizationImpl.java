 ...
 */
public class COCDTP145207GB01OrganizationImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.ucr.COCDTP145207GB01Organization
{
    private static final long serialVersionUID = 1L;
    
    public COCDTP145207GB01OrganizationImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     * Gets the "id" element
     */
    public uk.nhs.connect.iucds.ucr.COCDTP145207GB01Organization.Id getId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP145207GB01Organization.Id target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP145207GB01Organization.Id)get_store().find_element_user(ID$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     * Sets the "id" element
     */
    public void setId(uk.nhs.connect.iucds.ucr.COCDTP145207GB01Organization.Id id)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP145207GB01Organization.Id addNewId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP145207GB01Organization.Id target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP145207GB01Organization.Id)get_store().add_element_user(ID$0);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP145207GB01Organization.TemplateId getTemplateId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP145207GB01Organization.TemplateId target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP145207GB01Organization.TemplateId)get_store().find_element_user(TEMPLATEID$4, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setTemplateId(uk.nhs.connect.iucds.ucr.COCDTP145207GB01Organization.TemplateId templateId)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP145207GB01Organization.TemplateId addNewTemplateId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP145207GB01Organization.TemplateId target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP145207GB01Organization.TemplateId)get_store().add_element_user(TEMPLATEID$4);
            return target;
        }
    }
     ...
     * This is a complex type.
     */
    public static class IdImpl extends uk.nhs.connect.iucds.ucr.impl.IIImpl implements uk.nhs.connect.iucds.ucr.COCDTP145207GB01Organization.Id
    {
        private static final long serialVersionUID = 1L;
         ...
         */
        public static class RootImpl extends org.apache.xmlbeans.impl.values.XmlUnionImpl implements uk.nhs.connect.iucds.ucr.COCDTP145207GB01Organization.Id.Root, uk.nhs.connect.iucds.ucr.Oid, uk.nhs.connect.iucds.ucr.Uuid, uk.nhs.connect.iucds.ucr.Ruid
        {
            private static final long serialVersionUID = 1L;
         ...
         */
        public static class ExtensionImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements uk.nhs.connect.iucds.ucr.COCDTP145207GB01Organization.Id.Extension
        {
            private static final long serialVersionUID = 1L;
     ...
     * This is a complex type.
     */
    public static class TemplateIdImpl extends uk.nhs.connect.iucds.ucr.impl.IIImpl implements uk.nhs.connect.iucds.ucr.COCDTP145207GB01Organization.TemplateId
    {
        private static final long serialVersionUID = 1L;
         ...
         *     uk.nhs.connect.iucds.ucr.Ruid
         */
        public static class RootImpl extends org.apache.xmlbeans.impl.values.XmlUnionImpl implements uk.nhs.connect.iucds.ucr.COCDTP145207GB01Organization.TemplateId.Root, uk.nhs.connect.iucds.ucr.Oid, uk.nhs.connect.iucds.ucr.Uuid, uk.nhs.connect.iucds.ucr.Ruid
        {
            private static final long serialVersionUID = 1L;
         ...
         */
        public static class ExtensionImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements uk.nhs.connect.iucds.ucr.COCDTP145207GB01Organization.TemplateId.Extension
        {
            private static final long serialVersionUID = 1L;
