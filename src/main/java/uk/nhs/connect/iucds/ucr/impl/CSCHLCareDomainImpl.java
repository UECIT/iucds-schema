 ...
 */
public class CSCHLCareDomainImpl extends uk.nhs.connect.iucds.ucr.impl.CSImpl implements uk.nhs.connect.iucds.ucr.CSCHLCareDomain
{
    private static final long serialVersionUID = 1L;
    
    public CSCHLCareDomainImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
