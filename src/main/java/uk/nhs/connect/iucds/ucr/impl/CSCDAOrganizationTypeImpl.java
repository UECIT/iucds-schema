 ...
 */
public class CSCDAOrganizationTypeImpl extends uk.nhs.connect.iucds.ucr.impl.CSImpl implements uk.nhs.connect.iucds.ucr.CSCDAOrganizationType
{
    private static final long serialVersionUID = 1L;
    
    public CSCDAOrganizationTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
