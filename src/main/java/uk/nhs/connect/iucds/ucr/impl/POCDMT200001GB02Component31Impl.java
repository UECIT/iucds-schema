 ...
 */
public class POCDMT200001GB02Component31Impl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.ucr.POCDMT200001GB02Component31
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT200001GB02Component31Impl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName COCDTP146246GB01SECTION1$2 = 
        new javax.xml.namespace.QName("urn:hl7-org:v3", "COCD_TP146246GB01.Section1");
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section1 getCOCDTP146246GB01Section1()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section1 target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section1)get_store().find_element_user(COCDTP146246GB01SECTION1$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setCOCDTP146246GB01Section1(uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section1 cocdtp146246GB01Section1)
    {
        generatedSetterHelperImpl(cocdtp146246GB01Section1, COCDTP146246GB01SECTION1$2, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "COCD_TP146246GB01.Section1" element
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section1 addNewCOCDTP146246GB01Section1()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section1 target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section1)get_store().add_element_user(COCDTP146246GB01SECTION1$2);
            return target;
        }
    }
