 ...
 */
public class CVTriageDispositionTypeImpl extends uk.nhs.connect.iucds.ucr.impl.CVImpl implements uk.nhs.connect.iucds.ucr.CVTriageDispositionType
{
    private static final long serialVersionUID = 1L;
    
    public CVTriageDispositionTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
