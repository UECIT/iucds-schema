 ...
 */
public class CSSealingActTypeImpl extends uk.nhs.connect.iucds.ucr.impl.CSImpl implements uk.nhs.connect.iucds.ucr.CSSealingActType
{
    private static final long serialVersionUID = 1L;
    
    public CSSealingActTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
