 ...
 */
public class COCDTP146093GB01AppointmentReferenceImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.ucr.COCDTP146093GB01AppointmentReference
{
    private static final long serialVersionUID = 1L;
    
    public COCDTP146093GB01AppointmentReferenceImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146093GB01AppointmentReference.EffectiveTime getEffectiveTime()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146093GB01AppointmentReference.EffectiveTime target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146093GB01AppointmentReference.EffectiveTime)get_store().find_element_user(EFFECTIVETIME$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setEffectiveTime(uk.nhs.connect.iucds.ucr.COCDTP146093GB01AppointmentReference.EffectiveTime effectiveTime)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146093GB01AppointmentReference.EffectiveTime addNewEffectiveTime()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146093GB01AppointmentReference.EffectiveTime target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146093GB01AppointmentReference.EffectiveTime)get_store().add_element_user(EFFECTIVETIME$2);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.II getId()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.ucr.II)get_store().find_element_user(ID$4, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146093GB01AppointmentReference.TemplateId getTemplateId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146093GB01AppointmentReference.TemplateId target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146093GB01AppointmentReference.TemplateId)get_store().find_element_user(TEMPLATEID$6, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setTemplateId(uk.nhs.connect.iucds.ucr.COCDTP146093GB01AppointmentReference.TemplateId templateId)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146093GB01AppointmentReference.TemplateId addNewTemplateId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146093GB01AppointmentReference.TemplateId target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146093GB01AppointmentReference.TemplateId)get_store().add_element_user(TEMPLATEID$6);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146093GB01Location getLocation()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146093GB01Location target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146093GB01Location)get_store().find_element_user(LOCATION$8, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setLocation(uk.nhs.connect.iucds.ucr.COCDTP146093GB01Location location)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146093GB01Location addNewLocation()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146093GB01Location target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146093GB01Location)get_store().add_element_user(LOCATION$8);
            return target;
        }
    }
     ...
     * This is a complex type.
     */
    public static class EffectiveTimeImpl extends uk.nhs.connect.iucds.ucr.impl.TSImpl implements uk.nhs.connect.iucds.ucr.COCDTP146093GB01AppointmentReference.EffectiveTime
    {
        private static final long serialVersionUID = 1L;
     ...
     * This is a complex type.
     */
    public static class TemplateIdImpl extends uk.nhs.connect.iucds.ucr.impl.IIImpl implements uk.nhs.connect.iucds.ucr.COCDTP146093GB01AppointmentReference.TemplateId
    {
        private static final long serialVersionUID = 1L;
         ...
         */
        public static class RootImpl extends org.apache.xmlbeans.impl.values.XmlUnionImpl implements uk.nhs.connect.iucds.ucr.COCDTP146093GB01AppointmentReference.TemplateId.Root, uk.nhs.connect.iucds.ucr.Oid, uk.nhs.connect.iucds.ucr.Uuid, uk.nhs.connect.iucds.ucr.Ruid
        {
            private static final long serialVersionUID = 1L;
         ...
         */
        public static class ExtensionImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements uk.nhs.connect.iucds.ucr.COCDTP146093GB01AppointmentReference.TemplateId.Extension
        {
            private static final long serialVersionUID = 1L;
