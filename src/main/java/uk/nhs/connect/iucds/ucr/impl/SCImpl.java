 ...
 */
public class SCImpl extends uk.nhs.connect.iucds.ucr.impl.STImpl implements uk.nhs.connect.iucds.ucr.SC
{
    ...
    public uk.nhs.connect.iucds.ucr.St2 xgetCodeSystemName()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.ucr.St2)get_store().find_attribute_user(CODESYSTEMNAME$4);
            return target;
        }
    }
    ...
    public void xsetCodeSystemName(uk.nhs.connect.iucds.ucr.St2 codeSystemName)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.St2)get_store().add_attribute_user(CODESYSTEMNAME$4);
            }
    ...
    public uk.nhs.connect.iucds.ucr.St2 xgetCodeSystemVersion()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.St2 target = null;
            target = (uk.nhs.connect.iucds.ucr.St2)get_store().find_attribute_user(CODESYSTEMVERSION$6);
            return target;
        }
    }
    ...
    public void xsetCodeSystemVersion(uk.nhs.connect.iucds.ucr.St2 codeSystemVersion)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.St2)get_store().add_attribute_user(CODESYSTEMVERSION$6);
            }
    ...
    public uk.nhs.connect.iucds.ucr.St2 xgetDisplayName()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.St2 target = null;
            target = (uk.nhs.connect.iucds.ucr.St2)get_store().find_attribute_user(DISPLAYNAME$8);
            return target;
        }
    }
    ...
    public void xsetDisplayName(uk.nhs.connect.iucds.ucr.St2 displayName)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.St2)get_store().add_attribute_user(DISPLAYNAME$8);
            }
