 ...
 */
public class CSGPESMessageTypeImpl extends uk.nhs.connect.iucds.ucr.impl.CSImpl implements uk.nhs.connect.iucds.ucr.CSGPESMessageType
{
    private static final long serialVersionUID = 1L;
    
    public CSGPESMessageTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
