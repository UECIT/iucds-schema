 ...
 */
public class COCDTP145222GB02PlaceImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.ucr.COCDTP145222GB02Place
{
    private static final long serialVersionUID = 1L;
    
    public COCDTP145222GB02PlaceImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.TN getName()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.TN target = null;
            target = (uk.nhs.connect.iucds.ucr.TN)get_store().find_element_user(NAME$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setName(uk.nhs.connect.iucds.ucr.TN name)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.TN addNewName()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.TN target = null;
            target = (uk.nhs.connect.iucds.ucr.TN)get_store().add_element_user(NAME$2);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP145222GB02Place.TemplateId getTemplateId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP145222GB02Place.TemplateId target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP145222GB02Place.TemplateId)get_store().find_element_user(TEMPLATEID$4, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setTemplateId(uk.nhs.connect.iucds.ucr.COCDTP145222GB02Place.TemplateId templateId)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP145222GB02Place.TemplateId addNewTemplateId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP145222GB02Place.TemplateId target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP145222GB02Place.TemplateId)get_store().add_element_user(TEMPLATEID$4);
            return target;
        }
    }
     ...
     * This is a complex type.
     */
    public static class TemplateIdImpl extends uk.nhs.connect.iucds.ucr.impl.IIImpl implements uk.nhs.connect.iucds.ucr.COCDTP145222GB02Place.TemplateId
    {
        private static final long serialVersionUID = 1L;
         ...
         */
        public static class RootImpl extends org.apache.xmlbeans.impl.values.XmlUnionImpl implements uk.nhs.connect.iucds.ucr.COCDTP145222GB02Place.TemplateId.Root, uk.nhs.connect.iucds.ucr.Oid, uk.nhs.connect.iucds.ucr.Uuid, uk.nhs.connect.iucds.ucr.Ruid
        {
            private static final long serialVersionUID = 1L;
         ...
         */
        public static class ExtensionImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements uk.nhs.connect.iucds.ucr.COCDTP145222GB02Place.TemplateId.Extension
        {
            private static final long serialVersionUID = 1L;
