 ...
 */
public class CSDSTEligibilityOutcomeImpl extends uk.nhs.connect.iucds.ucr.impl.CSImpl implements uk.nhs.connect.iucds.ucr.CSDSTEligibilityOutcome
{
    private static final long serialVersionUID = 1L;
    
    public CSDSTEligibilityOutcomeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
