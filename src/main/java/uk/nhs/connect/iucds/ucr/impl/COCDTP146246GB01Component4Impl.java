/*
 * XML Type:  COCD_TP146246GB01.Component4
 * Namespace: urn:hl7-org:v3
 * Java type: uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component4
 *
 * Automatically generated - do not modify.
 */
package uk.nhs.connect.iucds.ucr.impl;
/**
 * An XML COCD_TP146246GB01.Component4(@urn:hl7-org:v3).
 *
 * This is a complex type.
 */
public class COCDTP146246GB01Component4Impl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component4
{
    private static final long serialVersionUID = 1L;
    
    public COCDTP146246GB01Component4Impl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName SECTION3$2 = 
        new javax.xml.namespace.QName("urn:hl7-org:v3", "section3");
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component4.TemplateId getTemplateId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component4.TemplateId target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component4.TemplateId)get_store().find_element_user(TEMPLATEID$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setTemplateId(uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component4.TemplateId templateId)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component4.TemplateId addNewTemplateId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component4.TemplateId target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component4.TemplateId)get_store().add_element_user(TEMPLATEID$0);
            return target;
        }
    }
    
    /**
     * Gets the "section3" element
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section3 getSection3()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section3 target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section3)get_store().find_element_user(SECTION3$2, 0);
            if (target == null)
            {
                return null;
            }
    ...
    /**
     * Tests for nil "section3" element
     */
    public boolean isNilSection3()
    {
        synchronized (monitor())
        {
            check_orphaned();
    ...
    /**
     * Sets the "section3" element
     */
    public void setSection3(uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section3 section3)
    {
        generatedSetterHelperImpl(section3, SECTION3$2, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "section3" element
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section3 addNewSection3()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section3 target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section3)get_store().add_element_user(SECTION3$2);
            return target;
        }
    }
    
    /**
     * Nils the "section3" element
     */
    public void setNilSection3()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class TemplateIdImpl extends uk.nhs.connect.iucds.ucr.impl.IIImpl implements uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component4.TemplateId
    {
        private static final long serialVersionUID = 1L;
         ...
         */
        public static class RootImpl extends org.apache.xmlbeans.impl.values.XmlUnionImpl implements uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component4.TemplateId.Root, uk.nhs.connect.iucds.ucr.Oid, uk.nhs.connect.iucds.ucr.Uuid, uk.nhs.connect.iucds.ucr.Ruid
        {
            private static final long serialVersionUID = 1L;
         ...
         * An XML extension(@).
         *
         * This is an atomic type that is a restriction of uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component4$TemplateId$Extension.
         */
        public static class ExtensionImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component4.TemplateId.Extension
        {
            private static final long serialVersionUID = 1L;
