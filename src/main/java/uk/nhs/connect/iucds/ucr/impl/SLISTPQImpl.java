 ...
 */
public class SLISTPQImpl extends uk.nhs.connect.iucds.ucr.impl.ANYImpl implements uk.nhs.connect.iucds.ucr.SLISTPQ
{
     ...
     */
    public uk.nhs.connect.iucds.ucr.PQ getOrigin()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.PQ target = null;
            target = (uk.nhs.connect.iucds.ucr.PQ)get_store().find_element_user(ORIGIN$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setOrigin(uk.nhs.connect.iucds.ucr.PQ origin)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.PQ addNewOrigin()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.PQ target = null;
            target = (uk.nhs.connect.iucds.ucr.PQ)get_store().add_element_user(ORIGIN$0);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.PQ getScale()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.PQ target = null;
            target = (uk.nhs.connect.iucds.ucr.PQ)get_store().find_element_user(SCALE$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setScale(uk.nhs.connect.iucds.ucr.PQ scale)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.PQ addNewScale()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.PQ target = null;
            target = (uk.nhs.connect.iucds.ucr.PQ)get_store().add_element_user(SCALE$2);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.ListInt xgetDigits()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.ListInt target = null;
            target = (uk.nhs.connect.iucds.ucr.ListInt)get_store().find_element_user(DIGITS$4, 0);
            return target;
        }
    }
     ...
     */
    public void xsetDigits(uk.nhs.connect.iucds.ucr.ListInt digits)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.ListInt)get_store().add_element_user(DIGITS$4);
            }
            target.set(digits);
        }
    }
