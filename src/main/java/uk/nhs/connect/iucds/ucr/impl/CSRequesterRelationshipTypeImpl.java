 ...
 */
public class CSRequesterRelationshipTypeImpl extends uk.nhs.connect.iucds.ucr.impl.CSImpl implements uk.nhs.connect.iucds.ucr.CSRequesterRelationshipType
{
    private static final long serialVersionUID = 1L;
    
    public CSRequesterRelationshipTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
