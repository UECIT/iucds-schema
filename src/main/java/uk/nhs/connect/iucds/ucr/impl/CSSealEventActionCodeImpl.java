 ...
 */
public class CSSealEventActionCodeImpl extends uk.nhs.connect.iucds.ucr.impl.CSImpl implements uk.nhs.connect.iucds.ucr.CSSealEventActionCode
{
    private static final long serialVersionUID = 1L;
    
    public CSSealEventActionCodeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
