 ...
 */
public class StrucDocContentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.ucr.StrucDocContent
{
     ...
     */
    public uk.nhs.connect.iucds.ucr.StrucDocContent.Revised.Enum getRevised()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (uk.nhs.connect.iucds.ucr.StrucDocContent.Revised.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.StrucDocContent.Revised xgetRevised()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocContent.Revised target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocContent.Revised)get_store().find_attribute_user(REVISED$22);
            return target;
        }
    }
     ...
     */
    public void setRevised(uk.nhs.connect.iucds.ucr.StrucDocContent.Revised.Enum revised)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetRevised(uk.nhs.connect.iucds.ucr.StrucDocContent.Revised revised)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.StrucDocContent.Revised)get_store().add_attribute_user(REVISED$22);
            }
            target.set(revised);
        }
    }
     ...
     */
    public static class RevisedImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements uk.nhs.connect.iucds.ucr.StrucDocContent.Revised
    {
        private static final long serialVersionUID = 1L;
