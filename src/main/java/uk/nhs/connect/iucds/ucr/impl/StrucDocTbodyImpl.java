 ...
 */
public class StrucDocTbodyImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.ucr.StrucDocTbody
{
     ...
     */
    public uk.nhs.connect.iucds.ucr.StrucDocTr[] getTrArray()
    {
        synchronized (monitor())
        {
            ...
            uk.nhs.connect.iucds.ucr.StrucDocTr[] result = new uk.nhs.connect.iucds.ucr.StrucDocTr[targetList.size()];
     ...
     * Gets ith "tr" element
     */
    public uk.nhs.connect.iucds.ucr.StrucDocTr getTrArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocTr target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocTr)get_store().find_element_user(TR$0, i);
            if (target == null)
            {
     ...
     */
    public void setTrArray(uk.nhs.connect.iucds.ucr.StrucDocTr[] trArray)
    {
        check_orphaned();
     ...
     * Sets ith "tr" element
     */
    public void setTrArray(int i, uk.nhs.connect.iucds.ucr.StrucDocTr tr)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.StrucDocTr insertNewTr(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocTr target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocTr)get_store().insert_element_user(TR$0, i);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.StrucDocTr addNewTr()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocTr target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocTr)get_store().add_element_user(TR$0);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.StrucDocTbody.Align.Enum getAlign()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (uk.nhs.connect.iucds.ucr.StrucDocTbody.Align.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.StrucDocTbody.Align xgetAlign()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocTbody.Align target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocTbody.Align)get_store().find_attribute_user(ALIGN$8);
            return target;
        }
    }
     ...
     */
    public void setAlign(uk.nhs.connect.iucds.ucr.StrucDocTbody.Align.Enum align)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetAlign(uk.nhs.connect.iucds.ucr.StrucDocTbody.Align align)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.StrucDocTbody.Align)get_store().add_attribute_user(ALIGN$8);
            }
            target.set(align);
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.StrucDocTbody.Valign.Enum getValign()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (uk.nhs.connect.iucds.ucr.StrucDocTbody.Valign.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.StrucDocTbody.Valign xgetValign()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocTbody.Valign target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocTbody.Valign)get_store().find_attribute_user(VALIGN$14);
            return target;
        }
    }
     ...
     */
    public void setValign(uk.nhs.connect.iucds.ucr.StrucDocTbody.Valign.Enum valign)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetValign(uk.nhs.connect.iucds.ucr.StrucDocTbody.Valign valign)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.StrucDocTbody.Valign)get_store().add_attribute_user(VALIGN$14);
            }
            target.set(valign);
        }
    }
     ...
     */
    public static class AlignImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements uk.nhs.connect.iucds.ucr.StrucDocTbody.Align
    {
        private static final long serialVersionUID = 1L;
     ...
     */
    public static class ValignImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements uk.nhs.connect.iucds.ucr.StrucDocTbody.Valign
    {
        private static final long serialVersionUID = 1L;
