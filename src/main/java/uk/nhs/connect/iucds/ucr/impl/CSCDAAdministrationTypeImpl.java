 ...
 */
public class CSCDAAdministrationTypeImpl extends uk.nhs.connect.iucds.ucr.impl.CSImpl implements uk.nhs.connect.iucds.ucr.CSCDAAdministrationType
{
    private static final long serialVersionUID = 1L;
    
    public CSCDAAdministrationTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
