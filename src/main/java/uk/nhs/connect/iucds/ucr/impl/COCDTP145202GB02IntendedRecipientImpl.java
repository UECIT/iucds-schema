 ...
 */
public class COCDTP145202GB02IntendedRecipientImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.ucr.COCDTP145202GB02IntendedRecipient
{
    private static final long serialVersionUID = 1L;
    
    public COCDTP145202GB02IntendedRecipientImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName RECIPIENTROLECODE$4 = 
    ...
    public uk.nhs.connect.iucds.ucr.IINPfITOidRequiredAssigningAuthorityName getIdArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.ucr.IINPfITOidRequiredAssigningAuthorityName)get_store().find_element_user(ID$2, i);
            if (target == null)
            {
    ...
    public uk.nhs.connect.iucds.ucr.IINPfITOidRequiredAssigningAuthorityName insertNewId(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.IINPfITOidRequiredAssigningAuthorityName target = null;
            target = (uk.nhs.connect.iucds.ucr.IINPfITOidRequiredAssigningAuthorityName)get_store().insert_element_user(ID$2, i);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.CV getRecipientRoleCode()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.ucr.CV)get_store().find_element_user(RECIPIENTROLECODE$4, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetRecipientRoleCode()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(RECIPIENTROLECODE$4) != 0;
        }
    }
    ...
    {
        generatedSetterHelperImpl(recipientRoleCode, RECIPIENTROLECODE$4, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public uk.nhs.connect.iucds.ucr.CV addNewRecipientRoleCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.CV target = null;
            target = (uk.nhs.connect.iucds.ucr.CV)get_store().add_element_user(RECIPIENTROLECODE$4);
            return target;
        }
    }
    ...
    public void unsetRecipientRoleCode()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(RECIPIENTROLECODE$4, 0);
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP145202GB02IntendedRecipient.TemplateId getTemplateId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP145202GB02IntendedRecipient.TemplateId target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP145202GB02IntendedRecipient.TemplateId)get_store().find_element_user(TEMPLATEID$8, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setTemplateId(uk.nhs.connect.iucds.ucr.COCDTP145202GB02IntendedRecipient.TemplateId templateId)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP145202GB02IntendedRecipient.TemplateId addNewTemplateId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP145202GB02IntendedRecipient.TemplateId target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP145202GB02IntendedRecipient.TemplateId)get_store().add_element_user(TEMPLATEID$8);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP145202GB02Person getAssignedPerson()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP145202GB02Person target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP145202GB02Person)get_store().find_element_user(ASSIGNEDPERSON$10, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setAssignedPerson(uk.nhs.connect.iucds.ucr.COCDTP145202GB02Person assignedPerson)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP145202GB02Person addNewAssignedPerson()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP145202GB02Person target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP145202GB02Person)get_store().add_element_user(ASSIGNEDPERSON$10);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP145202GB02Organization getRepresentedOrganization()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP145202GB02Organization target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP145202GB02Organization)get_store().find_element_user(REPRESENTEDORGANIZATION$12, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setRepresentedOrganization(uk.nhs.connect.iucds.ucr.COCDTP145202GB02Organization representedOrganization)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP145202GB02Organization addNewRepresentedOrganization()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP145202GB02Organization target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP145202GB02Organization)get_store().add_element_user(REPRESENTEDORGANIZATION$12);
            return target;
        }
    }
     ...
     * This is a complex type.
     */
    public static class TemplateIdImpl extends uk.nhs.connect.iucds.ucr.impl.IIImpl implements uk.nhs.connect.iucds.ucr.COCDTP145202GB02IntendedRecipient.TemplateId
    {
        private static final long serialVersionUID = 1L;
         ...
         */
        public static class RootImpl extends org.apache.xmlbeans.impl.values.XmlUnionImpl implements uk.nhs.connect.iucds.ucr.COCDTP145202GB02IntendedRecipient.TemplateId.Root, uk.nhs.connect.iucds.ucr.Oid, uk.nhs.connect.iucds.ucr.Uuid, uk.nhs.connect.iucds.ucr.Ruid
        {
            private static final long serialVersionUID = 1L;
         ...
         */
        public static class ExtensionImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements uk.nhs.connect.iucds.ucr.COCDTP145202GB02IntendedRecipient.TemplateId.Extension
        {
            private static final long serialVersionUID = 1L;
