 ...
 */
public class CSTriageOutcomeTypeImpl extends uk.nhs.connect.iucds.ucr.impl.CSImpl implements uk.nhs.connect.iucds.ucr.CSTriageOutcomeType
{
    private static final long serialVersionUID = 1L;
    
    public CSTriageOutcomeTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
