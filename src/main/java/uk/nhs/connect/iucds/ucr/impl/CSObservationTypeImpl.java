 ...
 */
public class CSObservationTypeImpl extends uk.nhs.connect.iucds.ucr.impl.CSImpl implements uk.nhs.connect.iucds.ucr.CSObservationType
{
    private static final long serialVersionUID = 1L;
    
    public CSObservationTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
