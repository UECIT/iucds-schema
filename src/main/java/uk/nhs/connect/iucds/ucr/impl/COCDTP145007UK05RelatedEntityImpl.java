 ...
 */
public class COCDTP145007UK05RelatedEntityImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.ucr.COCDTP145007UK05RelatedEntity
{
    private static final long serialVersionUID = 1L;
    
    public COCDTP145007UK05RelatedEntityImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP145007UK05RelatedEntity.TemplateId getTemplateId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP145007UK05RelatedEntity.TemplateId target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP145007UK05RelatedEntity.TemplateId)get_store().find_element_user(TEMPLATEID$6, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setTemplateId(uk.nhs.connect.iucds.ucr.COCDTP145007UK05RelatedEntity.TemplateId templateId)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP145007UK05RelatedEntity.TemplateId addNewTemplateId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP145007UK05RelatedEntity.TemplateId target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP145007UK05RelatedEntity.TemplateId)get_store().add_element_user(TEMPLATEID$6);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP145007UK05Person getRelationshipHolder()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP145007UK05Person target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP145007UK05Person)get_store().find_element_user(RELATIONSHIPHOLDER$8, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setRelationshipHolder(uk.nhs.connect.iucds.ucr.COCDTP145007UK05Person relationshipHolder)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP145007UK05Person addNewRelationshipHolder()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP145007UK05Person target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP145007UK05Person)get_store().add_element_user(RELATIONSHIPHOLDER$8);
            return target;
        }
    }
     ...
     * This is a complex type.
     */
    public static class TemplateIdImpl extends uk.nhs.connect.iucds.ucr.impl.IIImpl implements uk.nhs.connect.iucds.ucr.COCDTP145007UK05RelatedEntity.TemplateId
    {
        private static final long serialVersionUID = 1L;
         ...
         */
        public static class RootImpl extends org.apache.xmlbeans.impl.values.XmlUnionImpl implements uk.nhs.connect.iucds.ucr.COCDTP145007UK05RelatedEntity.TemplateId.Root, uk.nhs.connect.iucds.ucr.Oid, uk.nhs.connect.iucds.ucr.Uuid, uk.nhs.connect.iucds.ucr.Ruid
        {
            private static final long serialVersionUID = 1L;
         ...
         */
        public static class ExtensionImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements uk.nhs.connect.iucds.ucr.COCDTP145007UK05RelatedEntity.TemplateId.Extension
        {
            private static final long serialVersionUID = 1L;
