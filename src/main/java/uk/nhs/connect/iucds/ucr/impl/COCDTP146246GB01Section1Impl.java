 ...
 */
public class COCDTP146246GB01Section1Impl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section1
{
    private static final long serialVersionUID = 1L;
    
    public COCDTP146246GB01Section1Impl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName COMPONENT1$12 = 
        new javax.xml.namespace.QName("urn:hl7-org:v3", "component1");
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section1.TemplateId getTemplateId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section1.TemplateId target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section1.TemplateId)get_store().find_element_user(TEMPLATEID$4, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setTemplateId(uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section1.TemplateId templateId)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section1.TemplateId addNewTemplateId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section1.TemplateId target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section1.TemplateId)get_store().add_element_user(TEMPLATEID$4);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146246GB01Author1 getAuthor()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146246GB01Author1 target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146246GB01Author1)get_store().find_element_user(AUTHOR$10, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setAuthor(uk.nhs.connect.iucds.ucr.COCDTP146246GB01Author1 author)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146246GB01Author1 addNewAuthor()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146246GB01Author1 target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146246GB01Author1)get_store().add_element_user(AUTHOR$10);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component3[] getComponent1Array()
    {
        synchronized (monitor())
        {
            check_orphaned();
            java.util.List targetList = new java.util.ArrayList();
            get_store().find_all_element_users(COMPONENT1$12, targetList);
            uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component3[] result = new uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component3[targetList.size()];
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component3 getComponent1Array(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component3 target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component3)get_store().find_element_user(COMPONENT1$12, i);
            if (target == null)
            {
     ...
     */
    public boolean isNilComponent1Array(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public int sizeOfComponent1Array()
    {
        synchronized (monitor())
        {
            check_orphaned();
            return get_store().count_elements(COMPONENT1$12);
        }
    }
    
    /**
     * Sets array of all "component1" element  WARNING: This method is not atomicaly synchronized.
     */
    public void setComponent1Array(uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component3[] component1Array)
    {
        check_orphaned();
        arraySetterHelper(component1Array, COMPONENT1$12);
    }
    
    /**
     * Sets ith "component1" element
     */
    public void setComponent1Array(int i, uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component3 component1)
    {
        generatedSetterHelperImpl(component1, COMPONENT1$12, i, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_ARRAYITEM);
    }
    
    /**
     * Nils the ith "component1" element
     */
    public void setNilComponent1Array(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component3 insertNewComponent1(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component3 target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component3)get_store().insert_element_user(COMPONENT1$12, i);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component3 addNewComponent1()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component3 target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component3)get_store().add_element_user(COMPONENT1$12);
            return target;
        }
    }
     ...
     */
    public void removeComponent1(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(COMPONENT1$12, i);
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.Cs2 xgetMoodCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.Cs2 target = null;
            target = (uk.nhs.connect.iucds.ucr.Cs2)get_store().find_attribute_user(MOODCODE$20);
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.Cs2)get_default_attribute_value(MOODCODE$20);
            }
            return target;
        }
    }
    ...
    public void xsetMoodCode(uk.nhs.connect.iucds.ucr.Cs2 moodCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.Cs2)get_store().add_attribute_user(MOODCODE$20);
            }
            target.set(moodCode);
        }
    }
     ...
     * This is a complex type.
     */
    public static class TemplateIdImpl extends uk.nhs.connect.iucds.ucr.impl.IIImpl implements uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section1.TemplateId
    {
        private static final long serialVersionUID = 1L;
         ...
         */
        public static class RootImpl extends org.apache.xmlbeans.impl.values.XmlUnionImpl implements uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section1.TemplateId.Root, uk.nhs.connect.iucds.ucr.Oid, uk.nhs.connect.iucds.ucr.Uuid, uk.nhs.connect.iucds.ucr.Ruid
        {
            private static final long serialVersionUID = 1L;
         ...
         */
        public static class ExtensionImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section1.TemplateId.Extension
        {
            private static final long serialVersionUID = 1L;
