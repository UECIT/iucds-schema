 ...
 */
public class COCDTP146093GB01OrganizationImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.ucr.COCDTP146093GB01Organization
{
    private static final long serialVersionUID = 1L;
    
    public COCDTP146093GB01OrganizationImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.ST getDesc()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.ST target = null;
            target = (uk.nhs.connect.iucds.ucr.ST)get_store().find_element_user(DESC$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setDesc(uk.nhs.connect.iucds.ucr.ST desc)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.ST addNewDesc()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.ST target = null;
            target = (uk.nhs.connect.iucds.ucr.ST)get_store().add_element_user(DESC$0);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.ST getName()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.ST target = null;
            target = (uk.nhs.connect.iucds.ucr.ST)get_store().find_element_user(NAME$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setName(uk.nhs.connect.iucds.ucr.ST name)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.ST addNewName()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.ST target = null;
            target = (uk.nhs.connect.iucds.ucr.ST)get_store().add_element_user(NAME$2);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146093GB01Organization.TemplateId getTemplateId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146093GB01Organization.TemplateId target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146093GB01Organization.TemplateId)get_store().find_element_user(TEMPLATEID$4, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setTemplateId(uk.nhs.connect.iucds.ucr.COCDTP146093GB01Organization.TemplateId templateId)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146093GB01Organization.TemplateId addNewTemplateId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146093GB01Organization.TemplateId target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146093GB01Organization.TemplateId)get_store().add_element_user(TEMPLATEID$4);
            return target;
        }
    }
     ...
     * This is a complex type.
     */
    public static class TemplateIdImpl extends uk.nhs.connect.iucds.ucr.impl.IIImpl implements uk.nhs.connect.iucds.ucr.COCDTP146093GB01Organization.TemplateId
    {
        private static final long serialVersionUID = 1L;
         ...
         */
        public static class RootImpl extends org.apache.xmlbeans.impl.values.XmlUnionImpl implements uk.nhs.connect.iucds.ucr.COCDTP146093GB01Organization.TemplateId.Root, uk.nhs.connect.iucds.ucr.Oid, uk.nhs.connect.iucds.ucr.Uuid, uk.nhs.connect.iucds.ucr.Ruid
        {
            private static final long serialVersionUID = 1L;
         ...
         */
        public static class ExtensionImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements uk.nhs.connect.iucds.ucr.COCDTP146093GB01Organization.TemplateId.Extension
        {
            private static final long serialVersionUID = 1L;
