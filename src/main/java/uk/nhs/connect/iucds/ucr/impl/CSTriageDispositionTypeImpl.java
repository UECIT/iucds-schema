 ...
 */
public class CSTriageDispositionTypeImpl extends uk.nhs.connect.iucds.ucr.impl.CSImpl implements uk.nhs.connect.iucds.ucr.CSTriageDispositionType
{
    private static final long serialVersionUID = 1L;
    
    public CSTriageDispositionTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
