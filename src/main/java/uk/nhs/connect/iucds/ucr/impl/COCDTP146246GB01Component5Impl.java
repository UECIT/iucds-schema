 ...
 */
public class COCDTP146246GB01Component5Impl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component5
{
    private static final long serialVersionUID = 1L;
    
    public COCDTP146246GB01Component5Impl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName SECTION4$2 = 
        new javax.xml.namespace.QName("urn:hl7-org:v3", "section4");
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component5.TemplateId getTemplateId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component5.TemplateId target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component5.TemplateId)get_store().find_element_user(TEMPLATEID$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setTemplateId(uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component5.TemplateId templateId)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component5.TemplateId addNewTemplateId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component5.TemplateId target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component5.TemplateId)get_store().add_element_user(TEMPLATEID$0);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section4 getSection4()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section4 target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section4)get_store().find_element_user(SECTION4$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setSection4(uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section4 section4)
    {
        generatedSetterHelperImpl(section4, SECTION4$2, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "section4" element
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section4 addNewSection4()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section4 target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section4)get_store().add_element_user(SECTION4$2);
            return target;
        }
    }
     ...
     * This is a complex type.
     */
    public static class TemplateIdImpl extends uk.nhs.connect.iucds.ucr.impl.IIImpl implements uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component5.TemplateId
    {
        private static final long serialVersionUID = 1L;
         ...
         */
        public static class RootImpl extends org.apache.xmlbeans.impl.values.XmlUnionImpl implements uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component5.TemplateId.Root, uk.nhs.connect.iucds.ucr.Oid, uk.nhs.connect.iucds.ucr.Uuid, uk.nhs.connect.iucds.ucr.Ruid
        {
            private static final long serialVersionUID = 1L;
         ...
         */
        public static class ExtensionImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component5.TemplateId.Extension
        {
            private static final long serialVersionUID = 1L;
