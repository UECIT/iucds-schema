 ...
 */
public class CdaNPfITEDImpl extends uk.nhs.connect.iucds.ucr.impl.BINImpl implements uk.nhs.connect.iucds.ucr.CdaNPfITED
{
     ...
     */
    public uk.nhs.connect.iucds.ucr.AnyNPfITUrl getReference()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.AnyNPfITUrl target = null;
            target = (uk.nhs.connect.iucds.ucr.AnyNPfITUrl)get_store().find_element_user(REFERENCE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setReference(uk.nhs.connect.iucds.ucr.AnyNPfITUrl reference)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.AnyNPfITUrl addNewReference()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.AnyNPfITUrl target = null;
            target = (uk.nhs.connect.iucds.ucr.AnyNPfITUrl)get_store().add_element_user(REFERENCE$0);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.Thumbnail getThumbnail()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.Thumbnail target = null;
            target = (uk.nhs.connect.iucds.ucr.Thumbnail)get_store().find_element_user(THUMBNAIL$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setThumbnail(uk.nhs.connect.iucds.ucr.Thumbnail thumbnail)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.Thumbnail addNewThumbnail()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.Thumbnail target = null;
            target = (uk.nhs.connect.iucds.ucr.Thumbnail)get_store().add_element_user(THUMBNAIL$2);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.Cs2 xgetMediaType()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.ucr.Cs2)get_store().find_attribute_user(MEDIATYPE$4);
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.Cs2)get_default_attribute_value(MEDIATYPE$4);
            }
            return target;
        }
    }
    ...
    public void xsetMediaType(uk.nhs.connect.iucds.ucr.Cs2 mediaType)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.Cs2)get_store().add_attribute_user(MEDIATYPE$4);
            }
     ...
     */
    public uk.nhs.connect.iucds.ucr.Cs2 xgetLanguage()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.Cs2 target = null;
            target = (uk.nhs.connect.iucds.ucr.Cs2)get_store().find_attribute_user(LANGUAGE$6);
            return target;
        }
    }
     ...
     */
    public void xsetLanguage(uk.nhs.connect.iucds.ucr.Cs2 language)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.Cs2)get_store().add_attribute_user(LANGUAGE$6);
            }
            target.set(language);
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.CsCompressionAlgorithm.Enum getCompression()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (uk.nhs.connect.iucds.ucr.CsCompressionAlgorithm.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.CsCompressionAlgorithm xgetCompression()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.CsCompressionAlgorithm target = null;
            target = (uk.nhs.connect.iucds.ucr.CsCompressionAlgorithm)get_store().find_attribute_user(COMPRESSION$8);
            return target;
        }
    }
     ...
     */
    public void setCompression(uk.nhs.connect.iucds.ucr.CsCompressionAlgorithm.Enum compression)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetCompression(uk.nhs.connect.iucds.ucr.CsCompressionAlgorithm compression)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.CsCompressionAlgorithm)get_store().add_attribute_user(COMPRESSION$8);
            }
     ...
     */
    public uk.nhs.connect.iucds.ucr.Bin2 xgetIntegrityCheck()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.Bin2 target = null;
            target = (uk.nhs.connect.iucds.ucr.Bin2)get_store().find_attribute_user(INTEGRITYCHECK$10);
            return target;
        }
    }
     ...
     */
    public void xsetIntegrityCheck(uk.nhs.connect.iucds.ucr.Bin2 integrityCheck)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.Bin2)get_store().add_attribute_user(INTEGRITYCHECK$10);
            }
     ...
     */
    public uk.nhs.connect.iucds.ucr.CsIntegrityCheckAlgorithm.Enum getIntegrityCheckAlgorithm()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (uk.nhs.connect.iucds.ucr.CsIntegrityCheckAlgorithm.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.CsIntegrityCheckAlgorithm xgetIntegrityCheckAlgorithm()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.CsIntegrityCheckAlgorithm target = null;
            target = (uk.nhs.connect.iucds.ucr.CsIntegrityCheckAlgorithm)get_store().find_attribute_user(INTEGRITYCHECKALGORITHM$12);
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.CsIntegrityCheckAlgorithm)get_default_attribute_value(INTEGRITYCHECKALGORITHM$12);
            }
            return target;
        }
    }
     ...
     */
    public void setIntegrityCheckAlgorithm(uk.nhs.connect.iucds.ucr.CsIntegrityCheckAlgorithm.Enum integrityCheckAlgorithm)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetIntegrityCheckAlgorithm(uk.nhs.connect.iucds.ucr.CsIntegrityCheckAlgorithm integrityCheckAlgorithm)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.CsIntegrityCheckAlgorithm)get_store().add_attribute_user(INTEGRITYCHECKALGORITHM$12);
            }
