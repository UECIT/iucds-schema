 ...
 */
public class ANYImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.ucr.ANY
{
    ...
    public uk.nhs.connect.iucds.ucr.CsNullFlavor xgetNullFlavor()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.ucr.CsNullFlavor)get_store().find_attribute_user(NULLFLAVOR$0);
            return target;
        }
    }
    ...
    public void xsetNullFlavor(uk.nhs.connect.iucds.ucr.CsNullFlavor nullFlavor)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.CsNullFlavor)get_store().add_attribute_user(NULLFLAVOR$0);
            }
    ...
    public uk.nhs.connect.iucds.ucr.CsUpdateMode xgetUpdateMode()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.ucr.CsUpdateMode)get_store().find_attribute_user(UPDATEMODE$2);
            return target;
        }
    }
    ...
    public void xsetUpdateMode(uk.nhs.connect.iucds.ucr.CsUpdateMode updateMode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.CsUpdateMode)get_store().add_attribute_user(UPDATEMODE$2);
            }
