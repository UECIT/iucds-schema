 ...
 */
public class COCDTP146232GB01LocationImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.ucr.COCDTP146232GB01Location
{
    private static final long serialVersionUID = 1L;
    
    public COCDTP146232GB01LocationImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName COCDTP145222GB02HEALTHCAREFACILITY$4 = 
        new javax.xml.namespace.QName("urn:hl7-org:v3", "COCD_TP145222GB02.HealthCareFacility");
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146232GB01Location.TemplateId getTemplateId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146232GB01Location.TemplateId target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146232GB01Location.TemplateId)get_store().find_element_user(TEMPLATEID$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setTemplateId(uk.nhs.connect.iucds.ucr.COCDTP146232GB01Location.TemplateId templateId)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146232GB01Location.TemplateId addNewTemplateId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146232GB01Location.TemplateId target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146232GB01Location.TemplateId)get_store().add_element_user(TEMPLATEID$2);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP145222GB02HealthCareFacility getCOCDTP145222GB02HealthCareFacility()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP145222GB02HealthCareFacility target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP145222GB02HealthCareFacility)get_store().find_element_user(COCDTP145222GB02HEALTHCAREFACILITY$4, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setCOCDTP145222GB02HealthCareFacility(uk.nhs.connect.iucds.ucr.COCDTP145222GB02HealthCareFacility cocdtp145222GB02HealthCareFacility)
    {
        generatedSetterHelperImpl(cocdtp145222GB02HealthCareFacility, COCDTP145222GB02HEALTHCAREFACILITY$4, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "COCD_TP145222GB02.HealthCareFacility" element
     */
    public uk.nhs.connect.iucds.ucr.COCDTP145222GB02HealthCareFacility addNewCOCDTP145222GB02HealthCareFacility()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP145222GB02HealthCareFacility target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP145222GB02HealthCareFacility)get_store().add_element_user(COCDTP145222GB02HEALTHCAREFACILITY$4);
            return target;
        }
    }
     ...
     * This is a complex type.
     */
    public static class TemplateIdImpl extends uk.nhs.connect.iucds.ucr.impl.IIImpl implements uk.nhs.connect.iucds.ucr.COCDTP146232GB01Location.TemplateId
    {
        private static final long serialVersionUID = 1L;
         ...
         */
        public static class RootImpl extends org.apache.xmlbeans.impl.values.XmlUnionImpl implements uk.nhs.connect.iucds.ucr.COCDTP146232GB01Location.TemplateId.Root, uk.nhs.connect.iucds.ucr.Oid, uk.nhs.connect.iucds.ucr.Uuid, uk.nhs.connect.iucds.ucr.Ruid
        {
            private static final long serialVersionUID = 1L;
         ...
         */
        public static class ExtensionImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements uk.nhs.connect.iucds.ucr.COCDTP146232GB01Location.TemplateId.Extension
        {
            private static final long serialVersionUID = 1L;
