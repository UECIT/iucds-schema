 ...
 */
public class CSDSTOutcomeLevelOfNeedImpl extends uk.nhs.connect.iucds.ucr.impl.CSImpl implements uk.nhs.connect.iucds.ucr.CSDSTOutcomeLevelOfNeed
{
    private static final long serialVersionUID = 1L;
    
    public CSDSTOutcomeLevelOfNeedImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
