 ...
 */
public class POCDMT200001GB02AuthorizationImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.ucr.POCDMT200001GB02Authorization
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT200001GB02AuthorizationImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName COCDTP146226GB02CONSENT$2 = 
        new javax.xml.namespace.QName("urn:hl7-org:v3", "COCD_TP146226GB02.Consent");
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146226GB02Consent getCOCDTP146226GB02Consent()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146226GB02Consent target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146226GB02Consent)get_store().find_element_user(COCDTP146226GB02CONSENT$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setCOCDTP146226GB02Consent(uk.nhs.connect.iucds.ucr.COCDTP146226GB02Consent cocdtp146226GB02Consent)
    {
        generatedSetterHelperImpl(cocdtp146226GB02Consent, COCDTP146226GB02CONSENT$2, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "COCD_TP146226GB02.Consent" element
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146226GB02Consent addNewCOCDTP146226GB02Consent()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146226GB02Consent target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146226GB02Consent)get_store().add_element_user(COCDTP146226GB02CONSENT$2);
            return target;
        }
    }
