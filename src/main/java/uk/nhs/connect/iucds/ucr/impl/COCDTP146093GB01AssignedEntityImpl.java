 ...
 */
public class COCDTP146093GB01AssignedEntityImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.ucr.COCDTP146093GB01AssignedEntity
{
    private static final long serialVersionUID = 1L;
    
    public COCDTP146093GB01AssignedEntityImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName ASSIGNEDORGANIZATION$6 = 
        new javax.xml.namespace.QName("urn:hl7-org:v3", "assignedOrganization");
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146093GB01AssignedEntity.TemplateId getTemplateId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146093GB01AssignedEntity.TemplateId target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146093GB01AssignedEntity.TemplateId)get_store().find_element_user(TEMPLATEID$4, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setTemplateId(uk.nhs.connect.iucds.ucr.COCDTP146093GB01AssignedEntity.TemplateId templateId)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146093GB01AssignedEntity.TemplateId addNewTemplateId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146093GB01AssignedEntity.TemplateId target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146093GB01AssignedEntity.TemplateId)get_store().add_element_user(TEMPLATEID$4);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146093GB01Organization getAssignedOrganization()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146093GB01Organization target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146093GB01Organization)get_store().find_element_user(ASSIGNEDORGANIZATION$6, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public boolean isNilAssignedOrganization()
    {
        synchronized (monitor())
        {
            check_orphaned();
    ...
    public boolean isSetAssignedOrganization()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ASSIGNEDORGANIZATION$6) != 0;
        }
    }
     ...
     */
    public void setAssignedOrganization(uk.nhs.connect.iucds.ucr.COCDTP146093GB01Organization assignedOrganization)
    {
        generatedSetterHelperImpl(assignedOrganization, ASSIGNEDORGANIZATION$6, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "assignedOrganization" element
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146093GB01Organization addNewAssignedOrganization()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146093GB01Organization target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146093GB01Organization)get_store().add_element_user(ASSIGNEDORGANIZATION$6);
            return target;
        }
    }
     ...
     */
    public void setNilAssignedOrganization()
    {
        synchronized (monitor())
        {
            check_orphaned();
    ...
    public void unsetAssignedOrganization()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(ASSIGNEDORGANIZATION$6, 0);
        }
    }
     ...
     * This is a complex type.
     */
    public static class TemplateIdImpl extends uk.nhs.connect.iucds.ucr.impl.IIImpl implements uk.nhs.connect.iucds.ucr.COCDTP146093GB01AssignedEntity.TemplateId
    {
        private static final long serialVersionUID = 1L;
         ...
         */
        public static class RootImpl extends org.apache.xmlbeans.impl.values.XmlUnionImpl implements uk.nhs.connect.iucds.ucr.COCDTP146093GB01AssignedEntity.TemplateId.Root, uk.nhs.connect.iucds.ucr.Oid, uk.nhs.connect.iucds.ucr.Uuid, uk.nhs.connect.iucds.ucr.Ruid
        {
            private static final long serialVersionUID = 1L;
         ...
         */
        public static class ExtensionImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements uk.nhs.connect.iucds.ucr.COCDTP146093GB01AssignedEntity.TemplateId.Extension
        {
            private static final long serialVersionUID = 1L;
