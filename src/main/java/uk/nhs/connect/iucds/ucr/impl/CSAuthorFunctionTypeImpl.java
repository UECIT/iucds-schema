 ...
 */
public class CSAuthorFunctionTypeImpl extends uk.nhs.connect.iucds.ucr.impl.CSImpl implements uk.nhs.connect.iucds.ucr.CSAuthorFunctionType
{
    private static final long serialVersionUID = 1L;
    
    public CSAuthorFunctionTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
