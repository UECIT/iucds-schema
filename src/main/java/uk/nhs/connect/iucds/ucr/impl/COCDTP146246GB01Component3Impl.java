 ...
 */
public class COCDTP146246GB01Component3Impl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component3
{
    private static final long serialVersionUID = 1L;
    
    public COCDTP146246GB01Component3Impl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName SECTION2$2 = 
        new javax.xml.namespace.QName("urn:hl7-org:v3", "section2");
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component3.TemplateId getTemplateId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component3.TemplateId target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component3.TemplateId)get_store().find_element_user(TEMPLATEID$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setTemplateId(uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component3.TemplateId templateId)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component3.TemplateId addNewTemplateId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component3.TemplateId target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component3.TemplateId)get_store().add_element_user(TEMPLATEID$0);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section2 getSection2()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section2 target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section2)get_store().find_element_user(SECTION2$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setSection2(uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section2 section2)
    {
        generatedSetterHelperImpl(section2, SECTION2$2, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "section2" element
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section2 addNewSection2()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section2 target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section2)get_store().add_element_user(SECTION2$2);
            return target;
        }
    }
     ...
     * This is a complex type.
     */
    public static class TemplateIdImpl extends uk.nhs.connect.iucds.ucr.impl.IIImpl implements uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component3.TemplateId
    {
        private static final long serialVersionUID = 1L;
         ...
         */
        public static class RootImpl extends org.apache.xmlbeans.impl.values.XmlUnionImpl implements uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component3.TemplateId.Root, uk.nhs.connect.iucds.ucr.Oid, uk.nhs.connect.iucds.ucr.Uuid, uk.nhs.connect.iucds.ucr.Ruid
        {
            private static final long serialVersionUID = 1L;
         ...
         */
        public static class ExtensionImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component3.TemplateId.Extension
        {
            private static final long serialVersionUID = 1L;
