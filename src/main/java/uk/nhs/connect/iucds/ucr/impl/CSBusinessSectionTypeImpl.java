 ...
 */
public class CSBusinessSectionTypeImpl extends uk.nhs.connect.iucds.ucr.impl.CSImpl implements uk.nhs.connect.iucds.ucr.CSBusinessSectionType
{
    private static final long serialVersionUID = 1L;
    
    public CSBusinessSectionTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
