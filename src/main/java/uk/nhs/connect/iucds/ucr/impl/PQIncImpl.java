 ...
 */
public class PQIncImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.ucr.PQInc
{
     ...
     */
    public uk.nhs.connect.iucds.ucr.PQR[] getTranslationArray()
    {
        synchronized (monitor())
        {
            ...
            uk.nhs.connect.iucds.ucr.PQR[] result = new uk.nhs.connect.iucds.ucr.PQR[targetList.size()];
     ...
     */
    public uk.nhs.connect.iucds.ucr.PQR getTranslationArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.PQR target = null;
            target = (uk.nhs.connect.iucds.ucr.PQR)get_store().find_element_user(TRANSLATION$0, i);
            if (target == null)
            {
     ...
     */
    public void setTranslationArray(uk.nhs.connect.iucds.ucr.PQR[] translationArray)
    {
        check_orphaned();
     ...
     */
    public void setTranslationArray(int i, uk.nhs.connect.iucds.ucr.PQR translation)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.PQR insertNewTranslation(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.PQR target = null;
            target = (uk.nhs.connect.iucds.ucr.PQR)get_store().insert_element_user(TRANSLATION$0, i);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.PQR addNewTranslation()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.PQR target = null;
            target = (uk.nhs.connect.iucds.ucr.PQR)get_store().add_element_user(TRANSLATION$0);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.Real2 xgetValue()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.Real2 target = null;
            target = (uk.nhs.connect.iucds.ucr.Real2)get_store().find_attribute_user(VALUE$2);
            return target;
        }
    }
     ...
     */
    public void xsetValue(uk.nhs.connect.iucds.ucr.Real2 value)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.Real2)get_store().add_attribute_user(VALUE$2);
            }
            target.set(value);
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.Cs2 xgetUnit()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.Cs2 target = null;
            target = (uk.nhs.connect.iucds.ucr.Cs2)get_store().find_attribute_user(UNIT$4);
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.Cs2)get_default_attribute_value(UNIT$4);
            }
            return target;
        }
    }
     ...
     */
    public void xsetUnit(uk.nhs.connect.iucds.ucr.Cs2 unit)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.Cs2)get_store().add_attribute_user(UNIT$4);
            }
            target.set(unit);
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.CsNullFlavor.Enum getNullFlavor()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (uk.nhs.connect.iucds.ucr.CsNullFlavor.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.CsNullFlavor xgetNullFlavor()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.CsNullFlavor target = null;
            target = (uk.nhs.connect.iucds.ucr.CsNullFlavor)get_store().find_attribute_user(NULLFLAVOR$10);
            return target;
        }
    }
     ...
     */
    public void setNullFlavor(uk.nhs.connect.iucds.ucr.CsNullFlavor.Enum nullFlavor)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetNullFlavor(uk.nhs.connect.iucds.ucr.CsNullFlavor nullFlavor)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.CsNullFlavor)get_store().add_attribute_user(NULLFLAVOR$10);
            }
     ...
     */
    public uk.nhs.connect.iucds.ucr.Bl2 xgetInclusive()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.Bl2 target = null;
            target = (uk.nhs.connect.iucds.ucr.Bl2)get_store().find_attribute_user(INCLUSIVE$12);
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.Bl2)get_default_attribute_value(INCLUSIVE$12);
            }
            return target;
        }
    }
     ...
     */
    public void xsetInclusive(uk.nhs.connect.iucds.ucr.Bl2 inclusive)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.Bl2)get_store().add_attribute_user(INCLUSIVE$12);
            }
