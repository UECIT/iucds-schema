 ...
 */
public class CVNPfITCodedOriginaltextImpl extends uk.nhs.connect.iucds.ucr.impl.CVImpl implements uk.nhs.connect.iucds.ucr.CVNPfITCodedOriginaltext
{
    ...
    public uk.nhs.connect.iucds.ucr.Cs2 xgetCode()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.ucr.Cs2)get_store().find_attribute_user(CODE$2);
            return target;
        }
    }
    ...
    public void xsetCode(uk.nhs.connect.iucds.ucr.Cs2 code)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.Cs2)get_store().add_attribute_user(CODE$2);
            }
            target.set(code);
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.Uid xgetCodeSystem()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.ucr.Uid)get_store().find_attribute_user(CODESYSTEM$4);
            return target;
        }
    }
    ...
    public void xsetCodeSystem(uk.nhs.connect.iucds.ucr.Uid codeSystem)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.Uid)get_store().add_attribute_user(CODESYSTEM$4);
            }
    ...
    public uk.nhs.connect.iucds.ucr.St2 xgetDisplayName()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.ucr.St2)get_store().find_attribute_user(DISPLAYNAME$6);
            return target;
        }
    }
    ...
    public void xsetDisplayName(uk.nhs.connect.iucds.ucr.St2 displayName)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.St2)get_store().add_attribute_user(DISPLAYNAME$6);
            }
