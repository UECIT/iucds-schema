 ...
 */
public class CSCDAPrescriptionAnnotationImpl extends uk.nhs.connect.iucds.ucr.impl.CSImpl implements uk.nhs.connect.iucds.ucr.CSCDAPrescriptionAnnotation
{
    private static final long serialVersionUID = 1L;
    
    public CSCDAPrescriptionAnnotationImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
