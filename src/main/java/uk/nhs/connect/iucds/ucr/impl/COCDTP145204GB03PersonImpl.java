 ...
 */
public class COCDTP145204GB03PersonImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.ucr.COCDTP145204GB03Person
{
    private static final long serialVersionUID = 1L;
    
    public COCDTP145204GB03PersonImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName DETERMINERCODE$10 = 
     ...
     */
    public uk.nhs.connect.iucds.ucr.PN getName()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.PN target = null;
            target = (uk.nhs.connect.iucds.ucr.PN)get_store().find_element_user(NAME$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setName(uk.nhs.connect.iucds.ucr.PN name)
    {
    ...
    public uk.nhs.connect.iucds.ucr.PN addNewName()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.PN target = null;
            target = (uk.nhs.connect.iucds.ucr.PN)get_store().add_element_user(NAME$0);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP145204GB03Person.TemplateId getTemplateId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP145204GB03Person.TemplateId target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP145204GB03Person.TemplateId)get_store().find_element_user(TEMPLATEID$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setTemplateId(uk.nhs.connect.iucds.ucr.COCDTP145204GB03Person.TemplateId templateId)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP145204GB03Person.TemplateId addNewTemplateId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP145204GB03Person.TemplateId target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP145204GB03Person.TemplateId)get_store().add_element_user(TEMPLATEID$2);
            return target;
        }
    }
    ...
    public java.lang.String getDeterminerCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(DETERMINERCODE$10);
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_default_attribute_value(DETERMINERCODE$10);
            }
            if (target == null)
            {
                return null;
    ...
    public uk.nhs.connect.iucds.ucr.Cs2 xgetDeterminerCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.Cs2 target = null;
            target = (uk.nhs.connect.iucds.ucr.Cs2)get_store().find_attribute_user(DETERMINERCODE$10);
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.Cs2)get_default_attribute_value(DETERMINERCODE$10);
            }
            return target;
        }
    }
    ...
    public void setDeterminerCode(java.lang.String determinerCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(DETERMINERCODE$10);
            }
    ...
    public void xsetDeterminerCode(uk.nhs.connect.iucds.ucr.Cs2 determinerCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.Cs2)get_store().add_attribute_user(DETERMINERCODE$10);
            }
     ...
     * This is a complex type.
     */
    public static class TemplateIdImpl extends uk.nhs.connect.iucds.ucr.impl.IIImpl implements uk.nhs.connect.iucds.ucr.COCDTP145204GB03Person.TemplateId
    {
        private static final long serialVersionUID = 1L;
         ...
         */
        public static class RootImpl extends org.apache.xmlbeans.impl.values.XmlUnionImpl implements uk.nhs.connect.iucds.ucr.COCDTP145204GB03Person.TemplateId.Root, uk.nhs.connect.iucds.ucr.Oid, uk.nhs.connect.iucds.ucr.Uuid, uk.nhs.connect.iucds.ucr.Ruid
        {
            private static final long serialVersionUID = 1L;
         ...
         */
        public static class ExtensionImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements uk.nhs.connect.iucds.ucr.COCDTP145204GB03Person.TemplateId.Extension
        {
            private static final long serialVersionUID = 1L;
