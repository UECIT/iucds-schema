 ...
 */
public class COCDTP146246GB01Section4Impl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section4
{
    private static final long serialVersionUID = 1L;
    
    public COCDTP146246GB01Section4Impl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName COMPONENT4$10 = 
        new javax.xml.namespace.QName("urn:hl7-org:v3", "component4");
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section4.TemplateId getTemplateId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section4.TemplateId target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section4.TemplateId)get_store().find_element_user(TEMPLATEID$4, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setTemplateId(uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section4.TemplateId templateId)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section4.TemplateId addNewTemplateId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section4.TemplateId target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section4.TemplateId)get_store().add_element_user(TEMPLATEID$4);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component[] getComponent4Array()
    {
        synchronized (monitor())
        {
            check_orphaned();
            java.util.List targetList = new java.util.ArrayList();
            get_store().find_all_element_users(COMPONENT4$10, targetList);
            uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component[] result = new uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component[targetList.size()];
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component getComponent4Array(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component)get_store().find_element_user(COMPONENT4$10, i);
            if (target == null)
            {
     ...
     */
    public boolean isNilComponent4Array(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public int sizeOfComponent4Array()
    {
        synchronized (monitor())
        {
            check_orphaned();
            return get_store().count_elements(COMPONENT4$10);
        }
    }
    
    /**
     * Sets array of all "component4" element  WARNING: This method is not atomicaly synchronized.
     */
    public void setComponent4Array(uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component[] component4Array)
    {
        check_orphaned();
        arraySetterHelper(component4Array, COMPONENT4$10);
    }
    
    /**
     * Sets ith "component4" element
     */
    public void setComponent4Array(int i, uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component component4)
    {
        generatedSetterHelperImpl(component4, COMPONENT4$10, i, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_ARRAYITEM);
    }
    
    /**
     * Nils the ith "component4" element
     */
    public void setNilComponent4Array(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component insertNewComponent4(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component)get_store().insert_element_user(COMPONENT4$10, i);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component addNewComponent4()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component)get_store().add_element_user(COMPONENT4$10);
            return target;
        }
    }
     ...
     */
    public void removeComponent4(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(COMPONENT4$10, i);
        }
    }
     ...
     * This is a complex type.
     */
    public static class TemplateIdImpl extends uk.nhs.connect.iucds.ucr.impl.IIImpl implements uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section4.TemplateId
    {
        private static final long serialVersionUID = 1L;
         ...
         */
        public static class RootImpl extends org.apache.xmlbeans.impl.values.XmlUnionImpl implements uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section4.TemplateId.Root, uk.nhs.connect.iucds.ucr.Oid, uk.nhs.connect.iucds.ucr.Uuid, uk.nhs.connect.iucds.ucr.Ruid
        {
            private static final long serialVersionUID = 1L;
         ...
         */
        public static class ExtensionImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section4.TemplateId.Extension
        {
            private static final long serialVersionUID = 1L;
