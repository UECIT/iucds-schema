 ...
 */
public class COCDTP146246GB01Section3Impl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section3
{
    private static final long serialVersionUID = 1L;
    
    public COCDTP146246GB01Section3Impl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName COMPONENT3$10 = 
        new javax.xml.namespace.QName("urn:hl7-org:v3", "component3");
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section3.TemplateId getTemplateId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section3.TemplateId target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section3.TemplateId)get_store().find_element_user(TEMPLATEID$4, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setTemplateId(uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section3.TemplateId templateId)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section3.TemplateId addNewTemplateId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section3.TemplateId target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section3.TemplateId)get_store().add_element_user(TEMPLATEID$4);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component5[] getComponent3Array()
    {
        synchronized (monitor())
        {
            check_orphaned();
            java.util.List targetList = new java.util.ArrayList();
            get_store().find_all_element_users(COMPONENT3$10, targetList);
            uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component5[] result = new uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component5[targetList.size()];
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component5 getComponent3Array(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component5 target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component5)get_store().find_element_user(COMPONENT3$10, i);
            if (target == null)
            {
     ...
     */
    public boolean isNilComponent3Array(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public int sizeOfComponent3Array()
    {
        synchronized (monitor())
        {
            check_orphaned();
            return get_store().count_elements(COMPONENT3$10);
        }
    }
    
    /**
     * Sets array of all "component3" element  WARNING: This method is not atomicaly synchronized.
     */
    public void setComponent3Array(uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component5[] component3Array)
    {
        check_orphaned();
        arraySetterHelper(component3Array, COMPONENT3$10);
    }
    
    /**
     * Sets ith "component3" element
     */
    public void setComponent3Array(int i, uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component5 component3)
    {
        generatedSetterHelperImpl(component3, COMPONENT3$10, i, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_ARRAYITEM);
    }
    
    /**
     * Nils the ith "component3" element
     */
    public void setNilComponent3Array(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component5 insertNewComponent3(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component5 target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component5)get_store().insert_element_user(COMPONENT3$10, i);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component5 addNewComponent3()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component5 target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146246GB01Component5)get_store().add_element_user(COMPONENT3$10);
            return target;
        }
    }
     ...
     */
    public void removeComponent3(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(COMPONENT3$10, i);
        }
    }
     ...
     * This is a complex type.
     */
    public static class TemplateIdImpl extends uk.nhs.connect.iucds.ucr.impl.IIImpl implements uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section3.TemplateId
    {
        private static final long serialVersionUID = 1L;
         ...
         */
        public static class RootImpl extends org.apache.xmlbeans.impl.values.XmlUnionImpl implements uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section3.TemplateId.Root, uk.nhs.connect.iucds.ucr.Oid, uk.nhs.connect.iucds.ucr.Uuid, uk.nhs.connect.iucds.ucr.Ruid
        {
            private static final long serialVersionUID = 1L;
         ...
         */
        public static class ExtensionImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements uk.nhs.connect.iucds.ucr.COCDTP146246GB01Section3.TemplateId.Extension
        {
            private static final long serialVersionUID = 1L;
