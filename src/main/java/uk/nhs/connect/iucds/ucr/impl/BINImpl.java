 ...
 */
public class BINImpl extends uk.nhs.connect.iucds.ucr.impl.ANYImpl implements uk.nhs.connect.iucds.ucr.BIN
{
    ...
    public uk.nhs.connect.iucds.ucr.CsBinaryDataEncoding xgetRepresentation()
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.CsBinaryDataEncoding)get_default_attribute_value(REPRESENTATION$0);
            }
            return target;
        }
    }
