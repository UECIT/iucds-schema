 ...
 * Java type: uk.nhs.connect.iucds.ucr.StrucDocFootnote
 *
 ...
 */
public class StrucDocFootnoteImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.ucr.StrucDocFootnote
{
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocRenderMultiMedia getRenderMultiMediaArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.ucr.StrucDocRenderMultiMedia)get_store().find_element_user(RENDERMULTIMEDIA$10, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocRenderMultiMedia insertNewRenderMultiMedia(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocRenderMultiMedia target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocRenderMultiMedia)get_store().insert_element_user(RENDERMULTIMEDIA$10, i);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocRenderMultiMedia addNewRenderMultiMedia()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocRenderMultiMedia target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocRenderMultiMedia)get_store().add_element_user(RENDERMULTIMEDIA$10);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocParagraph getParagraphArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.ucr.StrucDocParagraph)get_store().find_element_user(PARAGRAPH$12, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocParagraph insertNewParagraph(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocParagraph target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocParagraph)get_store().insert_element_user(PARAGRAPH$12, i);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocParagraph addNewParagraph()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocParagraph target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocParagraph)get_store().add_element_user(PARAGRAPH$12);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocList getListArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.ucr.StrucDocList)get_store().find_element_user(LIST$14, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocList insertNewList(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocList target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocList)get_store().insert_element_user(LIST$14, i);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocList addNewList()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocList target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocList)get_store().add_element_user(LIST$14);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocTable getTableArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.ucr.StrucDocTable)get_store().find_element_user(TABLE$16, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocTable insertNewTable(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocTable target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocTable)get_store().insert_element_user(TABLE$16, i);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocTable addNewTable()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocTable target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocTable)get_store().add_element_user(TABLE$16);
            return target;
        }
    }
