 ...
 */
public class POCDMT200001GB02ComponentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.ucr.POCDMT200001GB02Component
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT200001GB02ComponentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName COCDTP146232GB01ENCOMPASSINGENCOUNTER$2 = 
        new javax.xml.namespace.QName("urn:hl7-org:v3", "COCD_TP146232GB01.EncompassingEncounter");
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146232GB01EncompassingEncounter getCOCDTP146232GB01EncompassingEncounter()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146232GB01EncompassingEncounter target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146232GB01EncompassingEncounter)get_store().find_element_user(COCDTP146232GB01ENCOMPASSINGENCOUNTER$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setCOCDTP146232GB01EncompassingEncounter(uk.nhs.connect.iucds.ucr.COCDTP146232GB01EncompassingEncounter cocdtp146232GB01EncompassingEncounter)
    {
        generatedSetterHelperImpl(cocdtp146232GB01EncompassingEncounter, COCDTP146232GB01ENCOMPASSINGENCOUNTER$2, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "COCD_TP146232GB01.EncompassingEncounter" element
     */
    public uk.nhs.connect.iucds.ucr.COCDTP146232GB01EncompassingEncounter addNewCOCDTP146232GB01EncompassingEncounter()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP146232GB01EncompassingEncounter target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP146232GB01EncompassingEncounter)get_store().add_element_user(COCDTP146232GB01ENCOMPASSINGENCOUNTER$2);
            return target;
        }
    }
