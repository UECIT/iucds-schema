 ...
 */
public class CVNPfITCodedDisplaynameImpl extends uk.nhs.connect.iucds.ucr.impl.CVImpl implements uk.nhs.connect.iucds.ucr.CVNPfITCodedDisplayname
{
    ...
    public uk.nhs.connect.iucds.ucr.St2 xgetDisplayName()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.ucr.St2)get_store().find_attribute_user(DISPLAYNAME$2);
            return target;
        }
    }
    ...
    public void xsetDisplayName(uk.nhs.connect.iucds.ucr.St2 displayName)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.St2)get_store().add_attribute_user(DISPLAYNAME$2);
            }
