 ...
 */
public class CSCDAObservationTypeImpl extends uk.nhs.connect.iucds.ucr.impl.CSImpl implements uk.nhs.connect.iucds.ucr.CSCDAObservationType
{
    private static final long serialVersionUID = 1L;
    
    public CSCDAObservationTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
