 ...
 */
public class StrucDocItemImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.ucr.StrucDocItem
{
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocContent getContentArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.ucr.StrucDocContent)get_store().find_element_user(CONTENT$2, i);
            if (target == null)
            {
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocContent insertNewContent(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocContent target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocContent)get_store().insert_element_user(CONTENT$2, i);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocContent addNewContent()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocContent target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocContent)get_store().add_element_user(CONTENT$2);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocLinkHtml getLinkHtmlArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.ucr.StrucDocLinkHtml)get_store().find_element_user(LINKHTML$4, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocLinkHtml insertNewLinkHtml(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocLinkHtml target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocLinkHtml)get_store().insert_element_user(LINKHTML$4, i);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocLinkHtml addNewLinkHtml()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocLinkHtml target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocLinkHtml)get_store().add_element_user(LINKHTML$4);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocSub getSubArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.ucr.StrucDocSub)get_store().find_element_user(SUB$6, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocSub insertNewSub(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocSub target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocSub)get_store().insert_element_user(SUB$6, i);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocSub addNewSub()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocSub target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocSub)get_store().add_element_user(SUB$6);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocSup getSupArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.ucr.StrucDocSup)get_store().find_element_user(SUP$8, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocSup insertNewSup(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocSup target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocSup)get_store().insert_element_user(SUP$8, i);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocSup addNewSup()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocSup target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocSup)get_store().add_element_user(SUP$8);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocBr getBrArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.ucr.StrucDocBr)get_store().find_element_user(BR$10, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocBr insertNewBr(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocBr target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocBr)get_store().insert_element_user(BR$10, i);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocBr addNewBr()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocBr target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocBr)get_store().add_element_user(BR$10);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocFootnote getFootnoteArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.ucr.StrucDocFootnote)get_store().find_element_user(FOOTNOTE$12, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocFootnote insertNewFootnote(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocFootnote target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocFootnote)get_store().insert_element_user(FOOTNOTE$12, i);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocFootnote addNewFootnote()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocFootnote target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocFootnote)get_store().add_element_user(FOOTNOTE$12);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocFootnoteRef getFootnoteRefArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.ucr.StrucDocFootnoteRef)get_store().find_element_user(FOOTNOTEREF$14, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocFootnoteRef insertNewFootnoteRef(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocFootnoteRef target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocFootnoteRef)get_store().insert_element_user(FOOTNOTEREF$14, i);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocFootnoteRef addNewFootnoteRef()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocFootnoteRef target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocFootnoteRef)get_store().add_element_user(FOOTNOTEREF$14);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocRenderMultiMedia getRenderMultiMediaArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.ucr.StrucDocRenderMultiMedia)get_store().find_element_user(RENDERMULTIMEDIA$16, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocRenderMultiMedia insertNewRenderMultiMedia(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocRenderMultiMedia target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocRenderMultiMedia)get_store().insert_element_user(RENDERMULTIMEDIA$16, i);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocRenderMultiMedia addNewRenderMultiMedia()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocRenderMultiMedia target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocRenderMultiMedia)get_store().add_element_user(RENDERMULTIMEDIA$16);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocParagraph getParagraphArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.ucr.StrucDocParagraph)get_store().find_element_user(PARAGRAPH$18, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    {
        generatedSetterHelperImpl(paragraph, PARAGRAPH$18, i, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_ARRAYITEM);
    }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocParagraph insertNewParagraph(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocParagraph target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocParagraph)get_store().insert_element_user(PARAGRAPH$18, i);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocParagraph addNewParagraph()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocParagraph target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocParagraph)get_store().add_element_user(PARAGRAPH$18);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocList getListArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.ucr.StrucDocList)get_store().find_element_user(LIST$20, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    {
        generatedSetterHelperImpl(list, LIST$20, i, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_ARRAYITEM);
    }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocList insertNewList(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocList target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocList)get_store().insert_element_user(LIST$20, i);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocList addNewList()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocList target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocList)get_store().add_element_user(LIST$20);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.StrucDocTable[] getTableArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            uk.nhs.connect.iucds.ucr.StrucDocTable[] result = new uk.nhs.connect.iucds.ucr.StrucDocTable[targetList.size()];
            targetList.toArray(result);
            return result;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.StrucDocTable getTableArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocTable target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocTable)get_store().find_element_user(TABLE$22, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
     ...
     */
    public void setTableArray(uk.nhs.connect.iucds.ucr.StrucDocTable[] tableArray)
    {
        check_orphaned();
     ...
     */
    public void setTableArray(int i, uk.nhs.connect.iucds.ucr.StrucDocTable table)
    {
        generatedSetterHelperImpl(table, TABLE$22, i, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_ARRAYITEM);
    }
    
    /**
     * Inserts and returns a new empty value (as xml) as the ith "table" element
     */
    public uk.nhs.connect.iucds.ucr.StrucDocTable insertNewTable(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocTable target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocTable)get_store().insert_element_user(TABLE$22, i);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.StrucDocTable addNewTable()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocTable target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocTable)get_store().add_element_user(TABLE$22);
            return target;
        }
    }
