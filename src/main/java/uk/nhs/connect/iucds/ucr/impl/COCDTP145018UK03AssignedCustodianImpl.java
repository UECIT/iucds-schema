 ...
 */
public class COCDTP145018UK03AssignedCustodianImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.ucr.COCDTP145018UK03AssignedCustodian
{
    private static final long serialVersionUID = 1L;
    
    public COCDTP145018UK03AssignedCustodianImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName REPRESENTEDCUSTODIANORGANIZATION$2 = 
    ...
    private static final javax.xml.namespace.QName CLASSCODE$8 = 
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP145018UK03AssignedCustodian.TemplateId getTemplateId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP145018UK03AssignedCustodian.TemplateId target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP145018UK03AssignedCustodian.TemplateId)get_store().find_element_user(TEMPLATEID$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setTemplateId(uk.nhs.connect.iucds.ucr.COCDTP145018UK03AssignedCustodian.TemplateId templateId)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP145018UK03AssignedCustodian.TemplateId addNewTemplateId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP145018UK03AssignedCustodian.TemplateId target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP145018UK03AssignedCustodian.TemplateId)get_store().add_element_user(TEMPLATEID$0);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.COCDTP145018UK03CustodianOrganization getRepresentedCustodianOrganization()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP145018UK03CustodianOrganization target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP145018UK03CustodianOrganization)get_store().find_element_user(REPRESENTEDCUSTODIANORGANIZATION$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setRepresentedCustodianOrganization(uk.nhs.connect.iucds.ucr.COCDTP145018UK03CustodianOrganization representedCustodianOrganization)
    {
        generatedSetterHelperImpl(representedCustodianOrganization, REPRESENTEDCUSTODIANORGANIZATION$2, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "representedCustodianOrganization" element
     */
    public uk.nhs.connect.iucds.ucr.COCDTP145018UK03CustodianOrganization addNewRepresentedCustodianOrganization()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.COCDTP145018UK03CustodianOrganization target = null;
            target = (uk.nhs.connect.iucds.ucr.COCDTP145018UK03CustodianOrganization)get_store().add_element_user(REPRESENTEDCUSTODIANORGANIZATION$2);
            return target;
        }
    }
    ...
    public java.lang.String getClassCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(CLASSCODE$8);
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_default_attribute_value(CLASSCODE$8);
            }
            if (target == null)
            {
                return null;
    ...
    public uk.nhs.connect.iucds.ucr.Cs2 xgetClassCode()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.ucr.Cs2)get_store().find_attribute_user(CLASSCODE$8);
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.Cs2)get_default_attribute_value(CLASSCODE$8);
            }
            return target;
        }
    }
    ...
    public void setClassCode(java.lang.String classCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(CLASSCODE$8);
            }
    ...
    public void xsetClassCode(uk.nhs.connect.iucds.ucr.Cs2 classCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.Cs2)get_store().add_attribute_user(CLASSCODE$8);
            }
     ...
     * This is a complex type.
     */
    public static class TemplateIdImpl extends uk.nhs.connect.iucds.ucr.impl.IIImpl implements uk.nhs.connect.iucds.ucr.COCDTP145018UK03AssignedCustodian.TemplateId
    {
        private static final long serialVersionUID = 1L;
         ...
         */
        public static class RootImpl extends org.apache.xmlbeans.impl.values.XmlUnionImpl implements uk.nhs.connect.iucds.ucr.COCDTP145018UK03AssignedCustodian.TemplateId.Root, uk.nhs.connect.iucds.ucr.Oid, uk.nhs.connect.iucds.ucr.Uuid, uk.nhs.connect.iucds.ucr.Ruid
        {
            private static final long serialVersionUID = 1L;
         ...
         */
        public static class ExtensionImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements uk.nhs.connect.iucds.ucr.COCDTP145018UK03AssignedCustodian.TemplateId.Extension
        {
            private static final long serialVersionUID = 1L;
