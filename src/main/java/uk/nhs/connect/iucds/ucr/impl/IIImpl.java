 ...
 */
public class IIImpl extends uk.nhs.connect.iucds.ucr.impl.ANYImpl implements uk.nhs.connect.iucds.ucr.II
{
     ...
     */
    public uk.nhs.connect.iucds.ucr.St2 xgetAssigningAuthorityName()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.St2 target = null;
            target = (uk.nhs.connect.iucds.ucr.St2)get_store().find_attribute_user(ASSIGNINGAUTHORITYNAME$4);
            return target;
        }
    }
     ...
     */
    public void xsetAssigningAuthorityName(uk.nhs.connect.iucds.ucr.St2 assigningAuthorityName)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.St2)get_store().add_attribute_user(ASSIGNINGAUTHORITYNAME$4);
            }
     ...
     */
    public uk.nhs.connect.iucds.ucr.Bl2 xgetDisplayable()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.Bl2 target = null;
            target = (uk.nhs.connect.iucds.ucr.Bl2)get_store().find_attribute_user(DISPLAYABLE$6);
            return target;
        }
    }
     ...
     */
    public void xsetDisplayable(uk.nhs.connect.iucds.ucr.Bl2 displayable)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.ucr.Bl2)get_store().add_attribute_user(DISPLAYABLE$6);
            }
