 ...
 */
public class StrucDocTitleContentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.ucr.StrucDocTitleContent
{
     ...
     */
    public uk.nhs.connect.iucds.ucr.StrucDocTitleContent[] getContentArray()
    {
        synchronized (monitor())
        {
            ...
            uk.nhs.connect.iucds.ucr.StrucDocTitleContent[] result = new uk.nhs.connect.iucds.ucr.StrucDocTitleContent[targetList.size()];
     ...
     */
    public uk.nhs.connect.iucds.ucr.StrucDocTitleContent getContentArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocTitleContent target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocTitleContent)get_store().find_element_user(CONTENT$0, i);
            if (target == null)
            {
     ...
     */
    public void setContentArray(uk.nhs.connect.iucds.ucr.StrucDocTitleContent[] contentArray)
    {
        check_orphaned();
     ...
     */
    public void setContentArray(int i, uk.nhs.connect.iucds.ucr.StrucDocTitleContent content)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.StrucDocTitleContent insertNewContent(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocTitleContent target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocTitleContent)get_store().insert_element_user(CONTENT$0, i);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.StrucDocTitleContent addNewContent()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocTitleContent target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocTitleContent)get_store().add_element_user(CONTENT$0);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocSub getSubArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.ucr.StrucDocSub)get_store().find_element_user(SUB$2, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocSub insertNewSub(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocSub target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocSub)get_store().insert_element_user(SUB$2, i);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocSub addNewSub()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocSub target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocSub)get_store().add_element_user(SUB$2);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocSup getSupArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.ucr.StrucDocSup)get_store().find_element_user(SUP$4, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocSup insertNewSup(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocSup target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocSup)get_store().insert_element_user(SUP$4, i);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocSup addNewSup()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocSup target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocSup)get_store().add_element_user(SUP$4);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocBr getBrArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.ucr.StrucDocBr)get_store().find_element_user(BR$6, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocBr insertNewBr(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocBr target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocBr)get_store().insert_element_user(BR$6, i);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocBr addNewBr()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocBr target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocBr)get_store().add_element_user(BR$6);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.StrucDocTitleFootnote[] getFootnoteArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            uk.nhs.connect.iucds.ucr.StrucDocTitleFootnote[] result = new uk.nhs.connect.iucds.ucr.StrucDocTitleFootnote[targetList.size()];
            targetList.toArray(result);
            return result;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.StrucDocTitleFootnote getFootnoteArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocTitleFootnote target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocTitleFootnote)get_store().find_element_user(FOOTNOTE$8, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
     ...
     */
    public void setFootnoteArray(uk.nhs.connect.iucds.ucr.StrucDocTitleFootnote[] footnoteArray)
    {
        check_orphaned();
     ...
     */
    public void setFootnoteArray(int i, uk.nhs.connect.iucds.ucr.StrucDocTitleFootnote footnote)
    {
        generatedSetterHelperImpl(footnote, FOOTNOTE$8, i, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_ARRAYITEM);
    }
    
    /**
     * Inserts and returns a new empty value (as xml) as the ith "footnote" element
     */
    public uk.nhs.connect.iucds.ucr.StrucDocTitleFootnote insertNewFootnote(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocTitleFootnote target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocTitleFootnote)get_store().insert_element_user(FOOTNOTE$8, i);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.StrucDocTitleFootnote addNewFootnote()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocTitleFootnote target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocTitleFootnote)get_store().add_element_user(FOOTNOTE$8);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocFootnoteRef getFootnoteRefArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.ucr.StrucDocFootnoteRef)get_store().find_element_user(FOOTNOTEREF$10, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    {
        generatedSetterHelperImpl(footnoteRef, FOOTNOTEREF$10, i, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_ARRAYITEM);
    }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocFootnoteRef insertNewFootnoteRef(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocFootnoteRef target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocFootnoteRef)get_store().insert_element_user(FOOTNOTEREF$10, i);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.ucr.StrucDocFootnoteRef addNewFootnoteRef()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.StrucDocFootnoteRef target = null;
            target = (uk.nhs.connect.iucds.ucr.StrucDocFootnoteRef)get_store().add_element_user(FOOTNOTEREF$10);
            return target;
        }
    }
