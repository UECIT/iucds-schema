 ...
 */
public class RTOQTYQTYImpl extends uk.nhs.connect.iucds.ucr.impl.QTYImpl implements uk.nhs.connect.iucds.ucr.RTOQTYQTY
{
     ...
     */
    public uk.nhs.connect.iucds.ucr.RTOQTYQTY.Numerator getNumerator()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.RTOQTYQTY.Numerator target = null;
            target = (uk.nhs.connect.iucds.ucr.RTOQTYQTY.Numerator)get_store().find_element_user(NUMERATOR$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setNumerator(uk.nhs.connect.iucds.ucr.RTOQTYQTY.Numerator numerator)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.RTOQTYQTY.Numerator addNewNumerator()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.RTOQTYQTY.Numerator target = null;
            target = (uk.nhs.connect.iucds.ucr.RTOQTYQTY.Numerator)get_store().add_element_user(NUMERATOR$0);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.ucr.RTOQTYQTY.Denominator getDenominator()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.RTOQTYQTY.Denominator target = null;
            target = (uk.nhs.connect.iucds.ucr.RTOQTYQTY.Denominator)get_store().find_element_user(DENOMINATOR$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setDenominator(uk.nhs.connect.iucds.ucr.RTOQTYQTY.Denominator denominator)
    {
     ...
     */
    public uk.nhs.connect.iucds.ucr.RTOQTYQTY.Denominator addNewDenominator()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.ucr.RTOQTYQTY.Denominator target = null;
            target = (uk.nhs.connect.iucds.ucr.RTOQTYQTY.Denominator)get_store().add_element_user(DENOMINATOR$2);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class NumeratorImpl extends uk.nhs.connect.iucds.ucr.impl.QTYImpl implements uk.nhs.connect.iucds.ucr.RTOQTYQTY.Numerator
    {
        private static final long serialVersionUID = 1L;
     ...
     * This is a complex type.
     */
    public static class DenominatorImpl extends uk.nhs.connect.iucds.ucr.impl.QTYImpl implements uk.nhs.connect.iucds.ucr.RTOQTYQTY.Denominator
    {
        private static final long serialVersionUID = 1L;
