 ...
 */
public class StrucDocTitleContentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.cda.ucr.StrucDocTitleContent
{
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.StrucDocTitleFootnote[] getFootnoteArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            uk.nhs.connect.iucds.cda.ucr.StrucDocTitleFootnote[] result = new uk.nhs.connect.iucds.cda.ucr.StrucDocTitleFootnote[targetList.size()];
            targetList.toArray(result);
            return result;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.StrucDocTitleFootnote getFootnoteArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.StrucDocTitleFootnote target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocTitleFootnote)get_store().find_element_user(FOOTNOTE$8, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
     ...
     */
    public void setFootnoteArray(uk.nhs.connect.iucds.cda.ucr.StrucDocTitleFootnote[] footnoteArray)
    {
        check_orphaned();
     ...
     */
    public void setFootnoteArray(int i, uk.nhs.connect.iucds.cda.ucr.StrucDocTitleFootnote footnote)
    {
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.StrucDocTitleFootnote insertNewFootnote(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.StrucDocTitleFootnote target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocTitleFootnote)get_store().insert_element_user(FOOTNOTE$8, i);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.StrucDocTitleFootnote addNewFootnote()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.StrucDocTitleFootnote target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocTitleFootnote)get_store().add_element_user(FOOTNOTE$8);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.StrucDocFootnoteRef getFootnoteRefArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocFootnoteRef)get_store().find_element_user(FOOTNOTEREF$10, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    public uk.nhs.connect.iucds.cda.ucr.StrucDocFootnoteRef insertNewFootnoteRef(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.StrucDocFootnoteRef target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocFootnoteRef)get_store().insert_element_user(FOOTNOTEREF$10, i);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.StrucDocFootnoteRef addNewFootnoteRef()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.StrucDocFootnoteRef target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocFootnoteRef)get_store().add_element_user(FOOTNOTEREF$10);
            return target;
        }
    }
