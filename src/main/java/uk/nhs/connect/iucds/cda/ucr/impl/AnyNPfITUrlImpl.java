 ...
 */
public class AnyNPfITUrlImpl extends uk.nhs.connect.iucds.cda.ucr.impl.CdaNPfITUrlImpl implements uk.nhs.connect.iucds.cda.ucr.AnyNPfITUrl
{
    private static final long serialVersionUID = 1L;
    
    public AnyNPfITUrlImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
