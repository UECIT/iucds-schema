 ...
 */
public class POCDMT000002UK01Component1Impl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Component1
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000002UK01Component1Impl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName ENCOMPASSINGENCOUNTER$8 = 
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01EncompassingEncounter getEncompassingEncounter()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01EncompassingEncounter target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01EncompassingEncounter)get_store().find_element_user(ENCOMPASSINGENCOUNTER$8, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setEncompassingEncounter(uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01EncompassingEncounter encompassingEncounter)
    {
        generatedSetterHelperImpl(encompassingEncounter, ENCOMPASSINGENCOUNTER$8, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "encompassingEncounter" element
     */
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01EncompassingEncounter addNewEncompassingEncounter()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01EncompassingEncounter target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01EncompassingEncounter)get_store().add_element_user(ENCOMPASSINGENCOUNTER$8);
            return target;
        }
    }
