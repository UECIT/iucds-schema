 ...
 */
public class StrucDocColgroupImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.cda.ucr.StrucDocColgroup
{
    ...
    public uk.nhs.connect.iucds.cda.ucr.StrucDocCol getColArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocCol)get_store().find_element_user(COL$0, i);
            if (target == null)
            {
    ...
    {
        generatedSetterHelperImpl(col, COL$0, i, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_ARRAYITEM);
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.StrucDocCol insertNewCol(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.StrucDocCol target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocCol)get_store().insert_element_user(COL$0, i);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.StrucDocCol addNewCol()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.StrucDocCol target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocCol)get_store().add_element_user(COL$0);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.StrucDocColgroup.Align.Enum getAlign()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (uk.nhs.connect.iucds.cda.ucr.StrucDocColgroup.Align.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.StrucDocColgroup.Align xgetAlign()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.StrucDocColgroup.Align target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocColgroup.Align)get_store().find_attribute_user(ALIGN$12);
            return target;
        }
    }
     ...
     */
    public void setAlign(uk.nhs.connect.iucds.cda.ucr.StrucDocColgroup.Align.Enum align)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetAlign(uk.nhs.connect.iucds.cda.ucr.StrucDocColgroup.Align align)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.StrucDocColgroup.Align)get_store().add_attribute_user(ALIGN$12);
            }
            target.set(align);
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.StrucDocColgroup.Valign.Enum getValign()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (uk.nhs.connect.iucds.cda.ucr.StrucDocColgroup.Valign.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.StrucDocColgroup.Valign xgetValign()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.StrucDocColgroup.Valign target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocColgroup.Valign)get_store().find_attribute_user(VALIGN$18);
            return target;
        }
    }
     ...
     */
    public void setValign(uk.nhs.connect.iucds.cda.ucr.StrucDocColgroup.Valign.Enum valign)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetValign(uk.nhs.connect.iucds.cda.ucr.StrucDocColgroup.Valign valign)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.StrucDocColgroup.Valign)get_store().add_attribute_user(VALIGN$18);
            }
            target.set(valign);
        }
    }
     ...
     */
    public static class AlignImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements uk.nhs.connect.iucds.cda.ucr.StrucDocColgroup.Align
    {
        private static final long serialVersionUID = 1L;
     ...
     */
    public static class ValignImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements uk.nhs.connect.iucds.cda.ucr.StrucDocColgroup.Valign
    {
        private static final long serialVersionUID = 1L;
