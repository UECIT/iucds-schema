 ...
 */
public class POCDMT000002UK01Participant1Impl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Participant1
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000002UK01Participant1Impl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName ASSOCIATEDENTITY$12 = 
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01AssociatedEntity getAssociatedEntity()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01AssociatedEntity target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01AssociatedEntity)get_store().find_element_user(ASSOCIATEDENTITY$12, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setAssociatedEntity(uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01AssociatedEntity associatedEntity)
    {
        generatedSetterHelperImpl(associatedEntity, ASSOCIATEDENTITY$12, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "associatedEntity" element
     */
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01AssociatedEntity addNewAssociatedEntity()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01AssociatedEntity target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01AssociatedEntity)get_store().add_element_user(ASSOCIATEDENTITY$12);
            return target;
        }
    }
