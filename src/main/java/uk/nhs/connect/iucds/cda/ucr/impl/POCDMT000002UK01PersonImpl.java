 ...
 */
public class POCDMT000002UK01PersonImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Person
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000002UK01PersonImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.EntityClass xgetClassCode()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.cda.ucr.EntityClass)get_store().find_attribute_user(CLASSCODE$12);
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.EntityClass)get_default_attribute_value(CLASSCODE$12);
            }
            return target;
        }
    }
    ...
    public void xsetClassCode(uk.nhs.connect.iucds.cda.ucr.EntityClass classCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.EntityClass)get_store().add_attribute_user(CLASSCODE$12);
            }
    ...
    public uk.nhs.connect.iucds.cda.ucr.EntityDeterminer xgetDeterminerCode()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.cda.ucr.EntityDeterminer)get_store().find_attribute_user(DETERMINERCODE$14);
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.EntityDeterminer)get_default_attribute_value(DETERMINERCODE$14);
            }
            return target;
        }
    }
    ...
    public void xsetDeterminerCode(uk.nhs.connect.iucds.cda.ucr.EntityDeterminer determinerCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.EntityDeterminer)get_store().add_attribute_user(DETERMINERCODE$14);
            }
