 ...
 */
public class POCDMT000002UK01Component5Impl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Component5
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000002UK01Component5Impl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Section getSection()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Section target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Section)get_store().find_element_user(SECTION$8, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setSection(uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Section section)
    {
        generatedSetterHelperImpl(section, SECTION$8, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "section" element
     */
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Section addNewSection()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Section target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Section)get_store().add_element_user(SECTION$8);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.ActRelationshipHasComponent xgetTypeCode()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.cda.ucr.ActRelationshipHasComponent)get_store().find_attribute_user(TYPECODE$12);
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.ActRelationshipHasComponent)get_default_attribute_value(TYPECODE$12);
            }
            return target;
        }
    }
    ...
    public void xsetTypeCode(uk.nhs.connect.iucds.cda.ucr.ActRelationshipHasComponent typeCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.ActRelationshipHasComponent)get_store().add_attribute_user(TYPECODE$12);
            }
            target.set(typeCode);
        }
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.Bl2 xgetContextConductionInd()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.cda.ucr.Bl2)get_store().find_attribute_user(CONTEXTCONDUCTIONIND$14);
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.Bl2)get_default_attribute_value(CONTEXTCONDUCTIONIND$14);
            }
            return target;
        }
    }
    ...
    public void xsetContextConductionInd(uk.nhs.connect.iucds.cda.ucr.Bl2 contextConductionInd)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.Bl2)get_store().add_attribute_user(CONTEXTCONDUCTIONIND$14);
            }
