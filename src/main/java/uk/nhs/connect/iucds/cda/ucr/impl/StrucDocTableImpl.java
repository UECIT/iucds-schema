 ...
 */
public class StrucDocTableImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.cda.ucr.StrucDocTable
{
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.StrucDocCol[] getColArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            uk.nhs.connect.iucds.cda.ucr.StrucDocCol[] result = new uk.nhs.connect.iucds.cda.ucr.StrucDocCol[targetList.size()];
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.StrucDocCol getColArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.StrucDocCol target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocCol)get_store().find_element_user(COL$2, i);
            if (target == null)
            {
     ...
     */
    public void setColArray(uk.nhs.connect.iucds.cda.ucr.StrucDocCol[] colArray)
    {
        check_orphaned();
     ...
     */
    public void setColArray(int i, uk.nhs.connect.iucds.cda.ucr.StrucDocCol col)
    {
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.StrucDocCol insertNewCol(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.StrucDocCol target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocCol)get_store().insert_element_user(COL$2, i);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.StrucDocCol addNewCol()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.StrucDocCol target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocCol)get_store().add_element_user(COL$2);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.StrucDocColgroup[] getColgroupArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            uk.nhs.connect.iucds.cda.ucr.StrucDocColgroup[] result = new uk.nhs.connect.iucds.cda.ucr.StrucDocColgroup[targetList.size()];
            targetList.toArray(result);
            return result;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.StrucDocColgroup getColgroupArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.StrucDocColgroup target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocColgroup)get_store().find_element_user(COLGROUP$4, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
     ...
     */
    public void setColgroupArray(uk.nhs.connect.iucds.cda.ucr.StrucDocColgroup[] colgroupArray)
    {
        check_orphaned();
     ...
     */
    public void setColgroupArray(int i, uk.nhs.connect.iucds.cda.ucr.StrucDocColgroup colgroup)
    {
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.StrucDocColgroup insertNewColgroup(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.StrucDocColgroup target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocColgroup)get_store().insert_element_user(COLGROUP$4, i);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.StrucDocColgroup addNewColgroup()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.StrucDocColgroup target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocColgroup)get_store().add_element_user(COLGROUP$4);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.StrucDocThead getThead()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.StrucDocThead target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocThead)get_store().find_element_user(THEAD$6, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setThead(uk.nhs.connect.iucds.cda.ucr.StrucDocThead thead)
    {
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.StrucDocThead addNewThead()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.StrucDocThead target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocThead)get_store().add_element_user(THEAD$6);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.StrucDocTfoot getTfoot()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.StrucDocTfoot target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocTfoot)get_store().find_element_user(TFOOT$8, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setTfoot(uk.nhs.connect.iucds.cda.ucr.StrucDocTfoot tfoot)
    {
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.StrucDocTfoot addNewTfoot()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.StrucDocTfoot target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocTfoot)get_store().add_element_user(TFOOT$8);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.StrucDocTbody[] getTbodyArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            uk.nhs.connect.iucds.cda.ucr.StrucDocTbody[] result = new uk.nhs.connect.iucds.cda.ucr.StrucDocTbody[targetList.size()];
            targetList.toArray(result);
            return result;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.StrucDocTbody getTbodyArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.StrucDocTbody target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocTbody)get_store().find_element_user(TBODY$10, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
     ...
     */
    public void setTbodyArray(uk.nhs.connect.iucds.cda.ucr.StrucDocTbody[] tbodyArray)
    {
        check_orphaned();
     ...
     */
    public void setTbodyArray(int i, uk.nhs.connect.iucds.cda.ucr.StrucDocTbody tbody)
    {
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.StrucDocTbody insertNewTbody(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.StrucDocTbody target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocTbody)get_store().insert_element_user(TBODY$10, i);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.StrucDocTbody addNewTbody()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.StrucDocTbody target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocTbody)get_store().add_element_user(TBODY$10);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.StrucDocTable.Frame.Enum getFrame()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (uk.nhs.connect.iucds.cda.ucr.StrucDocTable.Frame.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.StrucDocTable.Frame xgetFrame()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.StrucDocTable.Frame target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocTable.Frame)get_store().find_attribute_user(FRAME$24);
            return target;
        }
    }
     ...
     */
    public void setFrame(uk.nhs.connect.iucds.cda.ucr.StrucDocTable.Frame.Enum frame)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetFrame(uk.nhs.connect.iucds.cda.ucr.StrucDocTable.Frame frame)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.StrucDocTable.Frame)get_store().add_attribute_user(FRAME$24);
            }
            target.set(frame);
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.StrucDocTable.Rules.Enum getRules()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (uk.nhs.connect.iucds.cda.ucr.StrucDocTable.Rules.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.StrucDocTable.Rules xgetRules()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.StrucDocTable.Rules target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocTable.Rules)get_store().find_attribute_user(RULES$26);
            return target;
        }
    }
     ...
     */
    public void setRules(uk.nhs.connect.iucds.cda.ucr.StrucDocTable.Rules.Enum rules)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetRules(uk.nhs.connect.iucds.cda.ucr.StrucDocTable.Rules rules)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.StrucDocTable.Rules)get_store().add_attribute_user(RULES$26);
            }
            target.set(rules);
        }
    }
     ...
     */
    public static class FrameImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements uk.nhs.connect.iucds.cda.ucr.StrucDocTable.Frame
    {
        private static final long serialVersionUID = 1L;
     ...
     */
    public static class RulesImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements uk.nhs.connect.iucds.cda.ucr.StrucDocTable.Rules
    {
        private static final long serialVersionUID = 1L;
