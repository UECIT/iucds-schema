 ...
 */
public class StrucDocLinkHtmlImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.cda.ucr.StrucDocLinkHtml
{
    ...
    public uk.nhs.connect.iucds.cda.ucr.StrucDocFootnote getFootnoteArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocFootnote)get_store().find_element_user(FOOTNOTE$0, i);
            if (target == null)
            {
    ...
    {
        generatedSetterHelperImpl(footnote, FOOTNOTE$0, i, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_ARRAYITEM);
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.StrucDocFootnote insertNewFootnote(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.StrucDocFootnote target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocFootnote)get_store().insert_element_user(FOOTNOTE$0, i);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.StrucDocFootnote addNewFootnote()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.StrucDocFootnote target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocFootnote)get_store().add_element_user(FOOTNOTE$0);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.StrucDocFootnoteRef getFootnoteRefArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocFootnoteRef)get_store().find_element_user(FOOTNOTEREF$2, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    {
        generatedSetterHelperImpl(footnoteRef, FOOTNOTEREF$2, i, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_ARRAYITEM);
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.StrucDocFootnoteRef insertNewFootnoteRef(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.StrucDocFootnoteRef target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocFootnoteRef)get_store().insert_element_user(FOOTNOTEREF$2, i);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.StrucDocFootnoteRef addNewFootnoteRef()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.StrucDocFootnoteRef target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocFootnoteRef)get_store().add_element_user(FOOTNOTEREF$2);
            return target;
        }
    }
