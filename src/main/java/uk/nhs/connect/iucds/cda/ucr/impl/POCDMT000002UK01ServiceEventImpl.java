 ...
 */
public class POCDMT000002UK01ServiceEventImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01ServiceEvent
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000002UK01ServiceEventImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName PERFORMER$14 = 
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Performer1[] getPerformerArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            java.util.List targetList = new java.util.ArrayList();
            get_store().find_all_element_users(PERFORMER$14, targetList);
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Performer1[] result = new uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Performer1[targetList.size()];
            targetList.toArray(result);
            return result;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Performer1 getPerformerArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Performer1 target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Performer1)get_store().find_element_user(PERFORMER$14, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    public int sizeOfPerformerArray()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(PERFORMER$14);
        }
    }
     ...
     */
    public void setPerformerArray(uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Performer1[] performerArray)
    {
        check_orphaned();
        arraySetterHelper(performerArray, PERFORMER$14);
    }
    
    /**
     * Sets ith "performer" element
     */
    public void setPerformerArray(int i, uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Performer1 performer)
    {
        generatedSetterHelperImpl(performer, PERFORMER$14, i, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_ARRAYITEM);
    }
    
    /**
     * Inserts and returns a new empty value (as xml) as the ith "performer" element
     */
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Performer1 insertNewPerformer(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Performer1 target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Performer1)get_store().insert_element_user(PERFORMER$14, i);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Performer1 addNewPerformer()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Performer1 target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Performer1)get_store().add_element_user(PERFORMER$14);
            return target;
        }
    }
    ...
    public void removePerformer(int i)
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(PERFORMER$14, i);
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.ActClassRoot xgetClassCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.ActClassRoot target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.ActClassRoot)get_store().find_attribute_user(CLASSCODE$18);
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.ActClassRoot)get_default_attribute_value(CLASSCODE$18);
            }
            return target;
        }
    }
     ...
     */
    public void xsetClassCode(uk.nhs.connect.iucds.cda.ucr.ActClassRoot classCode)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.ActClassRoot)get_store().add_attribute_user(CLASSCODE$18);
            }
    ...
    public uk.nhs.connect.iucds.cda.ucr.ActMood xgetMoodCode()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.cda.ucr.ActMood)get_store().find_attribute_user(MOODCODE$20);
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.ActMood)get_default_attribute_value(MOODCODE$20);
            }
            return target;
        }
    }
    ...
    public void xsetMoodCode(uk.nhs.connect.iucds.cda.ucr.ActMood moodCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.ActMood)get_store().add_attribute_user(MOODCODE$20);
            }
            target.set(moodCode);
        }
    }
