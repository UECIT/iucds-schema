 ...
 */
public class GLISTTSImpl extends uk.nhs.connect.iucds.cda.ucr.impl.ANYImpl implements uk.nhs.connect.iucds.cda.ucr.GLISTTS
{
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.TS getHead()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.TS target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.TS)get_store().find_element_user(HEAD$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setHead(uk.nhs.connect.iucds.cda.ucr.TS head)
    {
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.TS addNewHead()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.TS target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.TS)get_store().add_element_user(HEAD$0);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.PQ getIncrement()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.PQ target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.PQ)get_store().find_element_user(INCREMENT$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setIncrement(uk.nhs.connect.iucds.cda.ucr.PQ increment)
    {
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.PQ addNewIncrement()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.PQ target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.PQ)get_store().add_element_user(INCREMENT$2);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.Int2 xgetPeriod()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.Int2 target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.Int2)get_store().find_attribute_user(PERIOD$4);
            return target;
        }
    }
     ...
     */
    public void xsetPeriod(uk.nhs.connect.iucds.cda.ucr.Int2 period)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.Int2)get_store().add_attribute_user(PERIOD$4);
            }
            target.set(period);
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.Int2 xgetDenominator()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.Int2 target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.Int2)get_store().find_attribute_user(DENOMINATOR$6);
            return target;
        }
    }
     ...
     */
    public void xsetDenominator(uk.nhs.connect.iucds.cda.ucr.Int2 denominator)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.Int2)get_store().add_attribute_user(DENOMINATOR$6);
            }
