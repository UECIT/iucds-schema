 ...
 */
public class AllInfrastructureRootTypeIdImpl extends uk.nhs.connect.iucds.cda.ucr.impl.IIImpl implements uk.nhs.connect.iucds.cda.ucr.AllInfrastructureRootTypeId
{
    private static final long serialVersionUID = 1L;
    
    public AllInfrastructureRootTypeIdImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
