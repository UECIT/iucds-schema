 ...
 */
public class POCDMT000002UK01AuthorizationImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Authorization
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000002UK01AuthorizationImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName CONSENT$8 = 
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Consent getConsent()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Consent target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Consent)get_store().find_element_user(CONSENT$8, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setConsent(uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Consent consent)
    {
        generatedSetterHelperImpl(consent, CONSENT$8, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "consent" element
     */
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Consent addNewConsent()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Consent target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Consent)get_store().add_element_user(CONSENT$8);
            return target;
        }
    }
