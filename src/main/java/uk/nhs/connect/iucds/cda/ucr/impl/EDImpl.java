 ...
 */
public class EDImpl extends uk.nhs.connect.iucds.cda.ucr.impl.BINImpl implements uk.nhs.connect.iucds.cda.ucr.ED
{
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.TEL getReference()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.TEL target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.TEL)get_store().find_element_user(REFERENCE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setReference(uk.nhs.connect.iucds.cda.ucr.TEL reference)
    {
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.TEL addNewReference()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.TEL target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.TEL)get_store().add_element_user(REFERENCE$0);
            return target;
        }
    }
