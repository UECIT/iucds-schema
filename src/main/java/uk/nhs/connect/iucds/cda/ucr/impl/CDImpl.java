 ...
 */
public class CDImpl extends uk.nhs.connect.iucds.cda.ucr.impl.ANYImpl implements uk.nhs.connect.iucds.cda.ucr.CD
{
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.CD.Group[] getGroupArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            uk.nhs.connect.iucds.cda.ucr.CD.Group[] result = new uk.nhs.connect.iucds.cda.ucr.CD.Group[targetList.size()];
            targetList.toArray(result);
            return result;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.CD.Group getGroupArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.CD.Group target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.CD.Group)get_store().find_element_user(GROUP$4, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
     ...
     */
    public void setGroupArray(uk.nhs.connect.iucds.cda.ucr.CD.Group[] groupArray)
    {
        check_orphaned();
     ...
     */
    public void setGroupArray(int i, uk.nhs.connect.iucds.cda.ucr.CD.Group group)
    {
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.CD.Group insertNewGroup(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.CD.Group target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.CD.Group)get_store().insert_element_user(GROUP$4, i);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.CD.Group addNewGroup()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.CD.Group target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.CD.Group)get_store().add_element_user(GROUP$4);
            return target;
        }
    }
     ...
     * This is a complex type.
     */
    public static class GroupImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.cda.ucr.CD.Group
    {
        private static final long serialVersionUID = 1L;
