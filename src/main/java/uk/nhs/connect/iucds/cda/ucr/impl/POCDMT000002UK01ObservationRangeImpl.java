 ...
 */
public class POCDMT000002UK01ObservationRangeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01ObservationRange
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000002UK01ObservationRangeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName INTERPRETATIONCODE$14 = 
    ...
    public uk.nhs.connect.iucds.cda.ucr.CDNPfITCDAUrl getCode()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.cda.ucr.CDNPfITCDAUrl)get_store().find_element_user(CODE$8, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public uk.nhs.connect.iucds.cda.ucr.CDNPfITCDAUrl addNewCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.CDNPfITCDAUrl target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.CDNPfITCDAUrl)get_store().add_element_user(CODE$8);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.ED getText()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.cda.ucr.ED)get_store().find_element_user(TEXT$10, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(text, TEXT$10, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.ED addNewText()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.ED target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.ED)get_store().add_element_user(TEXT$10);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.ANY getValue()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.ANY target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.ANY)get_store().find_element_user(VALUE$12, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetValue()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(VALUE$12) != 0;
        }
    }
     ...
     */
    public void setValue(uk.nhs.connect.iucds.cda.ucr.ANY value)
    {
        generatedSetterHelperImpl(value, VALUE$12, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.ANY addNewValue()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.ANY target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.ANY)get_store().add_element_user(VALUE$12);
            return target;
        }
    }
    ...
    public void unsetValue()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(VALUE$12, 0);
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.CE getInterpretationCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.CE target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.CE)get_store().find_element_user(INTERPRETATIONCODE$14, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetInterpretationCode()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(INTERPRETATIONCODE$14) != 0;
        }
    }
     ...
     */
    public void setInterpretationCode(uk.nhs.connect.iucds.cda.ucr.CE interpretationCode)
    {
        generatedSetterHelperImpl(interpretationCode, INTERPRETATIONCODE$14, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.CE addNewInterpretationCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.CE target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.CE)get_store().add_element_user(INTERPRETATIONCODE$14);
            return target;
        }
    }
    ...
    public void unsetInterpretationCode()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(INTERPRETATIONCODE$14, 0);
        }
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.ActClassObservation xgetClassCode()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.cda.ucr.ActClassObservation)get_store().find_attribute_user(CLASSCODE$18);
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.ActClassObservation)get_default_attribute_value(CLASSCODE$18);
            }
            return target;
        }
    }
    ...
    public void xsetClassCode(uk.nhs.connect.iucds.cda.ucr.ActClassObservation classCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.ActClassObservation)get_store().add_attribute_user(CLASSCODE$18);
            }
