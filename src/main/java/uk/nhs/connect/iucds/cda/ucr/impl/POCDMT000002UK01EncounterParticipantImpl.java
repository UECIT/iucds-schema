 ...
 */
public class POCDMT000002UK01EncounterParticipantImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01EncounterParticipant
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000002UK01EncounterParticipantImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01AssignedEntity getAssignedEntity()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01AssignedEntity)get_store().find_element_user(ASSIGNEDENTITY$10, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(assignedEntity, ASSIGNEDENTITY$10, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01AssignedEntity addNewAssignedEntity()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01AssignedEntity target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01AssignedEntity)get_store().add_element_user(ASSIGNEDENTITY$10);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.XEncounterParticipant.Enum getTypeCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (uk.nhs.connect.iucds.cda.ucr.XEncounterParticipant.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.XEncounterParticipant xgetTypeCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.XEncounterParticipant target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.XEncounterParticipant)get_store().find_attribute_user(TYPECODE$14);
            return target;
        }
    }
     ...
     */
    public void setTypeCode(uk.nhs.connect.iucds.cda.ucr.XEncounterParticipant.Enum typeCode)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetTypeCode(uk.nhs.connect.iucds.cda.ucr.XEncounterParticipant typeCode)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.XEncounterParticipant)get_store().add_attribute_user(TYPECODE$14);
            }
            target.set(typeCode);
        }
    }
