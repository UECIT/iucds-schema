 ...
 */
public class POCDMT000002UK01ReferenceRangeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01ReferenceRange
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000002UK01ReferenceRangeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName OBSERVATIONRANGE$8 = 
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01ObservationRange getObservationRange()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01ObservationRange target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01ObservationRange)get_store().find_element_user(OBSERVATIONRANGE$8, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setObservationRange(uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01ObservationRange observationRange)
    {
        generatedSetterHelperImpl(observationRange, OBSERVATIONRANGE$8, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "observationRange" element
     */
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01ObservationRange addNewObservationRange()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01ObservationRange target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01ObservationRange)get_store().add_element_user(OBSERVATIONRANGE$8);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.ActRelationshipType xgetTypeCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.ActRelationshipType target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.ActRelationshipType)get_store().find_attribute_user(TYPECODE$12);
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.ActRelationshipType)get_default_attribute_value(TYPECODE$12);
            }
            return target;
        }
    }
     ...
     */
    public void xsetTypeCode(uk.nhs.connect.iucds.cda.ucr.ActRelationshipType typeCode)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.ActRelationshipType)get_store().add_attribute_user(TYPECODE$12);
            }
            target.set(typeCode);
        }
    }
