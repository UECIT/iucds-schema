 ...
 */
public class POCDMT000002UK01OrganizationPartOfImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01OrganizationPartOf
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000002UK01OrganizationPartOfImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName WHOLEORGANIZATION$16 = 
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Organization getWholeOrganization()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Organization target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Organization)get_store().find_element_user(WHOLEORGANIZATION$16, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetWholeOrganization()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(WHOLEORGANIZATION$16) != 0;
        }
    }
     ...
     */
    public void setWholeOrganization(uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Organization wholeOrganization)
    {
        generatedSetterHelperImpl(wholeOrganization, WHOLEORGANIZATION$16, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "wholeOrganization" element
     */
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Organization addNewWholeOrganization()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Organization target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Organization)get_store().add_element_user(WHOLEORGANIZATION$16);
            return target;
        }
    }
    ...
    public void unsetWholeOrganization()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(WHOLEORGANIZATION$16, 0);
        }
    }
