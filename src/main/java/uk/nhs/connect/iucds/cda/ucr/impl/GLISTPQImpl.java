 ...
 */
public class GLISTPQImpl extends uk.nhs.connect.iucds.cda.ucr.impl.ANYImpl implements uk.nhs.connect.iucds.cda.ucr.GLISTPQ
{
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.PQ getHead()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.PQ target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.PQ)get_store().find_element_user(HEAD$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setHead(uk.nhs.connect.iucds.cda.ucr.PQ head)
    {
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.PQ addNewHead()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.PQ target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.PQ)get_store().add_element_user(HEAD$0);
            return target;
        }
    }
