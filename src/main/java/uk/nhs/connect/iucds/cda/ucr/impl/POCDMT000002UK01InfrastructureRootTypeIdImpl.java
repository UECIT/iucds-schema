 ...
 */
public class POCDMT000002UK01InfrastructureRootTypeIdImpl extends uk.nhs.connect.iucds.cda.ucr.impl.IIImpl implements uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01InfrastructureRootTypeId
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000002UK01InfrastructureRootTypeIdImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.Uid xgetRoot()
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.Uid)get_default_attribute_value(ROOT$0);
            }
            return target;
        }
    }
