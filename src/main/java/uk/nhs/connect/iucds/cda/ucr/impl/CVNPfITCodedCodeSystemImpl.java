 ...
 */
public class CVNPfITCodedCodeSystemImpl extends uk.nhs.connect.iucds.cda.ucr.impl.CVImpl implements uk.nhs.connect.iucds.cda.ucr.CVNPfITCodedCodeSystem
{
    private static final long serialVersionUID = 1L;
    
    public CVNPfITCodedCodeSystemImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
