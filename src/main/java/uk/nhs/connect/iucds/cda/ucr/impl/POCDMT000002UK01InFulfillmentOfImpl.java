 ...
 */
public class POCDMT000002UK01InFulfillmentOfImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01InFulfillmentOf
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000002UK01InFulfillmentOfImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName ORDER$8 = 
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Order getOrder()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Order target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Order)get_store().find_element_user(ORDER$8, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setOrder(uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Order order)
    {
        generatedSetterHelperImpl(order, ORDER$8, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "order" element
     */
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Order addNewOrder()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Order target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Order)get_store().add_element_user(ORDER$8);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.ActRelationshipFulfillsX.Enum getTypeCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (uk.nhs.connect.iucds.cda.ucr.ActRelationshipFulfillsX.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.ActRelationshipFulfills xgetTypeCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.ActRelationshipFulfills target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.ActRelationshipFulfills)get_store().find_attribute_user(TYPECODE$12);
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.ActRelationshipFulfills)get_default_attribute_value(TYPECODE$12);
            }
            return target;
        }
    }
     ...
     */
    public void setTypeCode(uk.nhs.connect.iucds.cda.ucr.ActRelationshipFulfillsX.Enum typeCode)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetTypeCode(uk.nhs.connect.iucds.cda.ucr.ActRelationshipFulfills typeCode)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.ActRelationshipFulfills)get_store().add_attribute_user(TYPECODE$12);
            }
            target.set(typeCode);
        }
    }
