 ...
 */
public class POCDMT000002UK01LocationImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Location
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000002UK01LocationImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName HEALTHCAREFACILITY$8 = 
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01HealthCareFacility getHealthCareFacility()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01HealthCareFacility target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01HealthCareFacility)get_store().find_element_user(HEALTHCAREFACILITY$8, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setHealthCareFacility(uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01HealthCareFacility healthCareFacility)
    {
        generatedSetterHelperImpl(healthCareFacility, HEALTHCAREFACILITY$8, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "healthCareFacility" element
     */
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01HealthCareFacility addNewHealthCareFacility()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01HealthCareFacility target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01HealthCareFacility)get_store().add_element_user(HEALTHCAREFACILITY$8);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.ParticipationTargetLocationX.Enum getTypeCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (uk.nhs.connect.iucds.cda.ucr.ParticipationTargetLocationX.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.ParticipationTargetLocation xgetTypeCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.ParticipationTargetLocation target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.ParticipationTargetLocation)get_store().find_attribute_user(TYPECODE$12);
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.ParticipationTargetLocation)get_default_attribute_value(TYPECODE$12);
            }
            return target;
        }
    }
     ...
     */
    public void setTypeCode(uk.nhs.connect.iucds.cda.ucr.ParticipationTargetLocationX.Enum typeCode)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetTypeCode(uk.nhs.connect.iucds.cda.ucr.ParticipationTargetLocation typeCode)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.ParticipationTargetLocation)get_store().add_attribute_user(TYPECODE$12);
            }
            target.set(typeCode);
        }
    }
