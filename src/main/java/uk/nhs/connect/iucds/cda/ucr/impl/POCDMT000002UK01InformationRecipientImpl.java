 ...
 */
public class POCDMT000002UK01InformationRecipientImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01InformationRecipient
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000002UK01InformationRecipientImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName INTENDEDRECIPIENT$8 = 
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01IntendedRecipient getIntendedRecipient()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01IntendedRecipient target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01IntendedRecipient)get_store().find_element_user(INTENDEDRECIPIENT$8, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setIntendedRecipient(uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01IntendedRecipient intendedRecipient)
    {
        generatedSetterHelperImpl(intendedRecipient, INTENDEDRECIPIENT$8, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "intendedRecipient" element
     */
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01IntendedRecipient addNewIntendedRecipient()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01IntendedRecipient target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01IntendedRecipient)get_store().add_element_user(INTENDEDRECIPIENT$8);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.XInformationRecipientX.Enum getTypeCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (uk.nhs.connect.iucds.cda.ucr.XInformationRecipientX.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.XInformationRecipient xgetTypeCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.XInformationRecipient target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.XInformationRecipient)get_store().find_attribute_user(TYPECODE$12);
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.XInformationRecipient)get_default_attribute_value(TYPECODE$12);
            }
            return target;
        }
    }
     ...
     */
    public void setTypeCode(uk.nhs.connect.iucds.cda.ucr.XInformationRecipientX.Enum typeCode)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetTypeCode(uk.nhs.connect.iucds.cda.ucr.XInformationRecipient typeCode)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.XInformationRecipient)get_store().add_attribute_user(TYPECODE$12);
            }
            target.set(typeCode);
        }
    }
