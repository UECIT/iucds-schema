 ...
 */
public class POCDMT000002UK01CriterionImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Criterion
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000002UK01CriterionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.ActClassObservation xgetClassCode()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.cda.ucr.ActClassObservation)get_store().find_attribute_user(CLASSCODE$16);
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.ActClassObservation)get_default_attribute_value(CLASSCODE$16);
            }
            return target;
        }
    }
    ...
    public void xsetClassCode(uk.nhs.connect.iucds.cda.ucr.ActClassObservation classCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.ActClassObservation)get_store().add_attribute_user(CLASSCODE$16);
            }
