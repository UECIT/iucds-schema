 ...
 */
public class POCDMT000002UK01SpecimenImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Specimen
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000002UK01SpecimenImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName SPECIMENROLE$8 = 
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01SpecimenRole getSpecimenRole()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01SpecimenRole target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01SpecimenRole)get_store().find_element_user(SPECIMENROLE$8, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setSpecimenRole(uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01SpecimenRole specimenRole)
    {
        generatedSetterHelperImpl(specimenRole, SPECIMENROLE$8, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "specimenRole" element
     */
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01SpecimenRole addNewSpecimenRole()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01SpecimenRole target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01SpecimenRole)get_store().add_element_user(SPECIMENROLE$8);
            return target;
        }
    }
