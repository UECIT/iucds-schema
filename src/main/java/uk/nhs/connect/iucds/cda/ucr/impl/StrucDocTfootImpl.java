 ...
 */
public class StrucDocTfootImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.cda.ucr.StrucDocTfoot
{
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.StrucDocTfoot.Align.Enum getAlign()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (uk.nhs.connect.iucds.cda.ucr.StrucDocTfoot.Align.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.StrucDocTfoot.Align xgetAlign()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.StrucDocTfoot.Align target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocTfoot.Align)get_store().find_attribute_user(ALIGN$8);
            return target;
        }
    }
     ...
     */
    public void setAlign(uk.nhs.connect.iucds.cda.ucr.StrucDocTfoot.Align.Enum align)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetAlign(uk.nhs.connect.iucds.cda.ucr.StrucDocTfoot.Align align)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.StrucDocTfoot.Align)get_store().add_attribute_user(ALIGN$8);
            }
            target.set(align);
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.StrucDocTfoot.Valign.Enum getValign()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (uk.nhs.connect.iucds.cda.ucr.StrucDocTfoot.Valign.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.StrucDocTfoot.Valign xgetValign()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.StrucDocTfoot.Valign target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocTfoot.Valign)get_store().find_attribute_user(VALIGN$14);
            return target;
        }
    }
     ...
     */
    public void setValign(uk.nhs.connect.iucds.cda.ucr.StrucDocTfoot.Valign.Enum valign)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetValign(uk.nhs.connect.iucds.cda.ucr.StrucDocTfoot.Valign valign)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.StrucDocTfoot.Valign)get_store().add_attribute_user(VALIGN$14);
            }
            target.set(valign);
        }
    }
     ...
     */
    public static class AlignImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements uk.nhs.connect.iucds.cda.ucr.StrucDocTfoot.Align
    {
        private static final long serialVersionUID = 1L;
     ...
     */
    public static class ValignImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements uk.nhs.connect.iucds.cda.ucr.StrucDocTfoot.Valign
    {
        private static final long serialVersionUID = 1L;
