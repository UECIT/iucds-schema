 ...
 */
public class ENImpl extends uk.nhs.connect.iucds.cda.ucr.impl.ANYImpl implements uk.nhs.connect.iucds.cda.ucr.EN
{
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.EnDelimiter[] getDelimiterArray()
    {
        synchronized (monitor())
        {
            ...
            uk.nhs.connect.iucds.cda.ucr.EnDelimiter[] result = new uk.nhs.connect.iucds.cda.ucr.EnDelimiter[targetList.size()];
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.EnDelimiter getDelimiterArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.EnDelimiter target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.EnDelimiter)get_store().find_element_user(DELIMITER$0, i);
            if (target == null)
            {
     ...
     */
    public void setDelimiterArray(uk.nhs.connect.iucds.cda.ucr.EnDelimiter[] delimiterArray)
    {
        check_orphaned();
     ...
     */
    public void setDelimiterArray(int i, uk.nhs.connect.iucds.cda.ucr.EnDelimiter delimiter)
    {
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.EnDelimiter insertNewDelimiter(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.EnDelimiter target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.EnDelimiter)get_store().insert_element_user(DELIMITER$0, i);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.EnDelimiter addNewDelimiter()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.EnDelimiter target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.EnDelimiter)get_store().add_element_user(DELIMITER$0);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.EnFamily[] getFamilyArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            uk.nhs.connect.iucds.cda.ucr.EnFamily[] result = new uk.nhs.connect.iucds.cda.ucr.EnFamily[targetList.size()];
            targetList.toArray(result);
            return result;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.EnFamily getFamilyArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.EnFamily target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.EnFamily)get_store().find_element_user(FAMILY$2, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
     ...
     */
    public void setFamilyArray(uk.nhs.connect.iucds.cda.ucr.EnFamily[] familyArray)
    {
        check_orphaned();
     ...
     */
    public void setFamilyArray(int i, uk.nhs.connect.iucds.cda.ucr.EnFamily family)
    {
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.EnFamily insertNewFamily(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.EnFamily target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.EnFamily)get_store().insert_element_user(FAMILY$2, i);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.EnFamily addNewFamily()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.EnFamily target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.EnFamily)get_store().add_element_user(FAMILY$2);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.EnGiven[] getGivenArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            uk.nhs.connect.iucds.cda.ucr.EnGiven[] result = new uk.nhs.connect.iucds.cda.ucr.EnGiven[targetList.size()];
            targetList.toArray(result);
            return result;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.EnGiven getGivenArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.EnGiven target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.EnGiven)get_store().find_element_user(GIVEN$4, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
     ...
     */
    public void setGivenArray(uk.nhs.connect.iucds.cda.ucr.EnGiven[] givenArray)
    {
        check_orphaned();
     ...
     */
    public void setGivenArray(int i, uk.nhs.connect.iucds.cda.ucr.EnGiven given)
    {
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.EnGiven insertNewGiven(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.EnGiven target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.EnGiven)get_store().insert_element_user(GIVEN$4, i);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.EnGiven addNewGiven()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.EnGiven target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.EnGiven)get_store().add_element_user(GIVEN$4);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.EnPrefix[] getPrefixArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            uk.nhs.connect.iucds.cda.ucr.EnPrefix[] result = new uk.nhs.connect.iucds.cda.ucr.EnPrefix[targetList.size()];
            targetList.toArray(result);
            return result;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.EnPrefix getPrefixArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.EnPrefix target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.EnPrefix)get_store().find_element_user(PREFIX$6, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
     ...
     */
    public void setPrefixArray(uk.nhs.connect.iucds.cda.ucr.EnPrefix[] prefixArray)
    {
        check_orphaned();
     ...
     */
    public void setPrefixArray(int i, uk.nhs.connect.iucds.cda.ucr.EnPrefix prefix)
    {
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.EnPrefix insertNewPrefix(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.EnPrefix target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.EnPrefix)get_store().insert_element_user(PREFIX$6, i);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.EnPrefix addNewPrefix()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.EnPrefix target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.EnPrefix)get_store().add_element_user(PREFIX$6);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.EnSuffix[] getSuffixArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            uk.nhs.connect.iucds.cda.ucr.EnSuffix[] result = new uk.nhs.connect.iucds.cda.ucr.EnSuffix[targetList.size()];
            targetList.toArray(result);
            return result;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.EnSuffix getSuffixArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.EnSuffix target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.EnSuffix)get_store().find_element_user(SUFFIX$8, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
     ...
     */
    public void setSuffixArray(uk.nhs.connect.iucds.cda.ucr.EnSuffix[] suffixArray)
    {
        check_orphaned();
     ...
     */
    public void setSuffixArray(int i, uk.nhs.connect.iucds.cda.ucr.EnSuffix suffix)
    {
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.EnSuffix insertNewSuffix(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.EnSuffix target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.EnSuffix)get_store().insert_element_user(SUFFIX$8, i);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.EnSuffix addNewSuffix()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.EnSuffix target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.EnSuffix)get_store().add_element_user(SUFFIX$8);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.IVLTS getValidTime()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.IVLTS target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.IVLTS)get_store().find_element_user(VALIDTIME$10, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setValidTime(uk.nhs.connect.iucds.cda.ucr.IVLTS validTime)
    {
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.IVLTS addNewValidTime()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.IVLTS target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.IVLTS)get_store().add_element_user(VALIDTIME$10);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.II getId()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.cda.ucr.II)get_store().find_element_user(ID$12, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public uk.nhs.connect.iucds.cda.ucr.II addNewId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.II target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.II)get_store().add_element_user(ID$12);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.SetCsEntityNameUse xgetUse()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.SetCsEntityNameUse target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.SetCsEntityNameUse)get_store().find_attribute_user(USE$14);
            return target;
        }
    }
     ...
     */
    public void xsetUse(uk.nhs.connect.iucds.cda.ucr.SetCsEntityNameUse use)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.SetCsEntityNameUse)get_store().add_attribute_user(USE$14);
            }
            target.set(use);
        }
    }
