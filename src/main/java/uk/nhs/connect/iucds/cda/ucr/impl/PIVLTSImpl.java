 ...
 */
public class PIVLTSImpl extends uk.nhs.connect.iucds.cda.ucr.impl.SXCMTSImpl implements uk.nhs.connect.iucds.cda.ucr.PIVLTS
{
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.IVLTS getPhase()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.IVLTS target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.IVLTS)get_store().find_element_user(PHASE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setPhase(uk.nhs.connect.iucds.cda.ucr.IVLTS phase)
    {
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.IVLTS addNewPhase()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.IVLTS target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.IVLTS)get_store().add_element_user(PHASE$0);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.PQ getPeriod()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.PQ target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.PQ)get_store().find_element_user(PERIOD$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setPeriod(uk.nhs.connect.iucds.cda.ucr.PQ period)
    {
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.PQ addNewPeriod()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.PQ target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.PQ)get_store().add_element_user(PERIOD$2);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.CalendarCycle xgetAlignment()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.CalendarCycle target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.CalendarCycle)get_store().find_attribute_user(ALIGNMENT$4);
            return target;
        }
    }
     ...
     */
    public void xsetAlignment(uk.nhs.connect.iucds.cda.ucr.CalendarCycle alignment)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.CalendarCycle)get_store().add_attribute_user(ALIGNMENT$4);
            }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.Bl2 xgetInstitutionSpecified()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.Bl2 target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.Bl2)get_store().find_attribute_user(INSTITUTIONSPECIFIED$6);
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.Bl2)get_default_attribute_value(INSTITUTIONSPECIFIED$6);
            }
            return target;
        }
    }
     ...
     */
    public void xsetInstitutionSpecified(uk.nhs.connect.iucds.cda.ucr.Bl2 institutionSpecified)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.Bl2)get_store().add_attribute_user(INSTITUTIONSPECIFIED$6);
            }
