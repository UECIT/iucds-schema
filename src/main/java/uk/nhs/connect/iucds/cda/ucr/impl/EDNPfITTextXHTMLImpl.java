 ...
 */
public class EDNPfITTextXHTMLImpl extends uk.nhs.connect.iucds.cda.ucr.impl.EDImpl implements uk.nhs.connect.iucds.cda.ucr.EDNPfITTextXHTML
{
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.EDNPfITTextXHTML.Html getHtml()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.EDNPfITTextXHTML.Html target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.EDNPfITTextXHTML.Html)get_store().find_element_user(HTML$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setHtml(uk.nhs.connect.iucds.cda.ucr.EDNPfITTextXHTML.Html html)
    {
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.EDNPfITTextXHTML.Html addNewHtml()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.EDNPfITTextXHTML.Html target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.EDNPfITTextXHTML.Html)get_store().add_element_user(HTML$0);
            return target;
        }
    }
     ...
     * This is a complex type.
     */
    public static class HtmlImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.cda.ucr.EDNPfITTextXHTML.Html
    {
        private static final long serialVersionUID = 1L;
