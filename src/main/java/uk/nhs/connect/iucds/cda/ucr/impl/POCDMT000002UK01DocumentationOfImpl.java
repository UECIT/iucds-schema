 ...
 */
public class POCDMT000002UK01DocumentationOfImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01DocumentationOf
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000002UK01DocumentationOfImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName SERVICEEVENT$8 = 
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01ServiceEvent getServiceEvent()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01ServiceEvent target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01ServiceEvent)get_store().find_element_user(SERVICEEVENT$8, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setServiceEvent(uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01ServiceEvent serviceEvent)
    {
        generatedSetterHelperImpl(serviceEvent, SERVICEEVENT$8, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "serviceEvent" element
     */
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01ServiceEvent addNewServiceEvent()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01ServiceEvent target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01ServiceEvent)get_store().add_element_user(SERVICEEVENT$8);
            return target;
        }
    }
