 ...
 */
public class IINPfITOidMandatoryAssignedAuthorityImpl extends uk.nhs.connect.iucds.cda.ucr.impl.IIImpl implements uk.nhs.connect.iucds.cda.ucr.IINPfITOidMandatoryAssignedAuthority
{
    private static final long serialVersionUID = 1L;
    
    public IINPfITOidMandatoryAssignedAuthorityImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
