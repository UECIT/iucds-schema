 ...
 */
public class POCDMT000002UK01RecordTargetImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01RecordTarget
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000002UK01RecordTargetImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName PATIENTROLE$8 = 
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01PatientRole getPatientRole()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01PatientRole target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01PatientRole)get_store().find_element_user(PATIENTROLE$8, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setPatientRole(uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01PatientRole patientRole)
    {
        generatedSetterHelperImpl(patientRole, PATIENTROLE$8, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "patientRole" element
     */
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01PatientRole addNewPatientRole()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01PatientRole target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01PatientRole)get_store().add_element_user(PATIENTROLE$8);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.ParticipationType xgetTypeCode()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.cda.ucr.ParticipationType)get_store().find_attribute_user(TYPECODE$12);
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.ParticipationType)get_default_attribute_value(TYPECODE$12);
            }
            return target;
        }
    }
    ...
    public void xsetTypeCode(uk.nhs.connect.iucds.cda.ucr.ParticipationType typeCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.ParticipationType)get_store().add_attribute_user(TYPECODE$12);
            }
            target.set(typeCode);
        }
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.ContextControl xgetContextControlCode()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.cda.ucr.ContextControl)get_store().find_attribute_user(CONTEXTCONTROLCODE$14);
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.ContextControl)get_default_attribute_value(CONTEXTCONTROLCODE$14);
            }
            return target;
        }
    }
    ...
    public void xsetContextControlCode(uk.nhs.connect.iucds.cda.ucr.ContextControl contextControlCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.ContextControl)get_store().add_attribute_user(CONTEXTCONTROLCODE$14);
            }
