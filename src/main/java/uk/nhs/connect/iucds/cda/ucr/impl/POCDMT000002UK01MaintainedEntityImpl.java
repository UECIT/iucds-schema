 ...
 */
public class POCDMT000002UK01MaintainedEntityImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01MaintainedEntity
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000002UK01MaintainedEntityImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName EFFECTIVETIME$8 = 
        new javax.xml.namespace.QName("urn:hl7-org:v3", "effectiveTime");
    private static final javax.xml.namespace.QName MAINTAININGPERSON$10 = 
    ...
    public uk.nhs.connect.iucds.cda.ucr.IVLTS getEffectiveTime()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.cda.ucr.IVLTS)get_store().find_element_user(EFFECTIVETIME$8, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetEffectiveTime()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(EFFECTIVETIME$8) != 0;
        }
    }
    ...
    {
        generatedSetterHelperImpl(effectiveTime, EFFECTIVETIME$8, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.IVLTS addNewEffectiveTime()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.IVLTS target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.IVLTS)get_store().add_element_user(EFFECTIVETIME$8);
            return target;
        }
    }
    ...
    public void unsetEffectiveTime()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(EFFECTIVETIME$8, 0);
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Person getMaintainingPerson()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Person target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Person)get_store().find_element_user(MAINTAININGPERSON$10, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setMaintainingPerson(uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Person maintainingPerson)
    {
        generatedSetterHelperImpl(maintainingPerson, MAINTAININGPERSON$10, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "maintainingPerson" element
     */
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Person addNewMaintainingPerson()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Person target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Person)get_store().add_element_user(MAINTAININGPERSON$10);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.RoleClass xgetClassCode()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.cda.ucr.RoleClass)get_store().find_attribute_user(CLASSCODE$14);
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.RoleClass)get_default_attribute_value(CLASSCODE$14);
            }
            return target;
        }
    }
    ...
    public void xsetClassCode(uk.nhs.connect.iucds.cda.ucr.RoleClass classCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.RoleClass)get_store().add_attribute_user(CLASSCODE$14);
            }
