 ...
 */
public class POCDMT000002UK01ObservationMediaImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01ObservationMedia
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000002UK01ObservationMediaImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.ED getValue()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.ED target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.ED)get_store().find_element_user(VALUE$12, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setValue(uk.nhs.connect.iucds.cda.ucr.ED value)
    {
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.ED addNewValue()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.ED target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.ED)get_store().add_element_user(VALUE$12);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.ActClassObservation xgetClassCode()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.cda.ucr.ActClassObservation)get_store().find_attribute_user(CLASSCODE$36);
            return target;
        }
    }
    ...
    public void xsetClassCode(uk.nhs.connect.iucds.cda.ucr.ActClassObservation classCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.ActClassObservation)get_store().add_attribute_user(CLASSCODE$36);
            }
