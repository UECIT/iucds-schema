 ...
 */
public class POCDMT000002UK01SubjectPersonImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01SubjectPerson
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000002UK01SubjectPersonImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.PN getNameArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.cda.ucr.PN)get_store().find_element_user(NAME$8, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    {
        generatedSetterHelperImpl(name, NAME$8, i, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_ARRAYITEM);
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.PN insertNewName(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.PN target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.PN)get_store().insert_element_user(NAME$8, i);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.PN addNewName()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.PN target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.PN)get_store().add_element_user(NAME$8);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.CE getAdministrativeGenderCode()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.cda.ucr.CE)get_store().find_element_user(ADMINISTRATIVEGENDERCODE$10, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(administrativeGenderCode, ADMINISTRATIVEGENDERCODE$10, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.CE addNewAdministrativeGenderCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.CE target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.CE)get_store().add_element_user(ADMINISTRATIVEGENDERCODE$10);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.TS getBirthTime()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.cda.ucr.TS)get_store().find_element_user(BIRTHTIME$12, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(birthTime, BIRTHTIME$12, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.TS addNewBirthTime()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.TS target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.TS)get_store().add_element_user(BIRTHTIME$12);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.EntityClass xgetClassCode()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.cda.ucr.EntityClass)get_store().find_attribute_user(CLASSCODE$16);
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.EntityClass)get_default_attribute_value(CLASSCODE$16);
            }
            return target;
        }
    }
    ...
    public void xsetClassCode(uk.nhs.connect.iucds.cda.ucr.EntityClass classCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.EntityClass)get_store().add_attribute_user(CLASSCODE$16);
            }
    ...
    public uk.nhs.connect.iucds.cda.ucr.EntityDeterminer xgetDeterminerCode()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.cda.ucr.EntityDeterminer)get_store().find_attribute_user(DETERMINERCODE$18);
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.EntityDeterminer)get_default_attribute_value(DETERMINERCODE$18);
            }
            return target;
        }
    }
    ...
    public void xsetDeterminerCode(uk.nhs.connect.iucds.cda.ucr.EntityDeterminer determinerCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.EntityDeterminer)get_store().add_attribute_user(DETERMINERCODE$18);
            }
