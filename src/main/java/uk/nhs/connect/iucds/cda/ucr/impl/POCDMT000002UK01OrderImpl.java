 ...
 */
public class POCDMT000002UK01OrderImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Order
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000002UK01OrderImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName PRIORITYCODE$12 = 
    ...
    public uk.nhs.connect.iucds.cda.ucr.CE getPriorityCode()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.cda.ucr.CE)get_store().find_element_user(PRIORITYCODE$12, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetPriorityCode()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(PRIORITYCODE$12) != 0;
        }
    }
    ...
    {
        generatedSetterHelperImpl(priorityCode, PRIORITYCODE$12, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.CE addNewPriorityCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.CE target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.CE)get_store().add_element_user(PRIORITYCODE$12);
            return target;
        }
    }
    ...
    public void unsetPriorityCode()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(PRIORITYCODE$12, 0);
        }
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.ActClassRoot xgetClassCode()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.cda.ucr.ActClassRoot)get_store().find_attribute_user(CLASSCODE$16);
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.ActClassRoot)get_default_attribute_value(CLASSCODE$16);
            }
            return target;
        }
    }
    ...
    public void xsetClassCode(uk.nhs.connect.iucds.cda.ucr.ActClassRoot classCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.ActClassRoot)get_store().add_attribute_user(CLASSCODE$16);
            }
