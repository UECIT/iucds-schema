 ...
 */
public class POCDMT000002UK01ConsumableImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Consumable
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000002UK01ConsumableImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName MANUFACTUREDPRODUCT$8 = 
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01ManufacturedProduct getManufacturedProduct()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01ManufacturedProduct target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01ManufacturedProduct)get_store().find_element_user(MANUFACTUREDPRODUCT$8, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setManufacturedProduct(uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01ManufacturedProduct manufacturedProduct)
    {
        generatedSetterHelperImpl(manufacturedProduct, MANUFACTUREDPRODUCT$8, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "manufacturedProduct" element
     */
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01ManufacturedProduct addNewManufacturedProduct()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01ManufacturedProduct target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01ManufacturedProduct)get_store().add_element_user(MANUFACTUREDPRODUCT$8);
            return target;
        }
    }
