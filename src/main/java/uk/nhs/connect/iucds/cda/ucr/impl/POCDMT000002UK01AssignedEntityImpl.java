 ...
 */
public class POCDMT000002UK01AssignedEntityImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01AssignedEntity
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000002UK01AssignedEntityImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Organization getRepresentedOrganization()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Organization)get_store().find_element_user(REPRESENTEDORGANIZATION$18, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(representedOrganization, REPRESENTEDORGANIZATION$18, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Organization addNewRepresentedOrganization()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Organization target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Organization)get_store().add_element_user(REPRESENTEDORGANIZATION$18);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.RoleClassAssignedEntity xgetClassCode()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.cda.ucr.RoleClassAssignedEntity)get_store().find_attribute_user(CLASSCODE$22);
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.RoleClassAssignedEntity)get_default_attribute_value(CLASSCODE$22);
            }
            return target;
        }
    }
    ...
    public void xsetClassCode(uk.nhs.connect.iucds.cda.ucr.RoleClassAssignedEntity classCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.RoleClassAssignedEntity)get_store().add_attribute_user(CLASSCODE$22);
            }
