 ...
 */
public class POCDMT000002UK01PreconditionImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Precondition
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000002UK01PreconditionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName CRITERION$8 = 
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Criterion getCriterion()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Criterion target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Criterion)get_store().find_element_user(CRITERION$8, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setCriterion(uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Criterion criterion)
    {
        generatedSetterHelperImpl(criterion, CRITERION$8, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "criterion" element
     */
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Criterion addNewCriterion()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Criterion target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Criterion)get_store().add_element_user(CRITERION$8);
            return target;
        }
    }
