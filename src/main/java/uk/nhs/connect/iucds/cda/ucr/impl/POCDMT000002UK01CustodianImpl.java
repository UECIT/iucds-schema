 ...
 */
public class POCDMT000002UK01CustodianImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Custodian
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000002UK01CustodianImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName ASSIGNEDCUSTODIAN$8 = 
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01AssignedCustodian getAssignedCustodian()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01AssignedCustodian target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01AssignedCustodian)get_store().find_element_user(ASSIGNEDCUSTODIAN$8, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setAssignedCustodian(uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01AssignedCustodian assignedCustodian)
    {
        generatedSetterHelperImpl(assignedCustodian, ASSIGNEDCUSTODIAN$8, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "assignedCustodian" element
     */
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01AssignedCustodian addNewAssignedCustodian()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01AssignedCustodian target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01AssignedCustodian)get_store().add_element_user(ASSIGNEDCUSTODIAN$8);
            return target;
        }
    }
