 ...
 */
public class CDNPfITCDAUrlImpl extends uk.nhs.connect.iucds.cda.ucr.impl.ANYImpl implements uk.nhs.connect.iucds.cda.ucr.CDNPfITCDAUrl
{
    private static final long serialVersionUID = 1L;
    
    public CDNPfITCDAUrlImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.CdaNPfITED getOriginalText()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.CdaNPfITED target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.CdaNPfITED)get_store().find_element_user(ORIGINALTEXT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setOriginalText(uk.nhs.connect.iucds.cda.ucr.CdaNPfITED originalText)
    {
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.CdaNPfITED addNewOriginalText()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.CdaNPfITED target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.CdaNPfITED)get_store().add_element_user(ORIGINALTEXT$0);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.CR[] getQualifierArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            uk.nhs.connect.iucds.cda.ucr.CR[] result = new uk.nhs.connect.iucds.cda.ucr.CR[targetList.size()];
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.CR getQualifierArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.CR target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.CR)get_store().find_element_user(QUALIFIER$2, i);
            if (target == null)
            {
     ...
     */
    public void setQualifierArray(uk.nhs.connect.iucds.cda.ucr.CR[] qualifierArray)
    {
        check_orphaned();
     ...
     */
    public void setQualifierArray(int i, uk.nhs.connect.iucds.cda.ucr.CR qualifier)
    {
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.CR insertNewQualifier(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.CR target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.CR)get_store().insert_element_user(QUALIFIER$2, i);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.CR addNewQualifier()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.CR target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.CR)get_store().add_element_user(QUALIFIER$2);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.CDNPfITCDAUrl.Group[] getGroupArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            uk.nhs.connect.iucds.cda.ucr.CDNPfITCDAUrl.Group[] result = new uk.nhs.connect.iucds.cda.ucr.CDNPfITCDAUrl.Group[targetList.size()];
            targetList.toArray(result);
            return result;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.CDNPfITCDAUrl.Group getGroupArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.CDNPfITCDAUrl.Group target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.CDNPfITCDAUrl.Group)get_store().find_element_user(GROUP$4, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
     ...
     */
    public void setGroupArray(uk.nhs.connect.iucds.cda.ucr.CDNPfITCDAUrl.Group[] groupArray)
    {
        check_orphaned();
     ...
     */
    public void setGroupArray(int i, uk.nhs.connect.iucds.cda.ucr.CDNPfITCDAUrl.Group group)
    {
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.CDNPfITCDAUrl.Group insertNewGroup(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.CDNPfITCDAUrl.Group target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.CDNPfITCDAUrl.Group)get_store().insert_element_user(GROUP$4, i);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.CDNPfITCDAUrl.Group addNewGroup()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.CDNPfITCDAUrl.Group target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.CDNPfITCDAUrl.Group)get_store().add_element_user(GROUP$4);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.CD[] getTranslationArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.CD getTranslationArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.CD target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.CD)get_store().find_element_user(TRANSLATION$6, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
     ...
     */
    public void setTranslationArray(uk.nhs.connect.iucds.cda.ucr.CD[] translationArray)
    {
        check_orphaned();
     ...
     */
    public void setTranslationArray(int i, uk.nhs.connect.iucds.cda.ucr.CD translation)
    {
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.CD insertNewTranslation(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.CD target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.CD)get_store().insert_element_user(TRANSLATION$6, i);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.CD addNewTranslation()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.CD target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.CD)get_store().add_element_user(TRANSLATION$6);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.Cs2 xgetCode()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.cda.ucr.Cs2)get_store().find_attribute_user(CODE$8);
            return target;
        }
    }
    ...
    public void xsetCode(uk.nhs.connect.iucds.cda.ucr.Cs2 code)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.Cs2)get_store().add_attribute_user(CODE$8);
            }
            target.set(code);
        }
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.Uid xgetCodeSystem()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.cda.ucr.Uid)get_store().find_attribute_user(CODESYSTEM$10);
            return target;
        }
    }
    ...
    public void xsetCodeSystem(uk.nhs.connect.iucds.cda.ucr.Uid codeSystem)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.Uid)get_store().add_attribute_user(CODESYSTEM$10);
            }
    ...
    public uk.nhs.connect.iucds.cda.ucr.St2 xgetCodeSystemName()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.cda.ucr.St2)get_store().find_attribute_user(CODESYSTEMNAME$12);
            return target;
        }
    }
    ...
    public void xsetCodeSystemName(uk.nhs.connect.iucds.cda.ucr.St2 codeSystemName)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.St2)get_store().add_attribute_user(CODESYSTEMNAME$12);
            }
    ...
    public uk.nhs.connect.iucds.cda.ucr.St2 xgetCodeSystemVersion()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.St2 target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.St2)get_store().find_attribute_user(CODESYSTEMVERSION$14);
            return target;
        }
    }
    ...
    public void xsetCodeSystemVersion(uk.nhs.connect.iucds.cda.ucr.St2 codeSystemVersion)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.St2)get_store().add_attribute_user(CODESYSTEMVERSION$14);
            }
    ...
    public uk.nhs.connect.iucds.cda.ucr.St2 xgetDisplayName()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.St2 target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.St2)get_store().find_attribute_user(DISPLAYNAME$16);
            return target;
        }
    }
    ...
    public void xsetDisplayName(uk.nhs.connect.iucds.cda.ucr.St2 displayName)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.St2)get_store().add_attribute_user(DISPLAYNAME$16);
            }
     ...
     * This is a complex type.
     */
    public static class GroupImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.cda.ucr.CDNPfITCDAUrl.Group
    {
        private static final long serialVersionUID = 1L;
        ...
        public uk.nhs.connect.iucds.cda.ucr.CR getQualifierArray(int i)
        {
            synchronized (monitor())
            {
                check_orphaned();
                uk.nhs.connect.iucds.cda.ucr.CR target = null;
                target = (uk.nhs.connect.iucds.cda.ucr.CR)get_store().find_element_user(QUALIFIER$0, i);
                if (target == null)
                {
                    throw new IndexOutOfBoundsException();
                }
        ...
        public uk.nhs.connect.iucds.cda.ucr.CR insertNewQualifier(int i)
        {
            synchronized (monitor())
            {
                check_orphaned();
                uk.nhs.connect.iucds.cda.ucr.CR target = null;
                target = (uk.nhs.connect.iucds.cda.ucr.CR)get_store().insert_element_user(QUALIFIER$0, i);
                return target;
            }
        }
        ...
        public uk.nhs.connect.iucds.cda.ucr.CR addNewQualifier()
        {
            synchronized (monitor())
            {
                check_orphaned();
                uk.nhs.connect.iucds.cda.ucr.CR target = null;
                target = (uk.nhs.connect.iucds.cda.ucr.CR)get_store().add_element_user(QUALIFIER$0);
                return target;
            }
        }
