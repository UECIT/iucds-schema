 ...
 */
public class StrucDocItemImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.cda.ucr.StrucDocItem
{
    ...
    public uk.nhs.connect.iucds.cda.ucr.StrucDocParagraph getParagraphArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocParagraph)get_store().find_element_user(PARAGRAPH$18, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    public uk.nhs.connect.iucds.cda.ucr.StrucDocParagraph insertNewParagraph(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.StrucDocParagraph target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocParagraph)get_store().insert_element_user(PARAGRAPH$18, i);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.StrucDocParagraph addNewParagraph()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.StrucDocParagraph target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocParagraph)get_store().add_element_user(PARAGRAPH$18);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.StrucDocList getListArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocList)get_store().find_element_user(LIST$20, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    public uk.nhs.connect.iucds.cda.ucr.StrucDocList insertNewList(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.StrucDocList target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocList)get_store().insert_element_user(LIST$20, i);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.StrucDocList addNewList()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.StrucDocList target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocList)get_store().add_element_user(LIST$20);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.StrucDocTable getTableArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocTable)get_store().find_element_user(TABLE$22, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    public uk.nhs.connect.iucds.cda.ucr.StrucDocTable insertNewTable(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.StrucDocTable target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocTable)get_store().insert_element_user(TABLE$22, i);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.StrucDocTable addNewTable()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.StrucDocTable target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocTable)get_store().add_element_user(TABLE$22);
            return target;
        }
    }
