 ...
 */
public class POCDMT000002UK01ParentDocument1Impl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01ParentDocument1
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000002UK01ParentDocument1Impl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.ActClinicalDocument1 xgetClassCode()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.cda.ucr.ActClinicalDocument1)get_store().find_attribute_user(CLASSCODE$20);
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.ActClinicalDocument1)get_default_attribute_value(CLASSCODE$20);
            }
            return target;
        }
    }
    ...
    public void xsetClassCode(uk.nhs.connect.iucds.cda.ucr.ActClinicalDocument1 classCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.ActClinicalDocument1)get_store().add_attribute_user(CLASSCODE$20);
            }
