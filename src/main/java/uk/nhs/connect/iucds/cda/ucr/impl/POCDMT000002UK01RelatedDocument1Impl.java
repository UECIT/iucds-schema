 ...
 */
public class POCDMT000002UK01RelatedDocument1Impl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01RelatedDocument1
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000002UK01RelatedDocument1Impl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName PARENTDOCUMENT$8 = 
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01ParentDocument1 getParentDocument()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01ParentDocument1 target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01ParentDocument1)get_store().find_element_user(PARENTDOCUMENT$8, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setParentDocument(uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01ParentDocument1 parentDocument)
    {
        generatedSetterHelperImpl(parentDocument, PARENTDOCUMENT$8, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "parentDocument" element
     */
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01ParentDocument1 addNewParentDocument()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01ParentDocument1 target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01ParentDocument1)get_store().add_element_user(PARENTDOCUMENT$8);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.XActRelationshipDocumentX.Enum getTypeCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (uk.nhs.connect.iucds.cda.ucr.XActRelationshipDocumentX.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.XActRelationshipDocument1 xgetTypeCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.XActRelationshipDocument1 target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.XActRelationshipDocument1)get_store().find_attribute_user(TYPECODE$12);
            return target;
        }
    }
     ...
     */
    public void setTypeCode(uk.nhs.connect.iucds.cda.ucr.XActRelationshipDocumentX.Enum typeCode)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetTypeCode(uk.nhs.connect.iucds.cda.ucr.XActRelationshipDocument1 typeCode)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.XActRelationshipDocument1)get_store().add_attribute_user(TYPECODE$12);
            }
            target.set(typeCode);
        }
    }
