 ...
 */
public class EDNHSURLImpl extends uk.nhs.connect.iucds.cda.ucr.impl.EDImpl implements uk.nhs.connect.iucds.cda.ucr.EDNHSURL
{
    private static final long serialVersionUID = 1L;
    
    public EDNHSURLImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
