 ...
 */
public class StrucDocColImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.cda.ucr.StrucDocCol
{
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.StrucDocCol.Align.Enum getAlign()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (uk.nhs.connect.iucds.cda.ucr.StrucDocCol.Align.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.StrucDocCol.Align xgetAlign()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.StrucDocCol.Align target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocCol.Align)get_store().find_attribute_user(ALIGN$10);
            return target;
        }
    }
     ...
     */
    public void setAlign(uk.nhs.connect.iucds.cda.ucr.StrucDocCol.Align.Enum align)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetAlign(uk.nhs.connect.iucds.cda.ucr.StrucDocCol.Align align)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.StrucDocCol.Align)get_store().add_attribute_user(ALIGN$10);
            }
            target.set(align);
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.StrucDocCol.Valign.Enum getValign()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (uk.nhs.connect.iucds.cda.ucr.StrucDocCol.Valign.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.StrucDocCol.Valign xgetValign()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.StrucDocCol.Valign target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.StrucDocCol.Valign)get_store().find_attribute_user(VALIGN$16);
            return target;
        }
    }
     ...
     */
    public void setValign(uk.nhs.connect.iucds.cda.ucr.StrucDocCol.Valign.Enum valign)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetValign(uk.nhs.connect.iucds.cda.ucr.StrucDocCol.Valign valign)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.StrucDocCol.Valign)get_store().add_attribute_user(VALIGN$16);
            }
            target.set(valign);
        }
    }
     ...
     */
    public static class AlignImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements uk.nhs.connect.iucds.cda.ucr.StrucDocCol.Align
    {
        private static final long serialVersionUID = 1L;
     ...
     */
    public static class ValignImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements uk.nhs.connect.iucds.cda.ucr.StrucDocCol.Valign
    {
        private static final long serialVersionUID = 1L;
