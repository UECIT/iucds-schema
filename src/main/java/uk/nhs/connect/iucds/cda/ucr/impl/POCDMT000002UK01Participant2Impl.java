 ...
 */
public class POCDMT000002UK01Participant2Impl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Participant2
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000002UK01Participant2Impl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName AWARENESSCODE$10 = 
        new javax.xml.namespace.QName("urn:hl7-org:v3", "awarenessCode");
    private static final javax.xml.namespace.QName PARTICIPANTROLE$12 = 
    ...
    public uk.nhs.connect.iucds.cda.ucr.CE getAwarenessCode()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.cda.ucr.CE)get_store().find_element_user(AWARENESSCODE$10, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetAwarenessCode()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(AWARENESSCODE$10) != 0;
        }
    }
    ...
    {
        generatedSetterHelperImpl(awarenessCode, AWARENESSCODE$10, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.CE addNewAwarenessCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.CE target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.CE)get_store().add_element_user(AWARENESSCODE$10);
            return target;
        }
    }
    ...
    public void unsetAwarenessCode()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(AWARENESSCODE$10, 0);
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01ParticipantRole getParticipantRole()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01ParticipantRole target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01ParticipantRole)get_store().find_element_user(PARTICIPANTROLE$12, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setParticipantRole(uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01ParticipantRole participantRole)
    {
        generatedSetterHelperImpl(participantRole, PARTICIPANTROLE$12, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "participantRole" element
     */
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01ParticipantRole addNewParticipantRole()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01ParticipantRole target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01ParticipantRole)get_store().add_element_user(PARTICIPANTROLE$12);
            return target;
        }
    }
