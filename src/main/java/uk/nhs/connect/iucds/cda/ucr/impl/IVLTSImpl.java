 ...
 */
public class IVLTSImpl extends uk.nhs.connect.iucds.cda.ucr.impl.SXCMTSImpl implements uk.nhs.connect.iucds.cda.ucr.IVLTS
{
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.IVXBTS getLow()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.IVXBTS target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.IVXBTS)get_store().find_element_user(LOW$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setLow(uk.nhs.connect.iucds.cda.ucr.IVXBTS low)
    {
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.IVXBTS addNewLow()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.IVXBTS target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.IVXBTS)get_store().add_element_user(LOW$0);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.IVXBTS getHigh()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.IVXBTS target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.IVXBTS)get_store().find_element_user(HIGH$4, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setHigh(uk.nhs.connect.iucds.cda.ucr.IVXBTS high)
    {
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.IVXBTS addNewHigh()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.IVXBTS target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.IVXBTS)get_store().add_element_user(HIGH$4);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.TS getCenter()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.TS target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.TS)get_store().find_element_user(CENTER$6, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setCenter(uk.nhs.connect.iucds.cda.ucr.TS center)
    {
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.TS addNewCenter()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.TS target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.TS)get_store().add_element_user(CENTER$6);
            return target;
        }
    }
