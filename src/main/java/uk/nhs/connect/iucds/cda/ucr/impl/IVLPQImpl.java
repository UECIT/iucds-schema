 ...
 */
public class IVLPQImpl extends uk.nhs.connect.iucds.cda.ucr.impl.ANYImpl implements uk.nhs.connect.iucds.cda.ucr.IVLPQ
{
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.PQInc getLow()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.PQInc target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.PQInc)get_store().find_element_user(LOW$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setLow(uk.nhs.connect.iucds.cda.ucr.PQInc low)
    {
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.PQInc addNewLow()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.PQInc target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.PQInc)get_store().add_element_user(LOW$0);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.PQ getWidth()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.PQ target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.PQ)get_store().find_element_user(WIDTH$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setWidth(uk.nhs.connect.iucds.cda.ucr.PQ width)
    {
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.PQ addNewWidth()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.PQ target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.PQ)get_store().add_element_user(WIDTH$2);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.PQInc getHigh()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.PQInc target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.PQInc)get_store().find_element_user(HIGH$4, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setHigh(uk.nhs.connect.iucds.cda.ucr.PQInc high)
    {
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.PQInc addNewHigh()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.PQInc target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.PQInc)get_store().add_element_user(HIGH$4);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.PQ getCenter()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.PQ target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.PQ)get_store().find_element_user(CENTER$6, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setCenter(uk.nhs.connect.iucds.cda.ucr.PQ center)
    {
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.PQ addNewCenter()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.PQ target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.PQ)get_store().add_element_user(CENTER$6);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.CsSetOperator xgetOperator()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.cda.ucr.CsSetOperator)get_store().find_attribute_user(OPERATOR$8);
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.CsSetOperator)get_default_attribute_value(OPERATOR$8);
            }
            return target;
        }
    }
    ...
    public void xsetOperator(uk.nhs.connect.iucds.cda.ucr.CsSetOperator operator)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.CsSetOperator)get_store().add_attribute_user(OPERATOR$8);
            }
            target.set(operator);
        }
    }
