 ...
 */
public class POCDMT000002UK01LabeledDrugImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01LabeledDrug
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000002UK01LabeledDrugImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.EN getName()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.cda.ucr.EN)get_store().find_element_user(NAME$10, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public uk.nhs.connect.iucds.cda.ucr.EN addNewName()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.EN target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.EN)get_store().add_element_user(NAME$10);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.EntityClassManufacturedMaterial xgetClassCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.EntityClassManufacturedMaterial target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.EntityClassManufacturedMaterial)get_store().find_attribute_user(CLASSCODE$14);
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.EntityClassManufacturedMaterial)get_default_attribute_value(CLASSCODE$14);
            }
            return target;
        }
    }
     ...
     */
    public void xsetClassCode(uk.nhs.connect.iucds.cda.ucr.EntityClassManufacturedMaterial classCode)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.EntityClassManufacturedMaterial)get_store().add_attribute_user(CLASSCODE$14);
            }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.EntityDeterminerDeterminedX.Enum getDeterminerCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (uk.nhs.connect.iucds.cda.ucr.EntityDeterminerDeterminedX.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.EntityDeterminerDetermined xgetDeterminerCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.EntityDeterminerDetermined target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.EntityDeterminerDetermined)get_store().find_attribute_user(DETERMINERCODE$16);
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.EntityDeterminerDetermined)get_default_attribute_value(DETERMINERCODE$16);
            }
            return target;
        }
    }
     ...
     */
    public void setDeterminerCode(uk.nhs.connect.iucds.cda.ucr.EntityDeterminerDeterminedX.Enum determinerCode)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetDeterminerCode(uk.nhs.connect.iucds.cda.ucr.EntityDeterminerDetermined determinerCode)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.EntityDeterminerDetermined)get_store().add_attribute_user(DETERMINERCODE$16);
            }
