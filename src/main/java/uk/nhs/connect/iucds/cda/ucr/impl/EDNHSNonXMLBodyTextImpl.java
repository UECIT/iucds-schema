 ...
 */
public class EDNHSNonXMLBodyTextImpl extends uk.nhs.connect.iucds.cda.ucr.impl.EDImpl implements uk.nhs.connect.iucds.cda.ucr.EDNHSNonXMLBodyText
{
    private static final long serialVersionUID = 1L;
    
    public EDNHSNonXMLBodyTextImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.Cs2 xgetMediaType()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.cda.ucr.Cs2)get_store().find_attribute_user(MEDIATYPE$2);
            return target;
        }
    }
    ...
    public void xsetMediaType(uk.nhs.connect.iucds.cda.ucr.Cs2 mediaType)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.Cs2)get_store().add_attribute_user(MEDIATYPE$2);
            }
