 ...
 */
public class POCDMT000002UK01SubjectImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01Subject
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000002UK01SubjectImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName RELATEDSUBJECT$10 = 
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.CE getAwarenessCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.CE target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.CE)get_store().find_element_user(AWARENESSCODE$8, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setAwarenessCode(uk.nhs.connect.iucds.cda.ucr.CE awarenessCode)
    {
        generatedSetterHelperImpl(awarenessCode, AWARENESSCODE$8, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "awarenessCode" element
     */
    public uk.nhs.connect.iucds.cda.ucr.CE addNewAwarenessCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.CE target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.CE)get_store().add_element_user(AWARENESSCODE$8);
            return target;
        }
    }
     ...
     */
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01RelatedSubject getRelatedSubject()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01RelatedSubject target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01RelatedSubject)get_store().find_element_user(RELATEDSUBJECT$10, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setRelatedSubject(uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01RelatedSubject relatedSubject)
    {
        generatedSetterHelperImpl(relatedSubject, RELATEDSUBJECT$10, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "relatedSubject" element
     */
    public uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01RelatedSubject addNewRelatedSubject()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01RelatedSubject target = null;
            target = (uk.nhs.connect.iucds.cda.ucr.POCDMT000002UK01RelatedSubject)get_store().add_element_user(RELATEDSUBJECT$10);
            return target;
        }
    }
    ...
    public uk.nhs.connect.iucds.cda.ucr.Cs2 xgetTypeCode()
    {
        synchronized (monitor())
        {
            ...
            target = (uk.nhs.connect.iucds.cda.ucr.Cs2)get_store().find_attribute_user(TYPECODE$14);
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.Cs2)get_default_attribute_value(TYPECODE$14);
            }
            return target;
        }
    }
    ...
    public void xsetTypeCode(uk.nhs.connect.iucds.cda.ucr.Cs2 typeCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (uk.nhs.connect.iucds.cda.ucr.Cs2)get_store().add_attribute_user(TYPECODE$14);
            }
            target.set(typeCode);
        }
    }
