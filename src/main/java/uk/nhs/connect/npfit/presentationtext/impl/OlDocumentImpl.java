 ...
 */
public class OlDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.npfit.presentationtext.OlDocument
{
     ...
     * Gets the "ol" element
     */
    public uk.nhs.connect.npfit.presentationtext.OlDocument.Ol getOl()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.npfit.presentationtext.OlDocument.Ol target = null;
            target = (uk.nhs.connect.npfit.presentationtext.OlDocument.Ol)get_store().find_element_user(OL$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     * Sets the "ol" element
     */
    public void setOl(uk.nhs.connect.npfit.presentationtext.OlDocument.Ol ol)
    {
    ...
    public uk.nhs.connect.npfit.presentationtext.OlDocument.Ol addNewOl()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.npfit.presentationtext.OlDocument.Ol target = null;
            target = (uk.nhs.connect.npfit.presentationtext.OlDocument.Ol)get_store().add_element_user(OL$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class OlImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.npfit.presentationtext.OlDocument.Ol
    {
        private static final long serialVersionUID = 1L;
