 ...
 */
public class H5DocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.npfit.presentationtext.H5Document
{
    private static final long serialVersionUID = 1L;
    
    public H5DocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName H5$0 = 
     ...
     * Gets the "h5" element
     */
    public uk.nhs.connect.npfit.presentationtext.H5Document.H5 getH5()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.npfit.presentationtext.H5Document.H5 target = null;
            target = (uk.nhs.connect.npfit.presentationtext.H5Document.H5)get_store().find_element_user(H5$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     * Sets the "h5" element
     */
    public void setH5(uk.nhs.connect.npfit.presentationtext.H5Document.H5 h5)
    {
        generatedSetterHelperImpl(h5, H5$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public uk.nhs.connect.npfit.presentationtext.H5Document.H5 addNewH5()
    {
        synchronized (monitor())
        {
            check_orphaned();
            uk.nhs.connect.npfit.presentationtext.H5Document.H5 target = null;
            target = (uk.nhs.connect.npfit.presentationtext.H5Document.H5)get_store().add_element_user(H5$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class H5Impl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements uk.nhs.connect.npfit.presentationtext.H5Document.H5
    {
        private static final long serialVersionUID = 1L;
        
        public H5Impl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
